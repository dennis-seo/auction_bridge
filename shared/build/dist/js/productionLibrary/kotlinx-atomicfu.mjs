...
protoOf(atomicfu$AtomicRefArray$ref).hn = function () {
  return this.gn_1.length;
};
protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
  return this.gn_1[index];
};
...
protoOf(AtomicRef).in = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicRef).jn = function () {
...
protoOf(AtomicBoolean).kn = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicBoolean).jn = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicLong).ln = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicLong).jn = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicInt).mn = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicInt).jn = function () {
  return this.kotlinx$atomicfu$value;
};
...
defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).hn);
//endregion
