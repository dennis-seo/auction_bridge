...
function invokeOnCompletion$default(onCancelling, invokeImmediately, handler, $super) {
  ...
  return $super === VOID ? this.xo(onCancelling, invokeImmediately, handler) : $super.xo.call(this, onCancelling, invokeImmediately, handler);
}
...
function close$default(cause, $super) {
  cause = cause === VOID ? null : cause;
  return $super === VOID ? this.g16(cause) : $super.g16.call(this, cause);
}
...
function fuse$default(context, capacity, onBufferOverflow, $super) {
  ...
  return $super === VOID ? this.d1c(context, capacity, onBufferOverflow) : $super.d1c.call(this, context, capacity, onBufferOverflow);
}
...
function AbstractCoroutine(parentContext, initParentJob, active) {
  ...
  if (initParentJob) {
    this.pn(parentContext.h9(Key_instance_3));
  }
  this.sn_1 = parentContext.rh(this);
}
protoOf(AbstractCoroutine).a9 = function () {
  return this.sn_1;
};
protoOf(AbstractCoroutine).tn = function () {
  return this.sn_1;
};
protoOf(AbstractCoroutine).un = function () {
  return protoOf(JobSupport).un.call(this);
};
protoOf(AbstractCoroutine).vn = function (value) {
};
protoOf(AbstractCoroutine).wn = function (cause, handled) {
};
protoOf(AbstractCoroutine).xn = function () {
  return get_classSimpleName(this) + ' was cancelled';
};
protoOf(AbstractCoroutine).yn = function (state) {
  if (state instanceof CompletedExceptionally) {
    this.wn(state.zn_1, state.bo());
  } else {
    this.vn((state == null ? true : !(state == null)) ? state : THROW_CCE());
  }
};
protoOf(AbstractCoroutine).f9 = function (result) {
  var state = this.co(toState_0(result));
  if (state === get_COMPLETING_WAITING_CHILDREN())
    return Unit_instance;
  this.do(state);
};
protoOf(AbstractCoroutine).do = function (state) {
  return this.eo(state);
};
protoOf(AbstractCoroutine).fo = function (exception) {
  handleCoroutineException(this.sn_1, exception);
};
protoOf(AbstractCoroutine).go = function () {
  var tmp0_elvis_lhs = get_coroutineName(this.sn_1);
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return protoOf(JobSupport).go.call(this);
  } else {
    tmp = tmp0_elvis_lhs;
  }
  var coroutineName = tmp;
  return '"' + coroutineName + '":' + protoOf(JobSupport).go.call(this);
};
protoOf(AbstractCoroutine).ho = function (start, receiver, block) {
  start.ko(block, receiver, this);
};
...
protoOf(DisposeHandlersOnCancel).fq = function () {
  // Inline function 'kotlin.collections.forEach' call
  var indexedObject = this.dq_1;
...
protoOf(DisposeHandlersOnCancel).qq = function (cause) {
  this.fq();
};
protoOf(DisposeHandlersOnCancel).toString = function () {
  return 'DisposeHandlersOnCancel[' + toString(this.dq_1) + ']';
};
function AwaitAllNode($outer, continuation) {
  this.nq_1 = $outer;
  JobNode.call(this);
  this.kq_1 = continuation;
  this.mq_1 = atomic$ref$1(null);
}
protoOf(AwaitAllNode).oq = function () {
  var tmp = this.lq_1;
  if (!(tmp == null))
    return tmp;
  else {
...
protoOf(AwaitAllNode).rq = function (value) {
  this.mq_1.kotlinx$atomicfu$value = value;
};
protoOf(AwaitAllNode).sq = function () {
  return this.mq_1.kotlinx$atomicfu$value;
};
protoOf(AwaitAllNode).tq = function () {
  return false;
};
protoOf(AwaitAllNode).qq = function (cause) {
  if (!(cause == null)) {
    var token = this.kq_1.xq(cause);
    if (!(token == null)) {
      this.kq_1.yq(token);
      var tmp0_safe_receiver = this.sq();
      if (tmp0_safe_receiver == null)
        null;
      else {
        tmp0_safe_receiver.fq();
      }
    }
  } else if (this.nq_1.vq_1.atomicfu$decrementAndGet() === 0) {
    var tmp0 = this.kq_1;
    // Inline function 'kotlin.collections.map' call
    var this_0 = this.nq_1.uq_1;
...
function AwaitAll(deferreds) {
  this.uq_1 = deferreds;
  this.vq_1 = atomic$int$1(this.uq_1.length);
}
protoOf(AwaitAll).lr = function ($completion) {
  var cancellable = new CancellableContinuationImpl(intercepted($completion), 1);
  cancellable.sr();
  var tmp = 0;
  var tmp_0 = this.uq_1.length;
  // Inline function 'kotlin.arrayOfNulls' call
  var tmp_1 = Array(tmp_0);
  while (tmp < tmp_0) {
    var tmp_2 = tmp;
    var deferred = this.uq_1[tmp_2];
    deferred.ro();
    // Inline function 'kotlin.apply' call
    var this_0 = new AwaitAllNode(this, cancellable);
    this_0.lq_1 = invokeOnCompletion(deferred, VOID, this_0);
    tmp_1[tmp_2] = this_0;
    tmp = tmp + 1 | 0;
  }
  var nodes = tmp_1;
      ...
      switch (tmp) {
        case 0:
          ...
          if (this.bq_1.p()) {
            ...
            suspendResult = (new AwaitAll(copyToArray(this_0))).lr(this);
...
function launch(_this__u8e3s4, context, start, block) {
  ...
  var coroutine = start.ur() ? new LazyStandaloneCoroutine(newContext, block) : new StandaloneCoroutine(newContext, true);
  coroutine.ho(start, coroutine, block);
  return coroutine;
}
function async(_this__u8e3s4, context, start, block) {
  ...
  start = start === VOID ? CoroutineStart_DEFAULT_getInstance() : start;
  var newContext = newCoroutineContext(_this__u8e3s4, context);
  var coroutine = start.ur() ? new LazyDeferredCoroutine(newContext, block) : new DeferredCoroutine(newContext, true);
  coroutine.ho(start, coroutine, block);
  return coroutine;
}
...
protoOf(StandaloneCoroutine).pp = function (exception) {
  handleCoroutineException(this.sn_1, exception);
  return true;
};
function LazyStandaloneCoroutine(parentContext, block) {
  StandaloneCoroutine.call(this, parentContext, false);
  this.bs_1 = createCoroutineUnintercepted(block, this, this);
}
protoOf(LazyStandaloneCoroutine).so = function () {
  startCoroutineCancellable(this.bs_1, this);
};
function $awaitCOROUTINE$(_this__u8e3s4, resultContinuation) {
  CoroutineImpl.call(this, resultContinuation);
  this.ks_1 = _this__u8e3s4;
}
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.ks_1.sp(this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(DeferredCoroutine).wq = function () {
  var tmp = this.rp();
  return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
};
protoOf(DeferredCoroutine).os = function ($completion) {
...
function LazyDeferredCoroutine(parentContext, block) {
  ...
  this.ss_1 = createCoroutineUnintercepted(block, this, this);
}
protoOf(LazyDeferredCoroutine).so = function () {
  startCoroutineCancellable(this.ss_1, this);
};
...
protoOf(DisposeOnCancel).qq = function (cause) {
  return this.xs_1.pq();
};
protoOf(DisposeOnCancel).toString = function () {
  return 'DisposeOnCancel[' + toString(this.xs_1) + ']';
};
function getOrCreateCancellableContinuation(delegate) {
  if (!(delegate instanceof DispatchedContinuation)) {
    return new CancellableContinuationImpl(delegate, 1);
  }
  var tmp4_safe_receiver = delegate.et();
  var tmp;
...
function isReusable($this) {
  var tmp;
  if (get_isReusableMode($this.ht_1)) {
    var tmp_0 = $this.nr_1;
    tmp = (tmp_0 instanceof DispatchedContinuation ? tmp_0 : THROW_CCE()).gt();
  } else {
    tmp = false;
  }
  return tmp;
...
function cancelLater($this, cause) {
  ...
  return dispatched.it(cause);
}
function callSegmentOnCancellation($this, segment, cause) {
  // Inline function 'kotlinx.coroutines.index' call
  var index = $this.pr_1.kotlinx$atomicfu$value & 536870911;
  ...
  try {
    segment.nt(index, cause, $this.a9());
  } catch ($p) {
  ...
  while (true) {
    ...
    switch (cur >> 29) {
      case 0:
        ...
        if ($this.pr_1.atomicfu$compareAndSet(cur, tmp$ret$2))
          return true;
        break;
      case 2:
        return false;
...
function installParentHandle($this) {
  ...
  $this.rr_1.atomicfu$compareAndSet(null, handle);
  return handle;
}
function invokeOnCancellationImpl($this, handler) {
  ...
  while (true) {
    ...
    if (state instanceof Active) {
      if ($this.qr_1.atomicfu$compareAndSet(state, handler))
        return Unit_instance;
    } else {
      var tmp;
      ...
      if (tmp) {
        ...
        if (state instanceof CompletedExceptionally) {
          ...
          if (state instanceof CancelledContinuation) {
            ...
            var cause = tmp13_safe_receiver == null ? null : tmp13_safe_receiver.zn_1;
            if (isInterface(handler, CancelHandler)) {
              $this.tt(handler, cause);
            } else {
          ...
          if (state instanceof CompletedContinuation) {
            ...
            if (!isInterface(handler, CancelHandler))
              THROW_CCE();
            if (state.ut()) {
              $this.tt(handler, state.st_1);
              return Unit_instance;
            }
            var update = state.vt(VOID, handler);
            if ($this.qr_1.atomicfu$compareAndSet(state, update))
              return Unit_instance;
          } else {
            if (handler instanceof Segment)
              return Unit_instance;
            ...
            if ($this.qr_1.atomicfu$compareAndSet(state, update_0))
              return Unit_instance;
          }
        }
      }
  ...
  while (true) {
    ...
    $l$block: {
      if (!(tmp0 == null) ? isInterface(tmp0, NotCompleted) : false) {
        var update = resumedState($this, tmp0, proposedUpdate, $this.ht_1, onCancellation, idempotent);
        if (!$this.qr_1.atomicfu$compareAndSet(tmp0, update)) {
          break $l$block;
        }
        ...
        if (tmp0 instanceof CompletedContinuation) {
          var tmp;
          if (!(idempotent == null) && tmp0.rt_1 === idempotent) {
            // Inline function 'kotlinx.coroutines.assert' call
...
function CancellableContinuationImpl(delegate, resumeMode) {
  ...
  this.nr_1 = delegate;
  // Inline function 'kotlinx.coroutines.assert' call
  this.or_1 = this.nr_1.a9();
  var tmp = this;
  // Inline function 'kotlinx.coroutines.decisionAndIndex' call
  var tmp$ret$1 = (0 << 29) + 536870911 | 0;
  tmp.pr_1 = atomic$int$1(tmp$ret$1);
  this.qr_1 = atomic$ref$1(Active_instance);
  this.rr_1 = atomic$ref$1(null);
}
...
protoOf(CancellableContinuationImpl).po = function () {
  var tmp = this.oo();
  return !(!(tmp == null) ? isInterface(tmp, NotCompleted) : false);
};
protoOf(CancellableContinuationImpl).qo = function () {
  var tmp = this.oo();
  return tmp instanceof CancelledContinuation;
};
protoOf(CancellableContinuationImpl).sr = function () {
  ...
  if (this.po()) {
    handle.pq();
    this.rr_1.kotlinx$atomicfu$value = NonDisposableHandle_instance;
  }
};
protoOf(CancellableContinuationImpl).ft = function () {
  // Inline function 'kotlinx.coroutines.assert' call
  // Inline function 'kotlinx.coroutines.assert' call
  var state = this.qr_1.kotlinx$atomicfu$value;
  // Inline function 'kotlinx.coroutines.assert' call
  var tmp;
  if (state instanceof CompletedContinuation) {
    tmp = !(state.rt_1 == null);
  ...
  this.qr_1.kotlinx$atomicfu$value = Active_instance;
  return true;
};
protoOf(CancellableContinuationImpl).zt = function () {
  return this.oo();
};
protoOf(CancellableContinuationImpl).au = function (takenState, cause) {
  var this_0 = this.qr_1;
  while (true) {
    var state = this_0.kotlinx$atomicfu$value;
    if (!(state == null) ? isInterface(state, NotCompleted) : false) {
      ...
      if (state instanceof CompletedExceptionally)
        ...
        if (state instanceof CompletedContinuation) {
          ...
          var update = state.vt(VOID, VOID, VOID, VOID, cause);
          if (this.qr_1.atomicfu$compareAndSet(state, update)) {
            state.bu(this, cause);
            return Unit_instance;
          }
        } else {
          if (this.qr_1.atomicfu$compareAndSet(state, new CompletedContinuation(state, VOID, VOID, VOID, cause))) {
            return Unit_instance;
          }
        }
      }
...
protoOf(CancellableContinuationImpl).cu = function (cause) {
  // Inline function 'kotlinx.atomicfu.loop' call
  var this_0 = this.qr_1;
  while (true) {
    var tmp0 = this_0.kotlinx$atomicfu$value;
...
protoOf(CancellableContinuationImpl).tt = function (handler, cause) {
  // Inline function 'kotlinx.coroutines.CancellableContinuationImpl.callCancelHandlerSafely' call
  try {
    handler.qq(cause);
  } catch ($p) {
...
protoOf(CancellableContinuationImpl).eu = function (onCancellation, cause, value) {
  try {
...
protoOf(CancellableContinuationImpl).fu = function (parent) {
  return parent.to();
};
protoOf(CancellableContinuationImpl).tr = function () {
  ...
  var state = this.oo();
  if (state instanceof CompletedExceptionally)
    throw recoverStackTrace(state.zn_1, this);
  if (get_isCancellableMode(this.ht_1)) {
  ...
  return this.hu(state);
};
protoOf(CancellableContinuationImpl).gu = function () {
  var tmp = this.nr_1;
  var tmp10_safe_receiver = tmp instanceof DispatchedContinuation ? tmp : null;
  var tmp0_elvis_lhs = tmp10_safe_receiver == null ? null : tmp10_safe_receiver.iu(this);
  var tmp_0;
  if (tmp0_elvis_lhs == null) {
    return Unit_instance;
  } else {
  ...
  this.xt();
  this.cu(cancellationCause);
};
protoOf(CancellableContinuationImpl).f9 = function (result) {
  return this.ju(toState(result, this), this.ht_1);
};
protoOf(CancellableContinuationImpl).ku = function (value, onCancellation) {
  return this.lu(value, this.ht_1, onCancellation);
};
protoOf(CancellableContinuationImpl).mu = function (segment, index) {
  var tmp0 = this.pr_1;
  $l$block: {
...
protoOf(CancellableContinuationImpl).us = function (handler) {
  return invokeOnCancellation(this, new UserSupplied(handler));
};
protoOf(CancellableContinuationImpl).ws = function (handler) {
  return invokeOnCancellationImpl(this, handler);
};
protoOf(CancellableContinuationImpl).lu = function (proposedUpdate, resumeMode, onCancellation) {
  // Inline function 'kotlinx.atomicfu.loop' call
  var this_0 = this.qr_1;
  while (true) {
    var tmp0 = this_0.kotlinx$atomicfu$value;
        ...
        if (tmp0 instanceof CancelledContinuation) {
          if (tmp0.qu()) {
            if (onCancellation == null)
              ...
              this.eu(onCancellation, tmp0.zn_1, proposedUpdate);
            }
            return Unit_instance;
          }
        }
...
protoOf(CancellableContinuationImpl).ju = function (proposedUpdate, resumeMode, onCancellation, $super) {
  onCancellation = onCancellation === VOID ? null : onCancellation;
  var tmp;
  if ($super === VOID) {
    this.lu(proposedUpdate, resumeMode, onCancellation);
    tmp = Unit_instance;
  } else {
    tmp = $super.lu.call(this, proposedUpdate, resumeMode, onCancellation);
  }
  return tmp;
};
...
protoOf(CancellableContinuationImpl).ts = function (value, idempotent, onCancellation) {
  return tryResumeImpl(this, value, idempotent, onCancellation);
};
protoOf(CancellableContinuationImpl).xq = function (exception) {
  return tryResumeImpl(this, new CompletedExceptionally(exception), null, null);
};
protoOf(CancellableContinuationImpl).yq = function (token) {
  // Inline function 'kotlinx.coroutines.assert' call
  dispatchResume(this, this.ht_1);
};
protoOf(CancellableContinuationImpl).vs = function (_this__u8e3s4, value) {
  var tmp = this.nr_1;
  var dc = tmp instanceof DispatchedContinuation ? tmp : null;
  var tmp_0;
  if ((dc == null ? null : dc.zs_1) === _this__u8e3s4) {
    tmp_0 = 4;
  } else {
    tmp_0 = this.ht_1;
  }
...
protoOf(CancellableContinuationImpl).hu = function (state) {
  var tmp;
  if (state instanceof CompletedContinuation) {
    var tmp_0 = state.ot_1;
...
protoOf(CancellableContinuationImpl).ru = function (state) {
  var tmp20_safe_receiver = protoOf(DispatchedTask).ru.call(this, state);
  var tmp;
  if (tmp20_safe_receiver == null) {
    tmp = null;
  } else {
    // Inline function 'kotlin.let' call
    tmp = recoverStackTrace(tmp20_safe_receiver, this.nr_1);
  }
  return tmp;
};
protoOf(CancellableContinuationImpl).toString = function () {
  return this.su() + '(' + toDebugString(this.nr_1) + '){' + _get_stateDebugRepresentation__bf18u4(this) + '}@' + get_hexAddress(this);
};
protoOf(CancellableContinuationImpl).su = function () {
...
protoOf(UserSupplied).qq = function (cause) {
  this.vu_1(cause);
};
protoOf(UserSupplied).toString = function () {
  return 'CancelHandler.UserSupplied[' + get_classSimpleName(this.vu_1) + '@' + get_hexAddress(this) + ']';
};
...
function CompletedContinuation(result, cancelHandler, onCancellation, idempotentResume, cancelCause) {
  ...
  this.ot_1 = result;
  this.pt_1 = cancelHandler;
  this.qt_1 = onCancellation;
  this.rt_1 = idempotentResume;
  this.st_1 = cancelCause;
}
protoOf(CompletedContinuation).ut = function () {
  return !(this.st_1 == null);
};
protoOf(CompletedContinuation).bu = function (cont, cause) {
  var tmp21_safe_receiver = this.pt_1;
  if (tmp21_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
    cont.tt(tmp21_safe_receiver, cause);
  }
  var tmp22_safe_receiver = this.qt_1;
  if (tmp22_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
    cont.eu(tmp22_safe_receiver, cause, this.ot_1);
  }
};
protoOf(CompletedContinuation).wu = function (result, cancelHandler, onCancellation, idempotentResume, cancelCause) {
  return new CompletedContinuation(result, cancelHandler, onCancellation, idempotentResume, cancelCause);
};
protoOf(CompletedContinuation).vt = function (result, cancelHandler, onCancellation, idempotentResume, cancelCause, $super) {
  result = result === VOID ? this.ot_1 : result;
  cancelHandler = cancelHandler === VOID ? this.pt_1 : cancelHandler;
  onCancellation = onCancellation === VOID ? this.qt_1 : onCancellation;
  idempotentResume = idempotentResume === VOID ? this.rt_1 : idempotentResume;
  cancelCause = cancelCause === VOID ? this.st_1 : cancelCause;
  return $super === VOID ? this.wu(result, cancelHandler, onCancellation, idempotentResume, cancelCause) : $super.wu.call(this, result, cancelHandler, onCancellation, idempotentResume, cancelCause);
};
protoOf(CompletedContinuation).toString = function () {
  return 'CompletedContinuation(result=' + toString_0(this.ot_1) + ', cancelHandler=' + toString_0(this.pt_1) + ', onCancellation=' + toString_0(this.qt_1) + ', idempotentResume=' + toString_0(this.rt_1) + ', cancelCause=' + toString_0(this.st_1) + ')';
};
...
protoOf(ChildContinuation).tq = function () {
  return true;
};
protoOf(ChildContinuation).qq = function (cause) {
  this.bv_1.du(this.bv_1.fu(this.dr()));
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.kv_1.sp(this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(CompletableDeferredImpl).cp = function () {
  return true;
};
protoOf(CompletableDeferredImpl).wq = function () {
  var tmp = this.rp();
  return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
};
protoOf(CompletableDeferredImpl).os = function ($completion) {
  var tmp = new $awaitCOROUTINE$_0(this, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(CompletableDeferredImpl).nv = function (value) {
  return this.ov(value);
};
protoOf(CompletableDeferredImpl).pv = function (exception) {
  return this.ov(new CompletedExceptionally(exception));
};
...
function CompletedExceptionally(cause, handled) {
  ...
  this.zn_1 = cause;
  this.ao_1 = atomic$boolean$1(handled);
}
protoOf(CompletedExceptionally).bo = function () {
  return this.ao_1.kotlinx$atomicfu$value;
};
protoOf(CompletedExceptionally).wt = function () {
  return this.ao_1.atomicfu$compareAndSet(false, true);
};
protoOf(CompletedExceptionally).toString = function () {
  return get_classSimpleName(this) + '[' + this.zn_1.toString() + ']';
};
function CancelledContinuation(continuation, cause, handled) {
  CompletedExceptionally.call(this, cause == null ? CancellationException_init_$Create$('Continuation ' + toString(continuation) + ' was cancelled normally') : cause, handled);
  this.pu_1 = atomic$boolean$1(false);
}
protoOf(CancelledContinuation).qu = function () {
...
function recoverResult(state, uCont) {
  ...
  if (state instanceof CompletedExceptionally) {
    ...
    var exception = recoverStackTrace(state.zn_1, uCont);
...
protoOf(CoroutineDispatcher).sv = function (context) {
  return true;
};
protoOf(CoroutineDispatcher).uv = function (context, block) {
  return this.tv(context, block);
};
...
function handleCoroutineException(context, exception) {
  try {
    ...
    if (tmp23_safe_receiver == null)
      ...
      // Inline function 'kotlin.let' call
      tmp23_safe_receiver.wv(context, exception);
      return Unit_instance;
    }
  } catch ($p) {
    if ($p instanceof Error) {
...
protoOf(CoroutineName).toString = function () {
  return 'CoroutineName(' + this.yv_1 + ')';
};
protoOf(CoroutineName).hashCode = function () {
  return getStringHashCode(this.yv_1);
};
...
protoOf(GlobalScope).tn = function () {
...
function cancel_0(_this__u8e3s4, cause) {
  cause = cause === VOID ? null : cause;
  var tmp0_elvis_lhs = _this__u8e3s4.tn().h9(Key_instance_3);
  var tmp;
  if (tmp0_elvis_lhs == null) {
...
function CoroutineScope_0(context) {
  return new ContextScope(!(context.h9(Key_instance_3) == null) ? context : context.rh(Job_0()));
}
...
protoOf(CoroutineStart).ko = function (block, receiver, completion) {
  var tmp;
  switch (this.l2_1) {
    case 0:
...
protoOf(CoroutineStart).ur = function () {
...
function delay(timeMillis, $completion) {
  ...
  if (timeMillis.y(new Long(-1, 2147483647)) < 0) {
    get_delay(cancellable.a9()).aw(timeMillis, cancellable);
  }
  return cancellable.tr();
}
...
protoOf(EventLoop).gw = function (task) {
  var tmp0_elvis_lhs = this.ew_1;
  var tmp;
  if (tmp0_elvis_lhs == null) {
...
protoOf(EventLoop).hw = function () {
  return this.cw_1.y(delta(this, true)) >= 0;
};
protoOf(EventLoop).iw = function () {
  var tmp27_safe_receiver = this.ew_1;
  var tmp0_elvis_lhs = tmp27_safe_receiver == null ? null : tmp27_safe_receiver.p();
  return tmp0_elvis_lhs == null ? true : tmp0_elvis_lhs;
};
protoOf(EventLoop).jw = function (unconfined) {
  this.cw_1 = this.cw_1.r2(delta(this, unconfined));
  if (!unconfined)
    this.dw_1 = true;
};
protoOf(EventLoop).kw = function (unconfined) {
  this.cw_1 = this.cw_1.s2(delta(this, unconfined));
  if (this.cw_1.y(new Long(0, 0)) > 0)
    return Unit_instance;
  // Inline function 'kotlinx.coroutines.assert' call
  if (this.dw_1) {
    this.lw();
...
function ThreadLocalEventLoop() {
  ...
  this.mw_1 = commonThreadLocal(new Symbol('ThreadLocalEventLoop'));
}
protoOf(ThreadLocalEventLoop).nw = function () {
  var tmp0_elvis_lhs = this.mw_1.pw();
  var tmp;
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlin.also' call
    var this_0 = createEventLoop();
    ThreadLocalEventLoop_getInstance().mw_1.qw(this_0);
    tmp = this_0;
  } else {
    tmp = tmp0_elvis_lhs;
  }
...
protoOf(NonDisposableHandle).no = function () {
  return null;
};
protoOf(NonDisposableHandle).pq = function () {
};
protoOf(NonDisposableHandle).hp = function (cause) {
  return false;
};
...
function invokeOnCompletion(_this__u8e3s4, invokeImmediately, handler) {
  ...
  if (_this__u8e3s4 instanceof JobSupport) {
    tmp = _this__u8e3s4.zo(invokeImmediately, handler);
  } else {
    var tmp_0 = handler.tq();
    tmp = _this__u8e3s4.xo(tmp_0, invokeImmediately, JobNode$invoke$ref(handler));
  }
  return tmp;
}
function ensureActive_0(_this__u8e3s4) {
  if (!_this__u8e3s4.un())
    throw _this__u8e3s4.to();
}
function cancel_1(_this__u8e3s4, message, cause) {
  cause = cause === VOID ? null : cause;
  return _this__u8e3s4.dp(CancellationException_0(message, cause));
}
...
protoOf(Empty).toString = function () {
  return 'Empty{' + (this.rw_1 ? 'Active' : 'New') + '}';
};
function Incomplete() {
}
function NodeList() {
...
protoOf(NodeList).un = function () {
  return true;
};
protoOf(NodeList).er = function () {
  return this;
};
protoOf(NodeList).vw = function (state) {
...
protoOf(NodeList).toString = function () {
  return get_DEBUG() ? this.vw('Active') : protoOf(LockFreeLinkedListHead).toString.call(this);
};
function JobNode() {
...
function finalizeFinishingState($this, state, proposedUpdate) {
  ...
  var proposedException = tmp46_safe_receiver == null ? null : tmp46_safe_receiver.zn_1;
  var wasCancelling;
  // Inline function 'kotlinx.coroutines.internal.synchronized' call
  // Inline function 'kotlinx.coroutines.internal.synchronizedImpl' call
  wasCancelling = state.bx();
  var exceptions = state.cx(proposedException);
  ...
  if (!(finalException == null)) {
    var handled = cancelParent($this, finalException) || $this.pp(finalException);
    if (handled) {
      (finalState instanceof CompletedExceptionally ? finalState : THROW_CCE()).wt();
    }
  }
  if (!wasCancelling) {
    $this.mp(finalException);
  }
  $this.yn(finalState);
  var casSuccess = $this.nn_1.atomicfu$compareAndSet(state, boxIncomplete(finalState));
  // Inline function 'kotlinx.coroutines.assert' call
...
function getFinalRootCause($this, state, exceptions) {
  if (exceptions.p()) {
    if (state.bx()) {
      ...
      return new JobCancellationException(null == null ? $this.xn() : null, null, $this);
    }
    return null;
  }
  var tmp$ret$2;
...
function tryFinalizeSimpleState($this, state, update) {
  // Inline function 'kotlinx.coroutines.assert' call
  // Inline function 'kotlinx.coroutines.assert' call
  if (!$this.nn_1.atomicfu$compareAndSet(state, boxIncomplete(update)))
    return false;
  $this.mp(null);
  $this.yn(update);
...
function completeStateFinalization($this, state, update) {
  var tmp47_safe_receiver = $this.mo();
  if (tmp47_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
    tmp47_safe_receiver.pq();
    $this.lo(NonDisposableHandle_instance);
  }
  var tmp48_safe_receiver = update instanceof CompletedExceptionally ? update : null;
  var cause = tmp48_safe_receiver == null ? null : tmp48_safe_receiver.zn_1;
  if (state instanceof JobNode) {
    try {
      ...
      if ($p instanceof Error) {
        var ex = $p;
        $this.fo(new CompletionHandlerException('Exception in completion handler ' + state.toString() + ' for ' + $this.toString(), ex));
      } else {
        throw $p;
      }
    }
  } else {
    var tmp49_safe_receiver = state.er();
...
function cancelParent($this, cause) {
  ...
  return parent.hp(cause) || isCancellation;
}
...
function startInternal($this, state) {
  if (state instanceof Empty) {
    if (state.rw_1)
      return 0;
    if (!$this.nn_1.atomicfu$compareAndSet(state, get_EMPTY_ACTIVE()))
      return -1;
    $this.so();
    return 1;
  } else {
    if (state instanceof InactiveNodeList) {
      if (!$this.nn_1.atomicfu$compareAndSet(state, state.dx_1))
        return -1;
      $this.so();
      return 1;
    } else {
...
function promoteEmptyToNodeList($this, state) {
  ...
  var update = state.rw_1 ? list : new InactiveNodeList(list);
  $this.nn_1.atomicfu$compareAndSet(state, update);
}
function promoteSingleToNodeList($this, state) {
  state.kr(new NodeList());
  // Inline function 'kotlinx.coroutines.internal.LockFreeLinkedListNode.nextNode' call
  var list = state.fr_1;
  $this.nn_1.atomicfu$compareAndSet(state, list);
}
...
function createCauseException($this, cause) {
  ...
  if (cause == null ? true : cause instanceof Error) {
    ...
    if (cause == null) {
      // Inline function 'kotlinx.coroutines.JobSupport.defaultCancellationException' call
      tmp_0 = new JobCancellationException(null == null ? $this.xn() : null, null, $this);
    } else {
      tmp_0 = cause;
    }
    tmp = tmp_0;
  } else {
    tmp = ((!(cause == null) ? isInterface(cause, ParentJob) : false) ? cause : THROW_CCE()).kp();
  }
  return tmp;
}
    ...
    $l$block: {
      if (tmp0 instanceof Finishing) {
        ...
        if (notifyRootCause == null)
          ...
          // Inline function 'kotlin.let' call
          notifyCancelling($this, tmp0.xw_1, notifyRootCause);
        }
        return get_COMPLETING_ALREADY();
      } else {
...
function tryMakeCancelling($this, state, rootCause) {
  ...
  if (!$this.nn_1.atomicfu$compareAndSet(state, cancelling))
    return false;
...
function tryMakeCompletingSlowPath($this, state, proposedUpdate) {
  ...
  finishing.ix(true);
  if (!(finishing === state)) {
    if (!$this.nn_1.atomicfu$compareAndSet(state, finishing))
      return get_COMPLETING_RETRY();
  }
  // Inline function 'kotlinx.coroutines.assert' call
  var wasCancelling = finishing.bx();
  var tmp65_safe_receiver = proposedUpdate instanceof CompletedExceptionally ? proposedUpdate : null;
  if (tmp65_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
    finishing.gx(tmp65_safe_receiver.zn_1);
  }
  // Inline function 'kotlin.takeIf' call
  var this_0 = finishing.hx();
  var tmp_0;
  if (!wasCancelling) {
    tmp_0 = this_0;
  } else {
...
function _get_exceptionOrNull__b3j7js($this, _this__u8e3s4) {
  ...
  return tmp67_safe_receiver == null ? null : tmp67_safe_receiver.zn_1;
}
function tryWaitForChild($this, state, child, proposedUpdate) {
  ...
  $l$1: do {
    $l$0: do {
      var handle = invokeOnCompletion(child_0.nx_1, false, new ChildCompletion($this_0, state_0, child_0, proposedUpdate_0));
...
function stateString($this, state) {
  var tmp;
  if (state instanceof Finishing) {
    tmp = state.bx() ? 'Cancelling' : state.ex() ? 'Completing' : 'Active';
  } else {
    if (!(state == null) ? isInterface(state, Incomplete) : false) {
      tmp = state.un() ? 'Active' : 'New';
    } else {
      if (state instanceof CompletedExceptionally) {
        tmp = 'Cancelled';
      } else {
...
function Finishing(list, isCompleting, rootCause) {
  ...
  this.xw_1 = list;
  this.yw_1 = atomic$boolean$1(isCompleting);
  this.zw_1 = atomic$ref$1(rootCause);
...
protoOf(Finishing).ix = function (value) {
  this.yw_1.kotlinx$atomicfu$value = value;
};
protoOf(Finishing).ex = function () {
  return this.yw_1.kotlinx$atomicfu$value;
};
protoOf(Finishing).ox = function (value) {
  this.zw_1.kotlinx$atomicfu$value = value;
};
protoOf(Finishing).hx = function () {
  return this.zw_1.kotlinx$atomicfu$value;
};
...
protoOf(Finishing).un = function () {
  return this.hx() == null;
};
protoOf(Finishing).cx = function (proposedException) {
...
protoOf(Finishing).gx = function (exception) {
  var rootCause = this.hx();
  if (rootCause == null) {
    this.ox(exception);
    return Unit_instance;
...
protoOf(Finishing).toString = function () {
  return 'Finishing[cancelling=' + this.bx() + ', completing=' + this.ex() + ', rootCause=' + toString_0(this.hx()) + ', exceptions=' + toString_0(_get_exceptionsHolder__nhszp(this)) + ', list=' + this.xw_1.toString() + ']';
};
function ChildCompletion(parent, state, child, proposedUpdate) {
  ...
  this.ux_1 = state;
  this.vx_1 = child;
  this.wx_1 = proposedUpdate;
}
protoOf(ChildCompletion).tq = function () {
  return false;
};
protoOf(ChildCompletion).qq = function (cause) {
  continueCompleting(this.tx_1, this.ux_1, this.vx_1, this.wx_1);
};
function AwaitContinuation(delegate, job) {
  CancellableContinuationImpl.call(this, delegate, 1);
  this.dy_1 = job;
}
protoOf(AwaitContinuation).fu = function (parent) {
  var state = this.dy_1.oo();
  if (state instanceof Finishing) {
    var tmp73_safe_receiver = state.hx();
...
protoOf(AwaitContinuation).su = function () {
...
function JobSupport(active) {
  this.nn_1 = atomic$ref$1(active ? get_EMPTY_ACTIVE() : get_EMPTY_NEW());
  this.on_1 = atomic$ref$1(null);
}
protoOf(JobSupport).s = function () {
  return Key_instance_3;
};
protoOf(JobSupport).lo = function (value) {
  this.on_1.kotlinx$atomicfu$value = value;
};
protoOf(JobSupport).mo = function () {
  return this.on_1.kotlinx$atomicfu$value;
};
protoOf(JobSupport).no = function () {
  var tmp45_safe_receiver = this.mo();
  return tmp45_safe_receiver == null ? null : tmp45_safe_receiver.no();
};
protoOf(JobSupport).pn = function (parent) {
  // Inline function 'kotlinx.coroutines.assert' call
  if (parent == null) {
    this.lo(NonDisposableHandle_instance);
    return Unit_instance;
...
protoOf(JobSupport).po = function () {
  var tmp = this.oo();
...
protoOf(JobSupport).to = function () {
  ...
  var tmp;
  if (state instanceof Finishing) {
    var tmp54_safe_receiver = state.hx();
    var tmp0_elvis_lhs = tmp54_safe_receiver == null ? null : this.uo(tmp54_safe_receiver, get_classSimpleName(this) + ' is cancelling');
    var tmp_0;
    if (tmp0_elvis_lhs == null) {
...
protoOf(JobSupport).uo = function (_this__u8e3s4, message) {
  var tmp0_elvis_lhs = _this__u8e3s4 instanceof CancellationException ? _this__u8e3s4 : null;
  var tmp;
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlinx.coroutines.JobSupport.defaultCancellationException' call
    tmp = new JobCancellationException(message == null ? this.xn() : message, _this__u8e3s4, this);
  } else {
    tmp = tmp0_elvis_lhs;
  }
  return tmp;
};
protoOf(JobSupport).vo = function (_this__u8e3s4, message, $super) {
  message = message === VOID ? null : message;
  return $super === VOID ? this.uo(_this__u8e3s4, message) : $super.uo.call(this, _this__u8e3s4, message);
};
protoOf(JobSupport).wo = function (handler) {
  return this.zo(true, new InvokeOnCompletion(handler));
};
protoOf(JobSupport).xo = function (onCancelling, invokeImmediately, handler) {
  var tmp;
  if (onCancelling) {
  ...
  return this.zo(invokeImmediately, tmp);
};
protoOf(JobSupport).zo = function (invokeImmediately, node) {
  node.cr_1 = this;
  var tmp$ret$0;
  $l$block_1: {
    ...
    while (true) {
      ...
      if (state instanceof Empty) {
        if (state.rw_1) {
          if (this.nn_1.atomicfu$compareAndSet(state, node)) {
            tmp$ret$0 = true;
            break $l$block_1;
          }
        } else {
        ...
        if (!(state == null) ? isInterface(state, Incomplete) : false) {
          ...
          if (list == null) {
            ...
            if (node.tq()) {
              ...
              var rootCause = tmp55_safe_receiver == null ? null : tmp55_safe_receiver.hx();
              var tmp_0;
              if (rootCause == null) {
                tmp_0 = list.ir(node, 5);
              } else {
  ...
  if (added)
    ...
    node.qq(tmp56_safe_receiver == null ? null : tmp56_safe_receiver.zn_1);
  }
  return NonDisposableHandle_instance;
};
protoOf(JobSupport).ap = function ($completion) {
...
protoOf(JobSupport).bp = function (node) {
  // Inline function 'kotlinx.coroutines.JobSupport.loopOnState' call
  while (true) {
    var state = this.oo();
    if (state instanceof JobNode) {
...
protoOf(JobSupport).dp = function (cause) {
  var tmp;
  if (cause == null) {
    // Inline function 'kotlinx.coroutines.JobSupport.defaultCancellationException' call
    tmp = new JobCancellationException(null == null ? this.xn() : null, null, this);
  } else {
    tmp = cause;
  }
  this.fp(tmp);
};
protoOf(JobSupport).xn = function () {
  return 'Job was cancelled';
};
protoOf(JobSupport).fp = function (cause) {
  this.jp(cause);
};
protoOf(JobSupport).gp = function (parentJob) {
  this.jp(parentJob);
};
protoOf(JobSupport).hp = function (cause) {
  if (cause instanceof CancellationException)
    return true;
  return this.jp(cause) && this.op();
};
protoOf(JobSupport).ip = function (cause) {
  return this.jp(cause);
};
...
protoOf(JobSupport).ov = function (proposedUpdate) {
  // Inline function 'kotlinx.coroutines.JobSupport.loopOnState' call
  while (true) {
    var tmp0 = this.oo();
    $l$block: {
...
protoOf(JobSupport).co = function (proposedUpdate) {
  // Inline function 'kotlinx.coroutines.JobSupport.loopOnState' call
  while (true) {
    var tmp0 = this.oo();
    $l$block: {
...
protoOf(JobSupport).lp = function (child) {
  // Inline function 'kotlin.also' call
      ...
      if (state instanceof Empty) {
        ...
        if (!(state == null) ? isInterface(state, Incomplete) : false) {
          ...
          if (list == null) {
            ...
            var addedBeforeCancellation = list.ir(node, 7);
            var tmp;
            if (addedBeforeCancellation) {
              tmp = true;
            } else {
              var addedBeforeCompletion = list.ir(node, 3);
              var latestState = this.oo();
              var tmp_0;
              if (latestState instanceof Finishing) {
                tmp_0 = latestState.hx();
              } else {
                // Inline function 'kotlinx.coroutines.assert' call
                var tmp69_safe_receiver = latestState instanceof CompletedExceptionally ? latestState : null;
                tmp_0 = tmp69_safe_receiver == null ? null : tmp69_safe_receiver.zn_1;
              }
              var rootCause = tmp_0;
              node.qq(rootCause);
              var tmp_1;
  ...
  node.qq(tmp70_safe_receiver == null ? null : tmp70_safe_receiver.zn_1);
  return NonDisposableHandle_instance;
};
protoOf(JobSupport).fo = function (exception) {
  throw exception;
};
...
protoOf(JobSupport).pp = function (exception) {
  return false;
};
protoOf(JobSupport).yn = function (state) {
};
protoOf(JobSupport).eo = function (state) {
};
protoOf(JobSupport).toString = function () {
  return this.qp() + '@' + get_hexAddress(this);
};
protoOf(JobSupport).qp = function () {
  return this.go() + '{' + stateString(this, this.oo()) + '}';
};
...
protoOf(JobSupport).sp = function ($completion) {
  $l$loop: while (true) {
    var state = this.oo();
    if (!(!(state == null) ? isInterface(state, Incomplete) : false)) {
      if (state instanceof CompletedExceptionally) {
...
protoOf(InactiveNodeList).un = function () {
  return false;
};
protoOf(InactiveNodeList).toString = function () {
  return get_DEBUG() ? this.dx_1.vw('New') : anyToString(this);
};
function InvokeOnCompletion(handler) {
  JobNode.call(this);
  this.iy_1 = handler;
}
protoOf(InvokeOnCompletion).tq = function () {
  return false;
};
protoOf(InvokeOnCompletion).qq = function (cause) {
  return this.iy_1(cause);
};
function InvokeOnCancelling(handler) {
  JobNode.call(this);
  this.ny_1 = handler;
  this.oy_1 = atomic$boolean$1(false);
}
protoOf(InvokeOnCancelling).tq = function () {
  return true;
};
protoOf(InvokeOnCancelling).qq = function (cause) {
  if (this.oy_1.atomicfu$compareAndSet(false, true))
    this.ny_1(cause);
};
...
protoOf(ResumeOnCompletion).tq = function () {
  return false;
};
protoOf(ResumeOnCompletion).qq = function (cause) {
  // Inline function 'kotlin.coroutines.resume' call
  var this_0 = this.ty_1;
  // Inline function 'kotlin.Companion.success' call
...
protoOf(ChildHandleNode).no = function () {
  return this.dr();
};
protoOf(ChildHandleNode).tq = function () {
  return true;
};
protoOf(ChildHandleNode).qq = function (cause) {
  return this.nx_1.gp(this.dr());
};
protoOf(ChildHandleNode).hp = function (cause) {
  return this.dr().hp(cause);
};
function unboxState(_this__u8e3s4) {
  _init_properties_JobSupport_kt__68f172();
  var tmp74_safe_receiver = _this__u8e3s4 instanceof IncompleteStateBox ? _this__u8e3s4 : null;
  var tmp0_elvis_lhs = tmp74_safe_receiver == null ? null : tmp74_safe_receiver.uy_1;
  return tmp0_elvis_lhs == null ? _this__u8e3s4 : tmp0_elvis_lhs;
}
function ResumeAwaitOnCompletion(continuation) {
  JobNode.call(this);
  this.zy_1 = continuation;
}
protoOf(ResumeAwaitOnCompletion).tq = function () {
  return false;
};
protoOf(ResumeAwaitOnCompletion).qq = function (cause) {
  var state = this.dr().oo();
  // Inline function 'kotlinx.coroutines.assert' call
  if (state instanceof CompletedExceptionally) {
    var tmp0 = this.zy_1;
    // Inline function 'kotlin.coroutines.resumeWithException' call
    // Inline function 'kotlin.Companion.failure' call
    var exception = state.zn_1;
    var tmp$ret$1 = _Result___init__impl__xyqfz8(createFailure(exception));
    tmp0.f9(tmp$ret$1);
  } else {
    var tmp0_0 = this.zy_1;
...
function handlesExceptionF($this) {
  ...
  var tmp0_elvis_lhs = tmp75_safe_receiver == null ? null : tmp75_safe_receiver.dr();
  var tmp_0;
  if (tmp0_elvis_lhs == null) {
    return false;
  } else {
  ...
  while (true) {
    if (parentJob.op())
      return true;
    var tmp_1 = parentJob.mo();
    var tmp76_safe_receiver = tmp_1 instanceof ChildHandleNode ? tmp_1 : null;
    var tmp1_elvis_lhs = tmp76_safe_receiver == null ? null : tmp76_safe_receiver.dr();
    var tmp_2;
    if (tmp1_elvis_lhs == null) {
      return false;
    } else {
...
function JobImpl(parent) {
  JobSupport.call(this, true);
  this.pn(parent);
  this.cz_1 = handlesExceptionF(this);
}
protoOf(JobImpl).cp = function () {
  return true;
};
protoOf(JobImpl).op = function () {
  return this.cz_1;
};
protoOf(JobImpl).qv = function () {
  return this.ov(Unit_instance);
};
protoOf(JobImpl).pv = function (exception) {
  return this.ov(new CompletedExceptionally(exception));
};
...
protoOf(MainCoroutineDispatcher).toString = function () {
  var tmp0_elvis_lhs = this.fz();
  return tmp0_elvis_lhs == null ? get_classSimpleName(this) + '@' + get_hexAddress(this) : tmp0_elvis_lhs;
};
protoOf(MainCoroutineDispatcher).fz = function () {
  var main = Dispatchers_getInstance().kz();
  if (this === main)
...
protoOf(SupervisorJobImpl).hp = function (cause) {
  return false;
};
...
protoOf(Unconfined).sv = function (context) {
  return false;
};
protoOf(Unconfined).tv = function (context, block) {
  var yieldContext = context.h9(Key_instance_4);
  if (!(yieldContext == null)) {
    yieldContext.qz_1 = true;
    return Unit_instance;
  }
...
function yield_0($completion) {
  ...
  $l$block_0: {
    ...
    var cont = tmp_0;
    if (cont.zs_1.sv(context)) {
      cont.rz(context, Unit_instance);
    } else {
      var yieldContext = new YieldContext();
      cont.rz(context.rh(yieldContext), Unit_instance);
      if (yieldContext.qz_1) {
...
function setElementLazy($this, index, value) {
  ...
  $this.xz_1.atomicfu$get(imul(index, 2)).kotlinx$atomicfu$value = value;
}
function ChannelSegment(id, prev, channel, pointers) {
  Segment.call(this, id, prev, pointers);
  this.wz_1 = channel;
  this.xz_1 = atomicfu$AtomicRefArray$ofNulls(imul(get_SEGMENT_SIZE(), 2));
}
protoOf(ChannelSegment).yz = function () {
  return ensureNotNull(this.wz_1);
};
protoOf(ChannelSegment).zz = function () {
  return get_SEGMENT_SIZE();
};
protoOf(ChannelSegment).a10 = function (index, element) {
  setElementLazy(this, index, element);
};
protoOf(ChannelSegment).b10 = function (index) {
  var tmp = this.xz_1.atomicfu$get(imul(index, 2)).kotlinx$atomicfu$value;
  return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
};
protoOf(ChannelSegment).c10 = function (index) {
  // Inline function 'kotlin.also' call
  var this_0 = this.b10(index);
  this.d10(index);
  return this_0;
};
protoOf(ChannelSegment).d10 = function (index) {
  setElementLazy(this, index, null);
};
protoOf(ChannelSegment).e10 = function (index) {
  return this.xz_1.atomicfu$get(imul(index, 2) + 1 | 0).kotlinx$atomicfu$value;
};
protoOf(ChannelSegment).f10 = function (index, value) {
  this.xz_1.atomicfu$get(imul(index, 2) + 1 | 0).kotlinx$atomicfu$value = value;
};
protoOf(ChannelSegment).g10 = function (index, from, to) {
  return this.xz_1.atomicfu$get(imul(index, 2) + 1 | 0).atomicfu$compareAndSet(from, to);
};
protoOf(ChannelSegment).h10 = function (index, update) {
  return this.xz_1.atomicfu$get(imul(index, 2) + 1 | 0).atomicfu$getAndSet(update);
};
protoOf(ChannelSegment).nt = function (index, cause, context) {
  var isSender = index >= get_SEGMENT_SIZE();
  var index_0 = isSender ? index - get_SEGMENT_SIZE() | 0 : index;
  var element = this.b10(index_0);
  $l$loop: while (true) {
    var cur = this.e10(index_0);
    var tmp;
    ...
    if (tmp) {
      ...
      if (this.g10(index_0, cur, update)) {
        this.d10(index_0);
        this.u10(index_0, !isSender);
        if (isSender) {
          var tmp109_safe_receiver = this.yz().j10_1;
      ...
      if (cur === get_INTERRUPTED_SEND() || cur === get_INTERRUPTED_RCV()) {
        this.d10(index_0);
        if (isSender) {
          var tmp110_safe_receiver = this.yz().j10_1;
...
protoOf(ChannelSegment).u10 = function (index, receiver) {
  if (receiver) {
    var tmp = this.yz();
    var tmp0 = this.lt_1;
...
function onClosedHasNext($this) {
  $this.i11_1 = get_CHANNEL_CLOSED();
  var tmp0_elvis_lhs = $this.k11_1.l11();
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return false;
  } else {
  ...
  try {
    ...
    if (updCellResult === get_SUSPEND()) {
      ...
      $l$block_0: {
        ...
        var segment_0 = this_0.p10_1.kotlinx$atomicfu$value;
        $l$loop_0: while (true) {
          if (this_0.n11()) {
            onClosedHasNextNoWaiterSuspend($this);
            break $l$block_0;
          }
          var r_0 = this_0.l10_1.atomicfu$getAndIncrement$long();
          ...
          if (updCellResult_0 === get_SUSPEND()) {
            ...
            $this.i11_1 = element;
            $this.j11_1 = null;
            var tmp96_safe_receiver = $this.k11_1.j10_1;
            cancellable.ku(true, tmp96_safe_receiver == null ? null : bindCancellationFun($this.k11_1, tmp96_safe_receiver, element));
          }
          break $l$block_0;
        }
      }
      ...
      $this.i11_1 = element_0;
      $this.j11_1 = null;
      var tmp96_safe_receiver_0 = $this.k11_1.j10_1;
      cancellable.ku(true, tmp96_safe_receiver_0 == null ? null : bindCancellationFun($this.k11_1, tmp96_safe_receiver_0, element_0));
    }
  } catch ($p) {
    if ($p instanceof Error) {
      var e = $p;
...
function onClosedHasNextNoWaiterSuspend($this) {
  var cont = ensureNotNull($this.j11_1);
  $this.j11_1 = null;
  $this.i11_1 = get_CHANNEL_CLOSED();
  var cause = $this.k11_1.l11();
  if (cause == null) {
    // Inline function 'kotlin.coroutines.resume' call
    // Inline function 'kotlin.Companion.success' call
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 8;
          if (!(this.w11_1.i11_1 === get_NO_RECEIVE_RESULT()) && !(this.w11_1.i11_1 === get_CHANNEL_CLOSED())) {
            var tmp_0 = this;
            tmp_0.x11_1 = true;
            this.u8_1 = 11;
            continue $sm;
        ...
        case 1:
          this.b12_1 = this.y11_1;
          this.c12_1 = this.z11_1;
          this.d12_1 = this.b12_1.p10_1.kotlinx$atomicfu$value;
          this.u8_1 = 2;
          continue $sm;
        case 2:
          if (!true) {
          ...
          if (this.b12_1.n11()) {
            var tmp_3 = this;
            tmp_3.a12_1 = onClosedHasNext(this.w11_1);
            this.u8_1 = 10;
            continue $sm;
          } else {
            this.u8_1 = 3;
        ...
        case 3:
          this.e12_1 = this.b12_1.l10_1.atomicfu$getAndIncrement$long();
          var tmp_4 = this;
          var tmp0 = this.e12_1;
          var other = get_SEGMENT_SIZE();
          tmp_4.f12_1 = tmp0.u2(toLong(other));
          var tmp_5 = this;
          var tmp0_0 = this.e12_1;
          var other_0 = get_SEGMENT_SIZE();
          tmp_5.g12_1 = tmp0_0.v2(toLong(other_0)).d1();
          if (!this.d12_1.lt_1.equals(this.f12_1)) {
            this.h12_1 = findSegmentReceive(this.b12_1, this.f12_1, this.d12_1);
            if (this.h12_1 == null) {
              this.u8_1 = 2;
              var tmp_6 = this;
              continue $sm;
        ...
        case 4:
          this.d12_1 = this.i12_1;
          this.u8_1 = 5;
          continue $sm;
        case 5:
          this.j12_1 = updateCellReceive(this.b12_1, this.d12_1, this.g12_1, this.e12_1, this.c12_1);
          if (this.j12_1 === get_SUSPEND()) {
            var tmp_7 = this;
            var tmp_8 = this.c12_1;
            var tmp92_safe_receiver = (!(tmp_8 == null) ? isInterface(tmp_8, Waiter) : false) ? tmp_8 : null;
            if (tmp92_safe_receiver == null)
              null;
            else {
              prepareReceiverForSuspension(this.b12_1, tmp92_safe_receiver, this.d12_1, this.g12_1);
            }
            this.d12_1;
            this.g12_1;
            this.e12_1;
            ...
            if (this.j12_1 === get_FAILED()) {
              if (this.e12_1.y(this.b12_1.m11()) < 0) {
                this.d12_1.g11();
              }
              this.u8_1 = 2;
              var tmp_9 = this;
              ...
              if (this.j12_1 === get_SUSPEND_NO_WAITER()) {
                var tmp_10 = this;
                tmp_10.l12_1 = this.d12_1;
                var tmp_11 = this;
                tmp_11.m12_1 = this.g12_1;
                var tmp_12 = this;
                tmp_12.n12_1 = this.e12_1;
                this.o12_1 = this.l12_1;
                this.p12_1 = this.m12_1;
                this.q12_1 = this.n12_1;
                this.u8_1 = 6;
                suspendResult = hasNextOnNoWaiterSuspend(this.w11_1, this.o12_1, this.p12_1, this.q12_1, this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
...
function onClosedSend($this, element, $completion) {
  ...
  cancellable.sr();
  $l$block: {
    var tmp79_safe_receiver = $this.j10_1;
    ...
    if (tmp80_safe_receiver == null)
      ...
      // Inline function 'kotlin.let' call
      addSuppressed(tmp80_safe_receiver, $this.r12());
    ...
    switch (updateCellSend($this, segment, index, element, s, cancellable, false)) {
      ...
      case 5:
        ...
        $l$block_5: {
          ...
          var segment_0 = $this.o10_1.kotlinx$atomicfu$value;
          $l$loop_0: while (true) {
            var sendersAndCloseStatusCur = $this.k10_1.atomicfu$getAndIncrement$long();
...
function prepareSenderForSuspension($this, _this__u8e3s4, segment, index) {
  _this__u8e3s4.mu(segment, index + get_SEGMENT_SIZE() | 0);
}
function onClosedSendOnNoWaiterSuspend($this, element, cont) {
  var tmp81_safe_receiver = $this.j10_1;
  ...
  // Inline function 'kotlin.coroutines.resumeWithException' call
  // Inline function 'kotlin.Companion.failure' call
  var exception = recoverStackTrace($this.r12(), cont);
  var tmp$ret$0 = _Result___init__impl__xyqfz8(createFailure(exception));
  cont.f9(tmp$ret$0);
}
...
function updateCellSend($this, segment, index, element, s, waiter, closed) {
  segment.a10(index, element);
  if (closed)
    return updateCellSendSlow($this, segment, index, element, s, waiter, closed);
  var state = segment.e10(index);
  if (state === null) {
    if (bufferOrRendezvousSend($this, s)) {
      if (segment.g10(index, null, get_BUFFERED())) {
        return 1;
      }
    } else {
      if (waiter == null) {
        ...
        if (segment.g10(index, null, waiter))
          return 2;
      }
    }
  } else {
    if (!(state == null) ? isInterface(state, Waiter) : false) {
      ...
      if (tryResumeReceiver($this, state, element)) {
        segment.f10(index, get_DONE_RCV());
        $this.t12();
        tmp = 0;
      } else {
        if (!(segment.h10(index, get_INTERRUPTED_RCV()) === get_INTERRUPTED_RCV())) {
          segment.u10(index, true);
        }
        tmp = 5;
      }
      return tmp;
  ...
  while (true) {
    ...
    if (state === null) {
      if (bufferOrRendezvousSend($this, s) && !closed) {
        ...
        if (closed) {
          if (segment.g10(index, null, get_INTERRUPTED_SEND())) {
            segment.u10(index, false);
            return 4;
          }
        } else if (waiter == null)
          return 3;
        else if (segment.g10(index, null, waiter))
          return 2;
      }
    } else if (state === get_IN_BUFFER()) {
      if (segment.g10(index, state, get_BUFFERED())) {
        return 1;
      }
...
function tryResumeReceiver($this, _this__u8e3s4, element) {
  ...
  if (isInterface(_this__u8e3s4, SelectInstance)) {
    tmp = _this__u8e3s4.z12($this, element);
  } else {
    if (_this__u8e3s4 instanceof ReceiveCatching) {
      if (!(_this__u8e3s4 instanceof ReceiveCatching))
        THROW_CCE();
      var tmp_0 = Companion_getInstance().x12(element);
      var tmp86_safe_receiver = $this.j10_1;
      tmp = tryResume0(_this__u8e3s4.y12_1, new ChannelResult(tmp_0), tmp86_safe_receiver == null ? null : bindCancellationFunResult($this, tmp86_safe_receiver));
    } else {
      if (_this__u8e3s4 instanceof BufferedChannelIterator) {
        if (!(_this__u8e3s4 instanceof BufferedChannelIterator))
          THROW_CCE();
        tmp = _this__u8e3s4.v12(element);
      } else {
        if (isInterface(_this__u8e3s4, CancellableContinuation)) {
          if (!isInterface(_this__u8e3s4, CancellableContinuation))
            THROW_CCE();
          var tmp87_safe_receiver = $this.j10_1;
...
function prepareReceiverForSuspension($this, _this__u8e3s4, segment, index) {
  $this.a13();
  _this__u8e3s4.mu(segment, index);
}
function receiveCatchingOnNoWaiterSuspend($this, segment, index, r, $completion) {
  ...
  try {
    ...
    if (updCellResult === get_SUSPEND()) {
      ...
      $l$block_0: {
        // Inline function 'kotlinx.coroutines.channels.BufferedChannel.receiveImpl' call
        var segment_0 = $this.p10_1.kotlinx$atomicfu$value;
        $l$loop_0: while (true) {
          if ($this.n11()) {
            onClosedReceiveCatchingOnNoWaiterSuspend($this, cancellable);
            break $l$block_0;
          }
          var r_0 = $this.l10_1.atomicfu$getAndIncrement$long();
          // Inline function 'kotlin.Long.div' call
          var other = get_SEGMENT_SIZE();
          var id = r_0.u2(toLong(other));
          // Inline function 'kotlin.Long.rem' call
          ...
          if (updCellResult_0 === get_SUSPEND()) {
            ...
            var element = (updCellResult_0 == null ? true : !(updCellResult_0 == null)) ? updCellResult_0 : THROW_CCE();
            var tmp_0 = Companion_getInstance().x12(element);
            var tmp89_safe_receiver = $this.j10_1;
            cancellable.ku(new ChannelResult(tmp_0), tmp89_safe_receiver == null ? null : bindCancellationFunResult($this, tmp89_safe_receiver));
          }
          break $l$block_0;
        }
      }
      ...
      segment.g11();
      var element_0 = (updCellResult == null ? true : !(updCellResult == null)) ? updCellResult : THROW_CCE();
      var tmp_1 = Companion_getInstance().x12(element_0);
      var tmp89_safe_receiver_0 = $this.j10_1;
      cancellable.ku(new ChannelResult(tmp_1), tmp89_safe_receiver_0 == null ? null : bindCancellationFunResult($this, tmp89_safe_receiver_0));
    }
  } catch ($p) {
    if ($p instanceof Error) {
      var e = $p;
...
function onClosedReceiveCatchingOnNoWaiterSuspend($this, cont) {
  // Inline function 'kotlin.coroutines.resume' call
  // Inline function 'kotlin.Companion.success' call
  var value = new ChannelResult(Companion_getInstance().c13($this.l11()));
...
function updateCellReceive($this, segment, index, r, waiter) {
  ...
  if (state === null) {
    // Inline function 'kotlinx.coroutines.channels.sendersCounter' call
    var senders = $this.k10_1.kotlinx$atomicfu$value.d3(new Long(-1, 268435455));
    if (r.y(senders) >= 0) {
      if (waiter === null) {
        return get_SUSPEND_NO_WAITER();
      }
      if (segment.g10(index, state, waiter)) {
        expandBuffer($this);
        return get_SUSPEND();
      }
    }
  } else if (state === get_BUFFERED())
    if (segment.g10(index, state, get_DONE_RCV())) {
      expandBuffer($this);
      return segment.c10(index);
    }
...
function updateCellReceiveSlow($this, segment, index, r, waiter) {
  $l$loop: while (true) {
    ...
    if (state === null || state === get_IN_BUFFER()) {
      ...
      var senders = $this.k10_1.kotlinx$atomicfu$value.d3(new Long(-1, 268435455));
      if (r.y(senders) < 0) {
        if (segment.g10(index, state, get_POISONED())) {
          expandBuffer($this);
          return get_FAILED();
        }
      } else {
      ...
      if (segment.g10(index, state, get_RESUMING_BY_RCV())) {
        ...
        if (tryResumeSender($this, sender, segment, index)) {
          segment.f10(index, get_DONE_RCV());
          expandBuffer($this);
          tmp_0 = segment.c10(index);
        } else {
          segment.f10(index, get_INTERRUPTED_SEND());
          segment.u10(index, false);
          if (helpExpandBuffer) {
            expandBuffer($this);
          }
  ...
  if (isInterface(_this__u8e3s4, CancellableContinuation)) {
    ...
    if (isInterface(_this__u8e3s4, SelectInstance)) {
      if (!(_this__u8e3s4 instanceof SelectImplementation))
        THROW_CCE();
      var trySelectResult = _this__u8e3s4.h13($this, Unit_instance);
      ...
      if (_this__u8e3s4 instanceof SendBroadcast) {
        tmp = tryResume0(_this__u8e3s4.d13_1, true);
      } else {
...
function expandBuffer($this) {
  if (_get_isRendezvousOrUnlimited__3mdufi($this))
    return Unit_instance;
  var segment = $this.q10_1.kotlinx$atomicfu$value;
  try_again: while (true) {
    var b = $this.m10_1.atomicfu$getAndIncrement$long();
    // Inline function 'kotlin.Long.div' call
    var other = get_SEGMENT_SIZE();
    var id = b.u2(toLong(other));
    var s = $this.m11();
    if (s.y(b) <= 0) {
      if (segment.lt_1.y(id) < 0 && !(segment.c11() == null)) {
        moveSegmentBufferEndToSpecifiedOrLast($this, id, segment);
      }
      incCompletedExpandBufferAttempts$default($this);
      return Unit_instance;
    }
    if (!segment.lt_1.equals(id)) {
...
function updateCellExpandBuffer($this, segment, index, b) {
  var state = segment.e10(index);
  if (!(state == null) ? isInterface(state, Waiter) : false) {
    if (b.y($this.l10_1.kotlinx$atomicfu$value) >= 0) {
      if (segment.g10(index, state, get_RESUMING_BY_EB())) {
        var tmp;
        if (tryResumeSender($this, state, segment, index)) {
          segment.f10(index, get_BUFFERED());
          tmp = true;
        } else {
          segment.f10(index, get_INTERRUPTED_SEND());
          segment.u10(index, false);
...
function updateCellExpandBufferSlow($this, segment, index, b) {
  $l$loop: while (true) {
    ...
    if (!(state == null) ? isInterface(state, Waiter) : false) {
      if (b.y($this.l10_1.kotlinx$atomicfu$value) < 0) {
        if (segment.g10(index, state, new WaiterEB(state)))
          return true;
      } else {
        if (segment.g10(index, state, get_RESUMING_BY_EB())) {
          var tmp;
      ...
      if (state === get_INTERRUPTED_SEND())
        ...
        if (state === null) {
          if (segment.g10(index, state, get_IN_BUFFER()))
            return true;
        } else {
...
function incCompletedExpandBufferAttempts($this, nAttempts) {
  ...
  if (!$this.n10_1.atomicfu$addAndGet$long(nAttempts).d3(new Long(0, 1073741824)).equals(new Long(0, 0))) {
    $l$loop: while (true) {
      // Inline function 'kotlinx.coroutines.channels.ebPauseExpandBuffers' call
      if (!!$this.n10_1.kotlinx$atomicfu$value.d3(new Long(0, 1073741824)).equals(new Long(0, 0))) {
        break $l$loop;
      }
    }
  }
...
function BufferedChannelIterator($outer) {
  this.k11_1 = $outer;
  this.i11_1 = get_NO_RECEIVE_RESULT();
  this.j11_1 = null;
}
protoOf(BufferedChannelIterator).i13 = function ($completion) {
  var tmp = new $hasNextCOROUTINE$(this, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(BufferedChannelIterator).mu = function (segment, index) {
  var tmp97_safe_receiver = this.j11_1;
  if (tmp97_safe_receiver == null)
    null;
  else {
    tmp97_safe_receiver.mu(segment, index);
  }
};
protoOf(BufferedChannelIterator).l = function () {
  var result = this.i11_1;
  // Inline function 'kotlin.check' call
  ...
  if (result === get_CHANNEL_CLOSED())
    throw recoverStackTrace_0(_get_receiveException__foorc1(this.k11_1));
  return (result == null ? true : !(result == null)) ? result : THROW_CCE();
};
protoOf(BufferedChannelIterator).v12 = function (element) {
  var cont = ensureNotNull(this.j11_1);
  this.j11_1 = null;
  this.i11_1 = element;
  var tmp98_safe_receiver = this.k11_1.j10_1;
  return tryResume0(cont, true, tmp98_safe_receiver == null ? null : bindCancellationFun(this.k11_1, tmp98_safe_receiver, element));
};
protoOf(BufferedChannelIterator).j13 = function () {
  var cont = ensureNotNull(this.j11_1);
  this.j11_1 = null;
  this.i11_1 = get_CHANNEL_CLOSED();
  var cause = this.k11_1.l11();
...
function completeClose($this, sendersCur) {
  ...
  if ($this.m13()) {
    ...
    if (!lastBufferedCellGlobalIndex.equals(new Long(-1, -1))) {
      $this.l13(lastBufferedCellGlobalIndex);
    }
  }
...
function closeLinkedList($this) {
  var lastSegment = $this.q10_1.kotlinx$atomicfu$value;
  // Inline function 'kotlin.let' call
  var it = $this.o10_1.kotlinx$atomicfu$value;
  if (it.lt_1.y(lastSegment.lt_1) > 0)
    lastSegment = it;
  // Inline function 'kotlin.let' call
  var it_0 = $this.p10_1.kotlinx$atomicfu$value;
  if (it_0.lt_1.y(lastSegment.lt_1) > 0)
    lastSegment = it_0;
  ...
  while (true) {
    ...
    if (0 <= inductionVariable)
      do {
        ...
        inductionVariable = inductionVariable + -1 | 0;
        var tmp0 = segment.lt_1;
        // Inline function 'kotlin.Long.times' call
        var other = get_SEGMENT_SIZE();
        // Inline function 'kotlin.Long.plus' call
        var globalIndex = tmp0.t2(toLong(other)).r2(toLong(index));
        if (globalIndex.y($this.s12()) < 0)
          return new Long(-1, -1);
        cell_update: while (true) {
          var state = segment.e10(index);
          if (state === null || state === get_IN_BUFFER()) {
            if (segment.g10(index, state, get_CHANNEL_CLOSED())) {
              segment.w10();
              break cell_update;
            }
          } else if (state === get_BUFFERED())
    ...
    var tmp0_elvis_lhs = segment.f11();
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return new Long(-1, -1);
    } else {
...
function removeUnprocessedElements($this, lastSegment) {
  var onUndeliveredElement = $this.j10_1;
            ...
            if (state === get_BUFFERED()) {
              ...
              if (state === get_IN_BUFFER() || state === null) {
                ...
                if (tmp) {
                  ...
                  if (segment.g10(index, state, get_CHANNEL_CLOSED())) {
                    if (!(onUndeliveredElement == null)) {
                      var element_0 = segment.b10(index);
      ...
      do {
        ...
        cell_update: while (true) {
          ...
          if (state === null || state === get_IN_BUFFER()) {
            ...
            if (state instanceof WaiterEB) {
              if (segment.g10(index, state, get_CHANNEL_CLOSED())) {
                suspendedReceivers = InlineList__plus_impl_nuetvo(suspendedReceivers, state.u12_1);
                segment.u10(index, true);
                break cell_update;
              }
            } else {
...
function resumeWaiterOnClosedChannel($this, _this__u8e3s4, receiver) {
  if (_this__u8e3s4 instanceof SendBroadcast) {
    // Inline function 'kotlin.coroutines.resume' call
    var this_0 = _this__u8e3s4.d13_1;
    // Inline function 'kotlin.Companion.success' call
    var tmp$ret$0 = _Result___init__impl__xyqfz8(false);
    this_0.f9(tmp$ret$0);
  } else {
    if (isInterface(_this__u8e3s4, CancellableContinuation)) {
      // Inline function 'kotlin.coroutines.resumeWithException' call
      // Inline function 'kotlin.Companion.failure' call
      var exception = receiver ? _get_receiveException__foorc1($this) : $this.r12();
      var tmp$ret$2 = _Result___init__impl__xyqfz8(createFailure(exception));
      _this__u8e3s4.f9(tmp$ret$2);
    } else {
      if (_this__u8e3s4 instanceof ReceiveCatching) {
        var tmp0 = _this__u8e3s4.y12_1;
        // Inline function 'kotlin.coroutines.resume' call
        // Inline function 'kotlin.Companion.success' call
        var value = new ChannelResult(Companion_getInstance().c13($this.l11()));
        ...
        if (_this__u8e3s4 instanceof BufferedChannelIterator) {
          ...
          if (isInterface(_this__u8e3s4, SelectInstance))
            _this__u8e3s4.z12($this, get_CHANNEL_CLOSED());
          else {
            // Inline function 'kotlin.error' call
            var message = 'Unexpected waiter: ' + toString(_this__u8e3s4);
            throw IllegalStateException_init_$Create$(toString(message));
...
function isClosed($this, sendersAndCloseStatusCur, isClosedForReceive) {
  ...
  switch (sendersAndCloseStatusCur.b3(60).d1()) {
    ...
    case 2:
      ...
      tmp = isClosedForReceive ? !$this.n13() : true;
      break;
    case 3:
      // Inline function 'kotlinx.coroutines.channels.sendersCounter' call
...
function isCellNonEmpty($this, segment, index, globalIndex) {
  while (true) {
    ...
    if (state === null || state === get_IN_BUFFER()) {
      ...
      return globalIndex.equals($this.s12());
  }
}
function findSegmentSend($this, id, startFrom) {
  ...
  if (_SegmentOrClosed___get_isClosed__impl__qmxmlo(it)) {
    completeCloseOrCancel($this);
    var tmp0_0 = startFrom.lt_1;
    // Inline function 'kotlin.Long.times' call
    var other = get_SEGMENT_SIZE();
    if (tmp0_0.t2(toLong(other)).y($this.s12()) < 0) {
      startFrom.g11();
    }
    tmp_0 = null;
  } else {
    ...
    var tmp_1;
    if (segment.lt_1.y(id) > 0) {
      var tmp0_1 = segment.lt_1;
      // Inline function 'kotlin.Long.times' call
      var other_0 = get_SEGMENT_SIZE();
      var tmp$ret$4 = tmp0_1.t2(toLong(other_0));
      updateSendersCounterIfLower($this, tmp$ret$4);
      var tmp0_2 = segment.lt_1;
      // Inline function 'kotlin.Long.times' call
      var other_1 = get_SEGMENT_SIZE();
      if (tmp0_2.t2(toLong(other_1)).y($this.s12()) < 0) {
        segment.g11();
      }
      tmp_1 = null;
    } else {
...
function findSegmentReceive($this, id, startFrom) {
  ...
  if (_SegmentOrClosed___get_isClosed__impl__qmxmlo(it)) {
    ...
    // Inline function 'kotlin.Long.times' call
    var other = get_SEGMENT_SIZE();
    if (tmp0_0.t2(toLong(other)).y($this.m11()) < 0) {
      startFrom.g11();
    }
    tmp_0 = null;
  } else {
    ...
    if (tmp_1) {
      var tmp0_2 = $this.q10_1;
      $l$block_5: {
        // Inline function 'kotlinx.coroutines.internal.moveForward' call
        while (true) {
          var cur_0 = tmp0_2.kotlinx$atomicfu$value;
          if (cur_0.lt_1.y(segment.lt_1) >= 0) {
            break $l$block_5;
          }
          if (!segment.y10()) {
            break $l$block_5;
...
function findSegmentBufferEnd($this, id, startFrom, currentBufferEndCounter) {
  ...
  if (_SegmentOrClosed___get_isClosed__impl__qmxmlo(it)) {
    ...
    if (segment.lt_1.y(id) > 0) {
      ...
      var tmp0_0 = segment.lt_1;
      // Inline function 'kotlin.Long.times' call
      var other = get_SEGMENT_SIZE();
      var tmp$ret$4 = tmp0_0.t2(toLong(other));
      if ($this.m10_1.atomicfu$compareAndSet(tmp_2, tmp$ret$4)) {
        var tmp0_1 = segment.lt_1;
        // Inline function 'kotlin.Long.times' call
        var other_0 = get_SEGMENT_SIZE();
...
function moveSegmentBufferEndToSpecifiedOrLast($this, id, startFrom) {
  ...
  $l$loop: while (segment.lt_1.y(id) < 0) {
    var tmp0_elvis_lhs = segment.c11();
    var tmp;
    if (tmp0_elvis_lhs == null) {
      break $l$loop;
    } else {
  ...
  while (true) {
    $l$loop_0: while (segment.x10()) {
      var tmp1_elvis_lhs = segment.c11();
      var tmp_0;
      if (tmp1_elvis_lhs == null) {
        break $l$loop_0;
      } else {
...
function updateSendersCounterIfLower($this, value) {
  ...
  while (true) {
    ...
    if ($this.k10_1.atomicfu$compareAndSet(cur, update))
      return Unit_instance;
  }
  return Unit_instance;
}
function updateReceiversCounterIfLower($this, value) {
  ...
  while (true) {
    ...
    if (cur.y(value) >= 0)
      return Unit_instance;
    if ($this.l10_1.atomicfu$compareAndSet(cur, value))
      return Unit_instance;
  }
  return Unit_instance;
}
...
function onCancellationChannelResultImplDoNotCall($this, cause, element, context) {
  callUndeliveredElement(ensureNotNull($this.j10_1), ensureNotNull(ChannelResult__getOrNull_impl_f5e07h(element)), context);
}
...
function onCancellationImplDoNotCall($this, cause, element, context) {
  callUndeliveredElement(ensureNotNull($this.j10_1), element, context);
}
function BufferedChannel$onUndeliveredElementReceiveCancellationConstructor$lambda$lambda($element, this$0, $select) {
  return function (_unused_var__etf5q3, _unused_var__etf5q3_0, _unused_var__etf5q3_1) {
    var tmp;
    if (!($element === get_CHANNEL_CLOSED())) {
      callUndeliveredElement(this$0.j10_1, ($element == null ? true : !($element == null)) ? $element : THROW_CCE(), $select.a9());
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function BufferedChannel$onCancellationChannelResultImplDoNotCall$ref(p0) {
  var l = function (_this__u8e3s4, p0_0, p1) {
    var tmp0 = p0;
    onCancellationChannelResultImplDoNotCall(tmp0, _this__u8e3s4, p0_0.b13_1, p1);
    return Unit_instance;
  };
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 11;
          var tmp_0 = this;
          tmp_0.z13_1 = this.x13_1;
          var tmp_1 = this;
          tmp_1.a14_1 = this.y13_1;
          var tmp_2 = this;
          tmp_2.b14_1 = null;
          this.u8_1 = 1;
          continue $sm;
        case 1:
          this.d14_1 = this.z13_1;
          this.e14_1 = this.a14_1;
          this.f14_1 = this.b14_1;
          this.g14_1 = this.d14_1.o10_1.kotlinx$atomicfu$value;
          this.u8_1 = 2;
          continue $sm;
        case 2:
          if (!true) {
          ...
          this.h14_1 = this.d14_1.k10_1.atomicfu$getAndIncrement$long();
          var tmp_3 = this;
          tmp_3.i14_1 = this.h14_1.d3(new Long(-1, 268435455));
          this.j14_1 = _get_isClosedForSend0__kxgf9m(this.d14_1, this.h14_1);
          var tmp_4 = this;
          var tmp0 = this.i14_1;
          var other = get_SEGMENT_SIZE();
          tmp_4.k14_1 = tmp0.u2(toLong(other));
          var tmp_5 = this;
          var tmp0_0 = this.i14_1;
          var other_0 = get_SEGMENT_SIZE();
          tmp_5.l14_1 = tmp0_0.v2(toLong(other_0)).d1();
          if (!this.g14_1.lt_1.equals(this.k14_1)) {
            this.m14_1 = findSegmentSend(this.d14_1, this.k14_1, this.g14_1);
            if (this.m14_1 == null) {
              if (this.j14_1) {
                this.u8_1 = 10;
                suspendResult = onClosedSend(this.x13_1, this.y13_1, this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
        ...
        case 3:
          this.g14_1 = this.n14_1;
          this.u8_1 = 4;
          continue $sm;
        case 4:
          this.o14_1 = updateCellSend(this.d14_1, this.g14_1, this.l14_1, this.e14_1, this.i14_1, this.f14_1, this.j14_1);
          if (this.o14_1 === 0) {
            this.g14_1.g11();
            var tmp_6 = this;
            tmp_6.c14_1 = Unit_instance;
            this.u8_1 = 13;
            continue $sm;
          } else {
            if (this.o14_1 === 1) {
              var tmp_7 = this;
              tmp_7.c14_1 = Unit_instance;
              this.u8_1 = 13;
              continue $sm;
            } else {
              if (this.o14_1 === 2) {
                ...
                if (this.o14_1 === 4) {
                  if (this.i14_1.y(this.d14_1.s12()) < 0) {
                    this.g14_1.g11();
                  }
                  this.u8_1 = 7;
                  suspendResult = onClosedSend(this.x13_1, this.y13_1, this);
                  ...
                  if (this.o14_1 === 5) {
                    ...
                    if (this.o14_1 === 3) {
                      var tmp_8 = this;
                      tmp_8.p14_1 = this.g14_1;
                      var tmp_9 = this;
                      tmp_9.q14_1 = this.l14_1;
                      var tmp_10 = this;
                      tmp_10.r14_1 = this.e14_1;
                      var tmp_11 = this;
                      tmp_11.s14_1 = this.i14_1;
                      this.t14_1 = this.p14_1;
                      this.u14_1 = this.q14_1;
                      this.v14_1 = this.r14_1;
                      this.w14_1 = this.s14_1;
                      this.u8_1 = 6;
                      suspendResult = sendOnNoWaiterSuspend(this.x13_1, this.t14_1, this.u14_1, this.v14_1, this.w14_1, this);
                      if (suspendResult === get_COROUTINE_SUSPENDED()) {
                        return suspendResult;
                      }
                      continue $sm;
        ...
        case 6:
          var tmp_12 = this;
          tmp_12.c14_1 = Unit_instance;
          this.u8_1 = 13;
          continue $sm;
        case 7:
          var tmp_13 = this;
          tmp_13.c14_1 = Unit_instance;
          this.u8_1 = 13;
          continue $sm;
        case 8:
          var tmp_14 = this.f14_1;
          var tmp83_safe_receiver = (!(tmp_14 == null) ? isInterface(tmp_14, Waiter) : false) ? tmp_14 : null;
          if (tmp83_safe_receiver == null)
            null;
          else {
            prepareSenderForSuspension(this.d14_1, tmp83_safe_receiver, this.g14_1, this.l14_1);
          }

          var tmp_15 = this;
          this.g14_1;
          this.l14_1;
          tmp_15.c14_1 = Unit_instance;
          this.u8_1 = 13;
          continue $sm;
        case 9:
          var tmp_16 = this;
          tmp_16.c14_1 = Unit_instance;
          this.u8_1 = 13;
          continue $sm;
        case 10:
          var tmp_17 = this;
          tmp_17.c14_1 = Unit_instance;
          this.u8_1 = 13;
          continue $sm;
        case 11:
          throw this.x8_1;
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 9;
          var tmp_0 = this;
          tmp_0.g15_1 = this.f15_1;
          var tmp_1 = this;
          tmp_1.h15_1 = null;
          this.u8_1 = 1;
          continue $sm;
        case 1:
          this.j15_1 = this.g15_1;
          this.k15_1 = this.h15_1;
          this.l15_1 = this.j15_1.p10_1.kotlinx$atomicfu$value;
          this.u8_1 = 2;
          continue $sm;
        case 2:
          if (!true) {
          ...
          if (this.j15_1.n11()) {
            var tmp_2 = this;
            tmp_2.i15_1 = Companion_getInstance().c13(this.f15_1.l11());
            this.u8_1 = 11;
            continue $sm;
          } else {
            this.u8_1 = 3;
        ...
        case 3:
          this.m15_1 = this.j15_1.l10_1.atomicfu$getAndIncrement$long();
          var tmp_3 = this;
          var tmp0 = this.m15_1;
          var other = get_SEGMENT_SIZE();
          tmp_3.n15_1 = tmp0.u2(toLong(other));
          var tmp_4 = this;
          var tmp0_0 = this.m15_1;
          var other_0 = get_SEGMENT_SIZE();
          tmp_4.o15_1 = tmp0_0.v2(toLong(other_0)).d1();
          if (!this.l15_1.lt_1.equals(this.n15_1)) {
            this.p15_1 = findSegmentReceive(this.j15_1, this.n15_1, this.l15_1);
            if (this.p15_1 == null) {
              this.u8_1 = 2;
              var tmp_5 = this;
              continue $sm;
            } else {
              this.q15_1 = this.p15_1;
              this.u8_1 = 4;
              continue $sm;
            }
          } else {
        ...
        case 4:
          this.l15_1 = this.q15_1;
          this.u8_1 = 5;
          continue $sm;
        case 5:
          this.r15_1 = updateCellReceive(this.j15_1, this.l15_1, this.o15_1, this.m15_1, this.k15_1);
          if (this.r15_1 === get_SUSPEND()) {
            var tmp_6 = this;
            var tmp_7 = this.k15_1;
            var tmp92_safe_receiver = (!(tmp_7 == null) ? isInterface(tmp_7, Waiter) : false) ? tmp_7 : null;
            if (tmp92_safe_receiver == null)
              null;
            else {
              prepareReceiverForSuspension(this.j15_1, tmp92_safe_receiver, this.l15_1, this.o15_1);
            }
            this.l15_1;
            this.o15_1;
            this.m15_1;
            ...
            if (this.r15_1 === get_FAILED()) {
              if (this.m15_1.y(this.j15_1.m11()) < 0) {
                this.l15_1.g11();
              }
              this.u8_1 = 2;
              var tmp_8 = this;
              ...
              if (this.r15_1 === get_SUSPEND_NO_WAITER()) {
                var tmp_9 = this;
                tmp_9.t15_1 = this.l15_1;
                var tmp_10 = this;
                tmp_10.u15_1 = this.o15_1;
                var tmp_11 = this;
                tmp_11.v15_1 = this.m15_1;
                this.w15_1 = this.t15_1;
                this.x15_1 = this.u15_1;
                this.y15_1 = this.v15_1;
                this.u8_1 = 6;
                suspendResult = receiveCatchingOnNoWaiterSuspend(this.f15_1, this.w15_1, this.x15_1, this.y15_1, this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                this.u8_1 = 7;
                ...
                var tmp_12 = this;
                this.l15_1.g11();
                var tmp_13 = this.r15_1;
                var element = (tmp_13 == null ? true : !(tmp_13 == null)) ? tmp_13 : THROW_CCE();
                tmp_12.s15_1 = new ChannelResult(Companion_getInstance().x12(element));
                this.u8_1 = 8;
                continue $sm;
              }
            }
        ...
        case 6:
          var unboxed = suspendResult.b13_1;
        ...
        case 10:
          ...
          continue $sm;
        case 11:
          return new ChannelResult(this.i15_1);
      }
    } catch ($p) {
      var e = $p;
      if (this.v8_1 === 9) {
...
function BufferedChannel(capacity, onUndeliveredElement) {
  ...
  this.i10_1 = capacity;
  this.j10_1 = onUndeliveredElement;
  // Inline function 'kotlin.require' call
  if (!(this.i10_1 >= 0)) {
    var message = 'Invalid channel capacity: ' + this.i10_1 + ', should be >=0';
    throw IllegalArgumentException_init_$Create$(toString(message));
  }
  this.k10_1 = atomic$long$1(new Long(0, 0));
  this.l10_1 = atomic$long$1(new Long(0, 0));
  this.m10_1 = atomic$long$1(initialBufferEnd(this.i10_1));
  this.n10_1 = atomic$long$1(_get_bufferEndCounter__2d4hee(this));
  var firstSegment = new ChannelSegment(new Long(0, 0), null, this, 3);
  this.o10_1 = atomic$ref$1(firstSegment);
  this.p10_1 = atomic$ref$1(firstSegment);
  var tmp = this;
  var tmp_0;
  if (_get_isRendezvousOrUnlimited__3mdufi(this)) {
  ...
  tmp_2.r10_1 = tmp_3;
  this.s10_1 = atomic$ref$1(get_NO_CLOSE_CAUSE());
  this.t10_1 = atomic$ref$1(null);
}
protoOf(BufferedChannel).m11 = function () {
  // Inline function 'kotlinx.coroutines.channels.sendersCounter' call
  return this.k10_1.kotlinx$atomicfu$value.d3(new Long(-1, 268435455));
};
protoOf(BufferedChannel).s12 = function () {
  return this.l10_1.kotlinx$atomicfu$value;
};
protoOf(BufferedChannel).z15 = function (element, $completion) {
  var tmp = new $sendCOROUTINE$(this, element, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(BufferedChannel).a16 = function (element) {
  if (shouldSendSuspend0(this, this.k10_1.kotlinx$atomicfu$value))
    return Companion_getInstance().b16();
  var tmp4 = get_INTERRUPTED_SEND();
  var tmp$ret$4;
  $l$block_4: {
    // Inline function 'kotlinx.coroutines.channels.BufferedChannel.sendImpl' call
    var segment = this.o10_1.kotlinx$atomicfu$value;
    $l$loop_0: while (true) {
      var sendersAndCloseStatusCur = this.k10_1.atomicfu$getAndIncrement$long();
      // Inline function 'kotlinx.coroutines.channels.sendersCounter' call
      ...
      if (!segment.lt_1.equals(id)) {
        ...
        if (tmp0_elvis_lhs == null) {
          var tmp_0;
          if (closed) {
            tmp$ret$4 = Companion_getInstance().c13(this.r12());
            break $l$block_4;
          } else {
            continue $l$loop_0;
          }
      ...
      switch (updateCellSend(this, segment, i, element, s, tmp4, closed)) {
        case 0:
          segment.g11();
          tmp$ret$4 = Companion_getInstance().x12(Unit_instance);
          break $l$block_4;
        case 1:
          tmp$ret$4 = Companion_getInstance().x12(Unit_instance);
          break $l$block_4;
        case 2:
          ...
          segment.w10();
          tmp$ret$4 = Companion_getInstance().b16();
          break $l$block_4;
        case 4:
          if (s.y(this.s12()) < 0) {
            segment.g11();
...
protoOf(BufferedChannel).c16 = function (element) {
  var tmp$ret$3;
  // Inline function 'kotlinx.coroutines.channels.BufferedChannel.sendImpl' call
  ...
  $l$loop_0: while (true) {
    ...
    if (!segment.lt_1.equals(id)) {
      ...
      if (tmp0_elvis_lhs == null) {
        var tmp_0;
        if (closed) {
          return Companion_getInstance().c13(this.r12());
        } else {
          continue $l$loop_0;
        }
      } else {
    ...
    switch (updateCellSend(this, segment, i, element, s, waiter, closed)) {
      case 0:
        segment.g11();
        return Companion_getInstance().x12(Unit_instance);
      case 1:
        return Companion_getInstance().x12(Unit_instance);
      case 2:
        if (closed) {
...
protoOf(BufferedChannel).d16 = function ($completion) {
...
protoOf(BufferedChannel).e16 = function () {
  var r = this.l10_1.kotlinx$atomicfu$value;
  var sendersAndCloseStatusCur = this.k10_1.kotlinx$atomicfu$value;
  if (_get_isClosedForReceive0__f7qknl(this, sendersAndCloseStatusCur)) {
    return Companion_getInstance().c13(this.l11());
  }
  // Inline function 'kotlinx.coroutines.channels.sendersCounter' call
  var s = sendersAndCloseStatusCur.d3(new Long(-1, 268435455));
  if (r.y(s) >= 0)
  ...
  $l$block_0: {
    // Inline function 'kotlinx.coroutines.channels.BufferedChannel.receiveImpl' call
    var segment = this.p10_1.kotlinx$atomicfu$value;
    $l$loop_0: while (true) {
      if (this.n11()) {
        tmp$ret$2 = Companion_getInstance().c13(this.l11());
        break $l$block_0;
      }
      var r_0 = this.l10_1.atomicfu$getAndIncrement$long();
      // Inline function 'kotlin.Long.div' call
      ...
      if (updCellResult === get_SUSPEND()) {
        ...
        this.v10(r_0);
        segm.w10();
        tmp_0 = new ChannelResult(Companion_getInstance().b16());
      } else if (updCellResult === get_FAILED()) {
        if (r_0.y(this.m11()) < 0) {
          segment.g11();
        }
        ...
        tmp_0 = new ChannelResult(Companion_getInstance().x12(element));
      }
      tmp$ret$2 = tmp_0.b13_1;
      break $l$block_0;
    }
  }
  return tmp$ret$2;
};
protoOf(BufferedChannel).l13 = function (globalCellIndex) {
  // Inline function 'kotlinx.coroutines.assert' call
  var segment = this.p10_1.kotlinx$atomicfu$value;
  $l$loop_0: while (true) {
    var r = this.l10_1.kotlinx$atomicfu$value;
    ...
    if (!this.l10_1.atomicfu$compareAndSet(r, tmp$ret$3))
      continue $l$loop_0;
    // Inline function 'kotlin.Long.div' call
    var other_0 = get_SEGMENT_SIZE();
    ...
    if (updCellResult === get_FAILED()) {
      ...
      segment.g11();
      var tmp90_safe_receiver = this.j10_1;
      var tmp_0;
...
protoOf(BufferedChannel).v10 = function (globalIndex) {
  if (_get_isRendezvousOrUnlimited__3mdufi(this))
    return Unit_instance;
  ...
  if (inductionVariable < times)
    do {
      ...
      var ebCompleted = this.n10_1.kotlinx$atomicfu$value.d3(new Long(-1, 1073741823));
  ...
  while (true) {
    ...
    var ebCompletedAndBit = this.n10_1.kotlinx$atomicfu$value;
    // Inline function 'kotlinx.coroutines.channels.ebCompletedCounter' call
    ...
    if (!pauseExpandBuffers) {
      this.n10_1.atomicfu$compareAndSet(ebCompletedAndBit, constructEBCompletedAndPauseFlag(ebCompleted_0, true));
    }
  }
};
...
protoOf(BufferedChannel).l11 = function () {
  var tmp = this.s10_1.kotlinx$atomicfu$value;
...
protoOf(BufferedChannel).f16 = function () {
};
protoOf(BufferedChannel).g16 = function (cause) {
  return this.h16(cause, false);
};
protoOf(BufferedChannel).dp = function (cause) {
  this.j16(cause);
};
protoOf(BufferedChannel).j16 = function (cause) {
  return this.h16(cause == null ? CancellationException_init_$Create$('Channel was cancelled') : cause, true);
};
protoOf(BufferedChannel).h16 = function (cause, cancel) {
  if (cancel) {
    markCancellationStarted(this);
  }
  var closedByThisOperation = this.s10_1.atomicfu$compareAndSet(get_NO_CLOSE_CAUSE(), cause);
  if (cancel) {
    markCancelled(this);
  } else {
    markClosed(this);
...
protoOf(BufferedChannel).k13 = function () {
  return _get_isClosedForSend0__kxgf9m(this, this.k10_1.kotlinx$atomicfu$value);
};
protoOf(BufferedChannel).n11 = function () {
  return _get_isClosedForReceive0__f7qknl(this, this.k10_1.kotlinx$atomicfu$value);
};
protoOf(BufferedChannel).n13 = function () {
  $l$loop: while (true) {
    ...
    if (!segment.lt_1.equals(id)) {
      ...
      if (tmp0_elvis_lhs == null) {
        var tmp_0;
        if (this.p10_1.kotlinx$atomicfu$value.lt_1.y(id) < 0) {
          return false;
        } else {
          continue $l$loop;
        }
    ...
    this.l10_1.atomicfu$compareAndSet(r, tmp$ret$2);
  }
};
protoOf(BufferedChannel).toString = function () {
  var sb = StringBuilder_init_$Create$();
  // Inline function 'kotlinx.coroutines.channels.sendersCloseStatus' call
  var tmp103_subject = this.k10_1.kotlinx$atomicfu$value.b3(60).d1();
  if (tmp103_subject === 2) {
    sb.b8('closed,');
  } else if (tmp103_subject === 3) {
    sb.b8('cancelled,');
  }
  sb.b8('capacity=' + this.i10_1 + ',');
  sb.b8('data=[');
  // Inline function 'kotlin.collections.filter' call
  var tmp0 = listOf([this.p10_1.kotlinx$atomicfu$value, this.o10_1.kotlinx$atomicfu$value, this.q10_1.kotlinx$atomicfu$value]);
  ...
  append_elements: while (true) {
    ...
    if (inductionVariable < last_0)
      process_cell: do {
        ...
        var cellState = segment.e10(i);
        var element_0 = segment.b10(i);
        var tmp;
...
protoOf(WaiterEB).toString = function () {
  return 'WaiterEB(' + toString(this.u12_1) + ')';
};
...
protoOf(ReceiveCatching).mu = function (segment, index) {
  this.y12_1.mu(segment, index);
};
function tryResume0(_this__u8e3s4, value, onCancellation) {
  onCancellation = onCancellation === VOID ? null : onCancellation;
  _init_properties_BufferedChannel_kt__d6uc4y();
  // Inline function 'kotlin.let' call
  var token = _this__u8e3s4.ts(value, null, onCancellation);
  var tmp;
  if (!(token == null)) {
    _this__u8e3s4.yq(token);
    tmp = true;
  } else {
    tmp = false;
  }
...
function createSegment(id, prev) {
  _init_properties_BufferedChannel_kt__d6uc4y();
  return new ChannelSegment(id, prev, prev.yz(), 0);
}
...
function Factory() {
  ...
  this.l16_1 = 2147483647;
  this.m16_1 = 0;
  this.n16_1 = -1;
  this.o16_1 = -2;
  this.p16_1 = -3;
  this.q16_1 = 'kotlinx.coroutines.channels.defaultBuffer';
  this.r16_1 = systemProp('kotlinx.coroutines.channels.defaultBuffer', 64, 1, 2147483646);
}
...
function ChannelResult__exceptionOrNull_impl_16ei30($this) {
  ...
  return tmp112_safe_receiver == null ? null : tmp112_safe_receiver.s16_1;
}
function Failed() {
}
...
protoOf(Closed).equals = function (other) {
  ...
  if (other instanceof Closed) {
    tmp = equals(this.s16_1, other.s16_1);
  } else {
    tmp = false;
  }
  return tmp;
...
protoOf(Closed).toString = function () {
  return 'Closed(' + toString_0(this.s16_1) + ')';
};
function Companion() {
  Companion_instance_0 = this;
  this.w12_1 = new Failed();
}
protoOf(Companion).x12 = function (value) {
  return _ChannelResult___init__impl__siwsuf(value);
};
protoOf(Companion).b16 = function () {
  return _ChannelResult___init__impl__siwsuf(this.w12_1);
};
protoOf(Companion).c13 = function (cause) {
...
function ChannelResult__equals_impl_f471ri($this, other) {
  if (!(other instanceof ChannelResult))
    return false;
  var tmp0_other_with_cast = other instanceof ChannelResult ? other.b13_1 : THROW_CCE();
...
protoOf(ChannelResult).toString = function () {
  return ChannelResult__toString_impl_rrcqu7(this.b13_1);
};
protoOf(ChannelResult).hashCode = function () {
  return ChannelResult__hashCode_impl_lilec2(this.b13_1);
};
protoOf(ChannelResult).equals = function (other) {
  return ChannelResult__equals_impl_f471ri(this.b13_1, other);
};
...
function Channel(capacity, onBufferOverflow, onUndeliveredElement) {
  ...
  switch (capacity) {
    ...
    case 2147483647:
      ...
      break;
    case -2:
      tmp = onBufferOverflow.equals(BufferOverflow_SUSPEND_getInstance()) ? new BufferedChannel(Factory_getInstance().r16_1, onUndeliveredElement) : new ConflatedBufferedChannel(1, onBufferOverflow, onUndeliveredElement);
      break;
    default:
...
protoOf(ChannelCoroutine).z15 = function (element, $completion) {
  return this.w16_1.z15(element, $completion);
};
protoOf(ChannelCoroutine).a16 = function (element) {
  return this.w16_1.a16(element);
};
protoOf(ChannelCoroutine).g16 = function (cause) {
  return this.w16_1.g16(cause);
};
protoOf(ChannelCoroutine).d16 = function ($completion) {
  var tmp = this.w16_1.d16($completion);
  if (tmp === get_COROUTINE_SUSPENDED())
    return tmp;
  return tmp;
};
protoOf(ChannelCoroutine).e16 = function () {
  return this.w16_1.e16();
};
protoOf(ChannelCoroutine).j = function () {
  return this.w16_1.j();
};
protoOf(ChannelCoroutine).dp = function (cause) {
  if (this.qo())
    return Unit_instance;
  var tmp;
  if (cause == null) {
...
protoOf(ChannelCoroutine).k16 = function (cause, $super) {
  return this.ep(cause, ($super == null ? true : $super instanceof ChannelCoroutine) ? $super : THROW_CCE());
};
protoOf(ChannelCoroutine).fp = function (cause) {
  var exception = this.vo(cause);
  this.w16_1.dp(exception);
  this.ip(exception);
};
function cancelConsumed(_this__u8e3s4, cause) {
  ...
  _this__u8e3s4.dp(tmp);
}
function trySendImpl($this, element, isSendOp) {
  return $this.k17_1 === BufferOverflow_DROP_LATEST_getInstance() ? trySendDropLatest($this, element, isSendOp) : $this.c16(element);
}
function trySendDropLatest($this, element, isSendOp) {
  var result = protoOf(BufferedChannel).a16.call($this, element);
  if (_ChannelResult___get_isSuccess__impl__odq1z9(result) || _ChannelResult___get_isClosed__impl__mg7kuu(result))
    return result;
  if (isSendOp) {
    var tmp118_safe_receiver = $this.j10_1;
...
function ConflatedBufferedChannel(capacity, onBufferOverflow, onUndeliveredElement) {
  ...
  this.j17_1 = capacity;
  this.k17_1 = onBufferOverflow;
  // Inline function 'kotlin.require' call
  if (!!(this.k17_1 === BufferOverflow_SUSPEND_getInstance())) {
    var message = 'This implementation does not support suspension for senders, use ' + getKClass(BufferedChannel).sa() + ' instead';
    throw IllegalArgumentException_init_$Create$(toString(message));
  }
  // Inline function 'kotlin.require' call
  if (!(this.j17_1 >= 1)) {
    var message_0 = 'Buffered channel capacity must be at least 1, but ' + this.j17_1 + ' was specified';
    throw IllegalArgumentException_init_$Create$(toString(message_0));
  }
}
protoOf(ConflatedBufferedChannel).m13 = function () {
  return this.k17_1.equals(BufferOverflow_DROP_OLDEST_getInstance());
};
protoOf(ConflatedBufferedChannel).z15 = function (element, $completion) {
  ...
  if (tmp instanceof Closed) {
    ...
    var tmp116_safe_receiver = this.j10_1;
    ...
    if (tmp117_safe_receiver == null)
      ...
      // Inline function 'kotlin.let' call
      addSuppressed(tmp117_safe_receiver, this.r12());
...
protoOf(ConflatedBufferedChannel).a16 = function (element) {
...
protoOf(ProducerCoroutine).un = function () {
  return protoOf(ChannelCoroutine).un.call(this);
};
protoOf(ProducerCoroutine).p17 = function (value) {
  this.w16_1.i16();
};
protoOf(ProducerCoroutine).vn = function (value) {
  return this.p17(value instanceof Unit ? value : THROW_CCE());
};
protoOf(ProducerCoroutine).wn = function (cause, handled) {
  var processed = this.w16_1.g16(cause);
  if (!processed && !handled) {
    handleCoroutineException(this.sn_1, cause);
  }
};
protoOf(ProducerCoroutine).k16 = function (cause, $super) {
  return this.ep(cause, ($super == null ? true : $super instanceof ProducerCoroutine) ? $super : THROW_CCE());
};
...
protoOf(SafeFlow).r17 = function (collector, $completion) {
  return this.q17_1(collector, $completion);
};
...
function $collectCOROUTINE$(_this__u8e3s4, collector, resultContinuation) {
  CoroutineImpl.call(this, resultContinuation);
  this.b18_1 = _this__u8e3s4;
  this.c18_1 = collector;
}
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          var tmp_0 = this;
          tmp_0.d18_1 = this.c18_1;
          this.e18_1 = this.d18_1;
          this.u8_1 = 1;
          suspendResult = this.e18_1.g18(this.b18_1.f18_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(flowOf$$inlined$unsafeFlow$1).h18 = function (collector, $completion) {
  var tmp = new $collectCOROUTINE$(this, collector, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(flowOf$$inlined$unsafeFlow$1).s17 = function (collector, $completion) {
  return this.h18(collector, $completion);
};
function $collectCOROUTINE$_0(_this__u8e3s4, collector, resultContinuation) {
  CoroutineImpl.call(this, resultContinuation);
  this.q18_1 = _this__u8e3s4;
  this.r18_1 = collector;
}
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 4;
          var tmp_0 = this;
          tmp_0.s18_1 = this.r18_1;
          this.t18_1 = this.s18_1;
          var tmp_1 = this;
          tmp_1.u18_1 = this.q18_1.a19_1;
          this.v18_1 = this.u18_1;
          this.w18_1 = this.v18_1.j();
          this.u8_1 = 1;
          continue $sm;
        case 1:
          if (!this.w18_1.k()) {
          ...
          this.x18_1 = this.w18_1.l();
          var tmp_2 = this;
          tmp_2.y18_1 = this.x18_1;
          this.z18_1 = this.y18_1;
          this.u8_1 = 2;
          suspendResult = this.t18_1.g18(this.z18_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
function asFlow$$inlined$unsafeFlow$1($this_asFlow) {
  this.a19_1 = $this_asFlow;
}
protoOf(asFlow$$inlined$unsafeFlow$1).h18 = function (collector, $completion) {
  var tmp = new $collectCOROUTINE$_0(this, collector, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(asFlow$$inlined$unsafeFlow$1).s17 = function (collector, $completion) {
  return this.h18(collector, $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        ...
        case 1:
          this.v8_1 = 7;
          this.v8_1 = 6;
          this.o19_1 = this.k19_1.j();
          this.u8_1 = 2;
          continue $sm;
        case 2:
          this.u8_1 = 3;
          suspendResult = this.o19_1.i13(this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 3:
          ...
          this.p19_1 = this.o19_1.l();
          this.u8_1 = 4;
          suspendResult = this.j19_1.g18(this.p19_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 7:
          ...
          var t = this.x8_1;
          if (this.l19_1) {
            cancelConsumed(this.k19_1, this.m19_1);
          }
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 5;
          var tmp_0 = this;
          tmp_0.a1a_1 = new SafeCollector(this.z19_1, this.a9());
          this.u8_1 = 1;
          continue $sm;
        case 1:
          this.v8_1 = 4;
          this.u8_1 = 2;
          suspendResult = this.y19_1.r17(this.a1a_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(AbstractFlow).s17 = function (collector, $completion) {
...
function _get_replaySize__dxgnb1($this) {
  ...
  // Inline function 'kotlin.Long.plus' call
  var other = $this.q1a_1;
  return tmp0.r2(toLong(other)).s2($this.o1a_1).d1();
}
...
function tryEmitLocked($this, value) {
  ...
  if (_get_replaySize__dxgnb1($this) > $this.k1a_1) {
    // Inline function 'kotlin.Long.plus' call
    var tmp$ret$0 = $this.o1a_1.r2(toLong(1));
...
function tryEmitNoCollectorsLocked($this, value) {
  ...
  // Inline function 'kotlin.Long.plus' call
  var other = $this.q1a_1;
  tmp.p1a_1 = tmp0.r2(toLong(other));
  return true;
}
function dropOldestLocked($this) {
  ...
  if ($this.o1a_1.y(newHead) < 0)
    $this.o1a_1 = newHead;
  if ($this.p1a_1.y(newHead) < 0) {
...
function correctCollectorIndexesOnDropOldest($this, newHead) {
  $l$block: {
    ...
    var tmp133_safe_receiver = $this.s1a_1;
    if (tmp133_safe_receiver == null)
      ...
      while (inductionVariable < last) {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        if (!(element == null)) {
          if (element.w1a_1.y(new Long(0, 0)) >= 0 && element.w1a_1.y(newHead) < 0) {
...
function cancelEmitter($this, emitter) {
  // Inline function 'kotlinx.coroutines.internal.synchronized' call
  // Inline function 'kotlinx.coroutines.internal.synchronizedImpl' call
  if (emitter.z1a_1.y(_get_head__d7jo8b($this)) < 0)
    return Unit_instance;
...
function updateBufferLocked($this, newReplayIndex, newMinCollectorIndex, newBufferEndIndex, newQueueEndIndex) {
  ...
  $this.q1a_1 = newBufferEndIndex.s2(newHead).d1();
  $this.r1a_1 = newQueueEndIndex.s2(newBufferEndIndex).d1();
  // Inline function 'kotlinx.coroutines.assert' call
  // Inline function 'kotlinx.coroutines.assert' call
  // Inline function 'kotlinx.coroutines.assert' call
}
function cleanupTailLocked($this) {
  if ($this.l1a_1 === 0 && $this.r1a_1 <= 1)
    return Unit_instance;
  var buffer = ensureNotNull($this.n1a_1);
  $l$loop: while (true) {
    var tmp;
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        ...
        case 3:
          var tmp_1 = this;
          tmp_1.p1b_1 = this.a9().h9(Key_instance_3);
          this.u8_1 = 4;
          continue $sm;
        case 4:
          if (!true) {
        ...
        case 7:
          ...
          continue $sm;
        case 8:
          var tmp121_safe_receiver = this.p1b_1;
          ...
          suspendResult = this.m1b_1.g18((tmp_2 == null ? true : !(tmp_2 == null)) ? tmp_2 : THROW_CCE(), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(SharedFlowImpl).s17 = function (collector, $completion) {
...
protoOf(SharedFlowImpl).g18 = function (value, $completion) {
  if (this.y1b(value))
    return Unit_instance;
...
protoOf(SharedFlowImpl).c1b = function (oldIndex) {
  ...
  $l$block: {
    ...
    if (tmp133_safe_receiver == null)
      ...
      while (inductionVariable < last) {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        if (!(element == null)) {
          if (element.w1a_1.y(new Long(0, 0)) >= 0 && element.w1a_1.y(newMinCollectorIndex) < 0)
  ...
  // Inline function 'kotlinx.coroutines.assert' call
  if (newMinCollectorIndex.y(this.p1a_1) <= 0)
    return get_EMPTY_RESUMES();
  ...
  if (this.t1a_1 > 0) {
    ...
    var tmp0 = this.r1a_1;
    // Inline function 'kotlin.comparisons.minOf' call
    var b = this.l1a_1 - newBufferSize0 | 0;
    tmp = Math.min(tmp0, b);
  } else {
    tmp = this.r1a_1;
  }
    ...
    if (inductionVariable_0.y(newQueueEndIndex) < 0)
      $l$loop: do {
        ...
        if (!(emitter === get_NO_VALUE())) {
          ...
          var _unary__edvuaz = resumeCount;
          resumeCount = _unary__edvuaz + 1 | 0;
          tmp_0[_unary__edvuaz] = emitter.b1b_1;
  ...
  if (this.l1a_1 === 0 && newReplayIndex.y(newQueueEndIndex) < 0 && equals(getBufferAt(ensureNotNull(this.n1a_1), newReplayIndex), get_NO_VALUE())) {
    newBufferEndIndex = newBufferEndIndex.w2();
...
protoOf(SharedFlowImpl).c1c = function () {
  // Inline function 'kotlinx.coroutines.internal.synchronized' call
  // Inline function 'kotlinx.coroutines.internal.synchronizedImpl' call
  updateBufferLocked(this, _get_bufferEndIndex__d2rk18(this), this.p1a_1, _get_bufferEndIndex__d2rk18(this), _get_queueEndIndex__4m025l(this));
  return Unit_instance;
};
protoOf(SharedFlowImpl).d1c = function (context, capacity, onBufferOverflow) {
...
protoOf(SharedFlowSlot).g1c = function (flow) {
  if (this.w1a_1.y(new Long(0, 0)) >= 0)
    return false;
  this.w1a_1 = flow.z1b();
  return true;
};
protoOf(SharedFlowSlot).h1c = function (flow) {
  return this.g1c(flow instanceof SharedFlowImpl ? flow : THROW_CCE());
};
protoOf(SharedFlowSlot).i1c = function (flow) {
  // Inline function 'kotlinx.coroutines.assert' call
...
protoOf(SharedFlowSlot).j1c = function (flow) {
  return this.i1c(flow instanceof SharedFlowImpl ? flow : THROW_CCE());
};
...
function Companion_0() {
  ...
  this.k1c_1 = new StartedEagerly();
  this.l1c_1 = new StartedLazily();
}
protoOf(Companion_0).m1c = function (stopTimeoutMillis, replayExpirationMillis) {
  return new StartedWhileSubscribed(stopTimeoutMillis, replayExpirationMillis);
};
protoOf(Companion_0).n1c = function (stopTimeoutMillis, replayExpirationMillis, $super) {
  ...
  return $super === VOID ? this.m1c(stopTimeoutMillis, replayExpirationMillis) : $super.m1c.call(this, stopTimeoutMillis, replayExpirationMillis);
};
...
protoOf(StartedEagerly).o1c = function (subscriptionCount) {
...
function StartedLazily$command$slambda$slambda($started, $this_flow, resultContinuation) {
  this.x1c_1 = $started;
  this.y1c_1 = $this_flow;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(StartedLazily$command$slambda$slambda).a1d = function (count, $completion) {
  var tmp = this.b1d(count, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(StartedLazily$command$slambda$slambda).k9 = function (p1, $completion) {
  return this.a1d((!(p1 == null) ? typeof p1 === 'number' : false) ? p1 : THROW_CCE(), $completion);
};
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 3;
          if (this.z1c_1 > 0 && !this.x1c_1._v) {
            this.x1c_1._v = true;
            this.u8_1 = 1;
            suspendResult = this.y1c_1.g18(SharingCommand_START_getInstance(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
...
protoOf(StartedLazily$command$slambda$slambda).b1d = function (count, completion) {
  var i = new StartedLazily$command$slambda$slambda(this.x1c_1, this.y1c_1, completion);
  i.z1c_1 = count;
  return i;
};
...
function StartedLazily$command$slambda($subscriptionCount, resultContinuation) {
  this.l1d_1 = $subscriptionCount;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(StartedLazily$command$slambda).o1d = function ($this$flow, $completion) {
  var tmp = this.p1d($this$flow, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(StartedLazily$command$slambda).k9 = function (p1, $completion) {
  return this.o1d((!(p1 == null) ? isInterface(p1, FlowCollector) : false) ? p1 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          ...
          this.n1d_1 = {_v: false};
          this.u8_1 = 1;
          var tmp_0 = StartedLazily$command$slambda$slambda_0(this.n1d_1, this.m1d_1, null);
          suspendResult = this.l1d_1.x1b(new sam$kotlinx_coroutines_flow_FlowCollector$0(tmp_0), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(StartedLazily$command$slambda).p1d = function ($this$flow, completion) {
  var i = new StartedLazily$command$slambda(this.l1d_1, completion);
  i.m1d_1 = $this$flow;
  return i;
};
function StartedLazily$command$slambda_0($subscriptionCount, resultContinuation) {
  ...
  var l = function ($this$flow, $completion) {
    return i.o1d($this$flow, $completion);
  };
  l.$arity = 1;
  return l;
}
...
protoOf(StartedLazily).o1c = function (subscriptionCount) {
...
protoOf(StartedWhileSubscribed$command$slambda).b1e = function ($this$transformLatest, count, $completion) {
  var tmp = this.c1e($this$transformLatest, count, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(StartedWhileSubscribed$command$slambda).l9 = function (p1, p2, $completion) {
  ...
  return this.b1e(tmp, (!(p2 == null) ? typeof p2 === 'number' : false) ? p2 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          ...
          if (this.a1e_1 > 0) {
            this.u8_1 = 6;
            suspendResult = this.z1d_1.g18(SharingCommand_START_getInstance(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
            ...
            this.u8_1 = 1;
            suspendResult = delay(this.y1d_1.d1e_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
        ...
        case 1:
          if (this.y1d_1.e1e_1.y(new Long(0, 0)) > 0) {
            this.u8_1 = 2;
            suspendResult = this.z1d_1.g18(SharingCommand_STOP_getInstance(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
        ...
        case 2:
          this.u8_1 = 3;
          suspendResult = delay(this.y1d_1.e1e_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 4:
          this.u8_1 = 5;
          suspendResult = this.z1d_1.g18(SharingCommand_STOP_AND_RESET_REPLAY_CACHE_getInstance(), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(StartedWhileSubscribed$command$slambda).c1e = function ($this$transformLatest, count, completion) {
  var i = new StartedWhileSubscribed$command$slambda(this.y1d_1, completion);
  i.z1d_1 = $this$transformLatest;
  i.a1e_1 = count;
  return i;
};
function StartedWhileSubscribed$command$slambda_0(this$0, resultContinuation) {
  ...
  var l = function ($this$transformLatest, count, $completion) {
    return i.b1e($this$transformLatest, count, $completion);
  };
  l.$arity = 2;
  return l;
}
...
protoOf(StartedWhileSubscribed$command$slambda_1).o1e = function (it, $completion) {
  var tmp = this.p1e(it, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(StartedWhileSubscribed$command$slambda_1).k9 = function (p1, $completion) {
  return this.o1e(p1 instanceof SharingCommand ? p1 : THROW_CCE(), $completion);
};
protoOf(StartedWhileSubscribed$command$slambda_1).c9 = function () {
  ...
  $sm: do
    try {
      ...
      if (tmp === 0) {
        this.v8_1 = 1;
        return !this.n1e_1.equals(SharingCommand_START_getInstance());
      } else if (tmp === 1) {
        throw this.x8_1;
      }
    } catch ($p) {
...
protoOf(StartedWhileSubscribed$command$slambda_1).p1e = function (it, completion) {
...
function StartedWhileSubscribed$command$slambda_2(resultContinuation) {
  ...
  var l = function (it, $completion) {
    return i.o1e(it, $completion);
  };
  l.$arity = 1;
  return l;
}
function StartedWhileSubscribed(stopTimeout, replayExpiration) {
  this.d1e_1 = stopTimeout;
  this.e1e_1 = replayExpiration;
  // Inline function 'kotlin.require' call
  if (!(this.d1e_1.y(new Long(0, 0)) >= 0)) {
    var message = 'stopTimeout(' + this.d1e_1.toString() + ' ms) cannot be negative';
    throw IllegalArgumentException_init_$Create$(toString(message));
  }
  // Inline function 'kotlin.require' call
  if (!(this.e1e_1.y(new Long(0, 0)) >= 0)) {
    var message_0 = 'replayExpiration(' + this.e1e_1.toString() + ' ms) cannot be negative';
    throw IllegalArgumentException_init_$Create$(toString(message_0));
  }
}
protoOf(StartedWhileSubscribed).o1c = function (subscriptionCount) {
...
protoOf(StartedWhileSubscribed).toString = function () {
  ...
  if (this.d1e_1.y(new Long(0, 0)) > 0) {
    this_0.e('stopTimeout=' + this.d1e_1.toString() + 'ms');
  }
  if (this.e1e_1.y(new Long(-1, 2147483647)) < 0) {
    this_0.e('replayExpiration=' + this.e1e_1.toString() + 'ms');
  }
...
protoOf(StartedWhileSubscribed).equals = function (other) {
  ...
  if (other instanceof StartedWhileSubscribed) {
    tmp_0 = this.d1e_1.equals(other.d1e_1);
  } else {
    tmp_0 = false;
  }
  if (tmp_0) {
    tmp = this.e1e_1.equals(other.e1e_1);
  } else {
    tmp = false;
  }
  return tmp;
...
protoOf(StartedWhileSubscribed).hashCode = function () {
  return imul(this.d1e_1.hashCode(), 31) + this.e1e_1.hashCode() | 0;
};
...
function updateState($this, expectedState, newState) {
  ...
  // Inline function 'kotlinx.coroutines.internal.synchronized' call
  // Inline function 'kotlinx.coroutines.internal.synchronizedImpl' call
  var oldState = $this.u1e_1.kotlinx$atomicfu$value;
  if (!(expectedState == null) && !equals(oldState, expectedState))
    return false;
  if (equals(oldState, newState))
    return true;
  $this.u1e_1.kotlinx$atomicfu$value = newState;
  curSequence = $this.v1e_1;
  if ((curSequence & 1) === 0) {
    curSequence = curSequence + 1 | 0;
    $this.v1e_1 = curSequence;
  } else {
    $this.v1e_1 = curSequence + 2 | 0;
    return true;
  }
  curSlots = $this.s1a_1;
  while (true) {
    ...
    // Inline function 'kotlinx.coroutines.internal.synchronized' call
    // Inline function 'kotlinx.coroutines.internal.synchronizedImpl' call
    if ($this.v1e_1 === curSequence) {
      $this.v1e_1 = curSequence + 1 | 0;
      return true;
    }
    curSequence = $this.v1e_1;
    curSlots = $this.s1a_1;
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 12;
          this.i1f_1 = this.g1f_1.r1b();
          this.u8_1 = 1;
          continue $sm;
        case 1:
          this.v8_1 = 11;
          var tmp_0 = this.h1f_1;
          if (tmp_0 instanceof SubscribedFlowCollector) {
            this.u8_1 = 2;
            suspendResult = this.h1f_1.u1b(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
        ...
        case 3:
          var tmp_1 = this;
          tmp_1.k1f_1 = this.a9().h9(Key_instance_3);
          this.l1f_1 = null;
          this.u8_1 = 4;
          continue $sm;
        case 4:
          ...
          this.m1f_1 = this.g1f_1.u1e_1.kotlinx$atomicfu$value;
          var tmp129_safe_receiver = this.k1f_1;
          ...
          if (this.l1f_1 == null || !equals(this.l1f_1, this.m1f_1)) {
            this.u8_1 = 5;
            var tmp0 = get_NULL();
            var value = this.m1f_1;
            var tmp_2;
            if (value === tmp0) {
            ...
            suspendResult = this.h1f_1.g18(tmp_2, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
        ...
        case 5:
          this.l1f_1 = this.m1f_1;
          this.u8_1 = 6;
          continue $sm;
        case 6:
          if (!this.i1f_1.o1f()) {
            this.u8_1 = 7;
            suspendResult = this.i1f_1.n1f(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
        ...
        case 8:
          ...
          continue $sm;
        case 9:
          this.j1f_1 = Unit_instance;
          this.v8_1 = 12;
          this.u8_1 = 10;
          continue $sm;
        case 10:
          this.v8_1 = 12;
          this.g1f_1.v1b(this.i1f_1);
          return Unit_instance;
        case 11:
          this.v8_1 = 12;
          var t = this.x8_1;
...
function StateFlowImpl(initialState) {
  AbstractSharedFlow.call(this);
  this.u1e_1 = atomic$ref$1(initialState);
  this.v1e_1 = 0;
}
protoOf(StateFlowImpl).p1f = function (value) {
...
protoOf(StateFlowImpl).t = function () {
  ...
  var value = this.u1e_1.kotlinx$atomicfu$value;
  var tmp;
  if (value === tmp0) {
...
protoOf(StateFlowImpl).q1f = function (expect, update) {
...
protoOf(StateFlowImpl).g18 = function (value, $completion) {
  this.p1f(value);
  return Unit_instance;
};
protoOf(StateFlowImpl).c1c = function () {
...
protoOf(StateFlowImpl).s17 = function (collector, $completion) {
  return this.x1b(collector, $completion);
};
...
protoOf(StateFlowImpl).d1c = function (context, capacity, onBufferOverflow) {
  return fuseStateFlow(this, context, capacity, onBufferOverflow);
};
function StateFlowSlot() {
  AbstractSharedFlowSlot.call(this);
  this.w1e_1 = new WorkaroundAtomicReference(null);
}
protoOf(StateFlowSlot).r1f = function (flow) {
  if (!(get_value(this.w1e_1) == null))
    return false;
  set_value(this.w1e_1, get_NONE());
  return true;
};
protoOf(StateFlowSlot).h1c = function (flow) {
  return this.r1f(flow instanceof StateFlowImpl ? flow : THROW_CCE());
};
protoOf(StateFlowSlot).s1f = function (flow) {
  set_value(this.w1e_1, null);
  return get_EMPTY_RESUMES();
};
protoOf(StateFlowSlot).j1c = function (flow) {
  return this.s1f(flow instanceof StateFlowImpl ? flow : THROW_CCE());
};
protoOf(StateFlowSlot).x1e = function () {
  ...
  while (true) {
    ...
    if (state == null)
      ...
      if (this.w1e_1.u1f(state, get_PENDING()))
        return Unit_instance;
    } else {
      if (this.w1e_1.u1f(state, get_NONE())) {
        // Inline function 'kotlin.coroutines.resume' call
...
protoOf(StateFlowSlot).o1f = function () {
  // Inline function 'kotlin.let' call
  // Inline function 'kotlinx.coroutines.assert' call
  return ensureNotNull(this.w1e_1.v1f(get_NONE())) === get_PENDING();
};
protoOf(StateFlowSlot).n1f = function ($completion) {
  var cancellable = new CancellableContinuationImpl(intercepted($completion), 1);
  cancellable.sr();
  $l$block: {
    // Inline function 'kotlinx.coroutines.assert' call
    if (this.w1e_1.u1f(get_NONE(), cancellable)) {
      break $l$block;
    }
    // Inline function 'kotlinx.coroutines.assert' call
    // Inline function 'kotlin.coroutines.resume' call
...
protoOf(AbstractSharedFlow).f1c = function () {
  // Inline function 'kotlinx.coroutines.internal.synchronized' call
  // Inline function 'kotlinx.coroutines.internal.synchronizedImpl' call
  var tmp0_elvis_lhs = this.v1a_1;
  var tmp;
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlin.also' call
    var this_0 = new SubscriptionCountStateFlow(this.t1a_1);
    this.v1a_1 = this_0;
    tmp = this_0;
  } else {
    tmp = tmp0_elvis_lhs;
...
protoOf(AbstractSharedFlow).r1b = function () {
  ...
  $l$loop: while (true) {
    ...
    if (index >= slots.length)
      index = 0;
    if ((slot instanceof AbstractSharedFlowSlot ? slot : THROW_CCE()).h1c(this))
      break $l$loop;
  }
  this.u1a_1 = index;
...
protoOf(AbstractSharedFlow).v1b = function (slot) {
  ...
  if (this.t1a_1 === 0)
    this.u1a_1 = 0;
  var resumes = (slot instanceof AbstractSharedFlowSlot ? slot : THROW_CCE()).j1c(this);
  var inductionVariable = 0;
...
function SubscriptionCountStateFlow(initialValue) {
  ...
  this.y1b(initialValue);
}
protoOf(SubscriptionCountStateFlow).i1g = function (delta) {
  // Inline function 'kotlinx.coroutines.internal.synchronized' call
  // Inline function 'kotlinx.coroutines.internal.synchronizedImpl' call
  return this.y1b(this.w1b() + delta | 0);
};
...
protoOf(ChannelFlow$_get_collectToFun_$slambda_j53z2e).t1g = function (it, $completion) {
  var tmp = this.u1g(it, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(ChannelFlow$_get_collectToFun_$slambda_j53z2e).k9 = function (p1, $completion) {
  return this.t1g((!(p1 == null) ? isInterface(p1, ProducerScope) : false) ? p1 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.r1g_1.y1g(this.s1g_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ChannelFlow$_get_collectToFun_$slambda_j53z2e).u1g = function (it, completion) {
  var i = new ChannelFlow$_get_collectToFun_$slambda_j53z2e(this.r1g_1, completion);
  i.s1g_1 = it;
  return i;
};
...
protoOf(ChannelFlow$collect$slambda).k1h = function ($this$coroutineScope, $completion) {
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = emitAll(this.h1h_1, this.i1h_1.m1h(this.j1h_1), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ChannelFlow$collect$slambda).l1h = function ($this$coroutineScope, completion) {
  var i = new ChannelFlow$collect$slambda(this.h1h_1, this.i1h_1, completion);
  i.j1h_1 = $this$coroutineScope;
  return i;
};
...
protoOf(ChannelFlow).n1h = function () {
  return ChannelFlow$_get_collectToFun_$slambda_j53z2e_0(this, null);
};
protoOf(ChannelFlow).o1h = function () {
  return this.w1g_1 === -3 ? -2 : this.w1g_1;
};
protoOf(ChannelFlow).p1h = function () {
  return null;
};
protoOf(ChannelFlow).d1c = function (context, capacity, onBufferOverflow) {
  // Inline function 'kotlinx.coroutines.assert' call
  var newContext = context.rh(this.v1g_1);
  var newCapacity;
  var newOverflow;
  if (!onBufferOverflow.equals(BufferOverflow_SUSPEND_getInstance())) {
  ...
  if (equals(newContext, this.v1g_1) && newCapacity === this.w1g_1 && newOverflow.equals(this.x1g_1))
    return this;
  return this.q1h(newContext, newCapacity, newOverflow);
};
protoOf(ChannelFlow).m1h = function (scope) {
  return produce(scope, this.v1g_1, this.o1h(), this.x1g_1, CoroutineStart_ATOMIC_getInstance(), VOID, this.n1h());
};
protoOf(ChannelFlow).s17 = function (collector, $completion) {
...
protoOf(ChannelFlow).toString = function () {
  ...
  var tmp134_safe_receiver = this.r1h();
  ...
  if (!(this.v1g_1 === EmptyCoroutineContext_getInstance())) {
    props.e('context=' + toString(this.v1g_1));
  }
  if (!(this.w1g_1 === -3)) {
    props.e('capacity=' + this.w1g_1);
  }
  if (!this.x1g_1.equals(BufferOverflow_SUSPEND_getInstance())) {
    props.e('onBufferOverflow=' + this.x1g_1.toString());
  }
...
protoOf(ChannelFlowOperatorImpl).q1h = function (context, capacity, onBufferOverflow) {
  return new ChannelFlowOperatorImpl(this.z1h_1, context, capacity, onBufferOverflow);
};
protoOf(ChannelFlowOperatorImpl).p1h = function () {
  return this.z1h_1;
};
protoOf(ChannelFlowOperatorImpl).a1i = function (collector, $completion) {
  return this.z1h_1.s17(collector, $completion);
};
...
protoOf(ChannelFlowOperator$collectWithContextUndispatched$slambda).l1i = function (it, $completion) {
  var tmp = this.m1i(it, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(ChannelFlowOperator$collectWithContextUndispatched$slambda).k9 = function (p1, $completion) {
  return this.l1i((!(p1 == null) ? isInterface(p1, FlowCollector) : false) ? p1 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.j1i_1.a1i(this.k1i_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ChannelFlowOperator$collectWithContextUndispatched$slambda).m1i = function (it, completion) {
  var i = new ChannelFlowOperator$collectWithContextUndispatched$slambda(this.j1i_1, completion);
  i.k1i_1 = it;
  return i;
};
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 7;
          if (this.v1i_1.w1g_1 === -3) {
            var tmp_0 = this;
            tmp_0.x1i_1 = this.a9();
            this.y1i_1 = newCoroutineContext_0(this.x1i_1, this.v1i_1.v1g_1);
            if (equals(this.y1i_1, this.x1i_1)) {
              this.u8_1 = 6;
              suspendResult = this.v1i_1.a1i(this.w1i_1, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
        ...
        case 1:
          if (equals(this.y1i_1.h9(Key_instance), this.x1i_1.h9(Key_instance))) {
            this.u8_1 = 5;
            suspendResult = collectWithContextUndispatched(this.v1i_1, this.w1i_1, this.y1i_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
        ...
        case 3:
          this.u8_1 = 4;
          suspendResult = protoOf(ChannelFlow).s17.call(this.v1i_1, this.w1i_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ChannelFlowOperator).y1g = function (scope, $completion) {
  return this.a1i(new SendingCollector(scope), $completion);
};
protoOf(ChannelFlowOperator).s17 = function (collector, $completion) {
...
protoOf(ChannelFlowOperator).toString = function () {
  return toString(this.z1h_1) + ' -> ' + protoOf(ChannelFlow).toString.call(this);
};
...
function UndispatchedContextCollector$emitRef$slambda($downstream, resultContinuation) {
  this.h1j_1 = $downstream;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(UndispatchedContextCollector$emitRef$slambda).j1j = function (it, $completion) {
  var tmp = this.k1j(it, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(UndispatchedContextCollector$emitRef$slambda).k9 = function (p1, $completion) {
  return this.j1j((p1 == null ? true : !(p1 == null)) ? p1 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.h1j_1.g18(this.i1j_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(UndispatchedContextCollector$emitRef$slambda).k1j = function (it, completion) {
  var i = new UndispatchedContextCollector$emitRef$slambda(this.h1j_1, completion);
  i.i1j_1 = it;
  return i;
};
function UndispatchedContextCollector$emitRef$slambda_0($downstream, resultContinuation) {
  ...
  var l = function (it, $completion) {
    return i.j1j(it, $completion);
  };
  l.$arity = 1;
  return l;
}
function UndispatchedContextCollector(downstream, emitContext) {
  this.l1j_1 = emitContext;
  this.m1j_1 = threadContextElements(this.l1j_1);
  var tmp = this;
  tmp.n1j_1 = UndispatchedContextCollector$emitRef$slambda_0(downstream, null);
}
protoOf(UndispatchedContextCollector).g18 = function (value, $completion) {
  return withContextUndispatched(this.l1j_1, value, this.m1j_1, this.n1j_1, $completion);
};
...
function combineInternal$slambda$slambda$slambda($resultChannel, $i, resultContinuation) {
  this.y1j_1 = $resultChannel;
  this.z1j_1 = $i;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(combineInternal$slambda$slambda$slambda).j1j = function (value, $completion) {
  var tmp = this.k1j(value, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 3;
          this.u8_1 = 1;
          suspendResult = this.y1j_1.z15(new IndexedValue(this.z1j_1, this.a1k_1), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(combineInternal$slambda$slambda$slambda).k1j = function (value, completion) {
  var i = new combineInternal$slambda$slambda$slambda(this.y1j_1, this.z1j_1, completion);
  i.a1k_1 = value;
  return i;
};
...
function combineInternal$slambda$slambda($flows, $i, $nonClosed, $resultChannel, resultContinuation) {
  this.k1k_1 = $flows;
  this.l1k_1 = $i;
  this.m1k_1 = $nonClosed;
  this.n1k_1 = $resultChannel;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(combineInternal$slambda$slambda).k1h = function ($this$launch, $completion) {
    ...
    try {
      ...
      switch (tmp) {
        ...
        case 1:
          this.v8_1 = 4;
          this.u8_1 = 2;
          var tmp_0 = this.k1k_1[this.l1k_1];
          var tmp_1 = combineInternal$slambda$slambda$slambda_0(this.n1k_1, this.l1k_1, null);
          suspendResult = tmp_0.s17(new sam$kotlinx_coroutines_flow_FlowCollector$0_0(tmp_1), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(combineInternal$slambda$slambda).l1h = function ($this$launch, completion) {
  var i = new combineInternal$slambda$slambda(this.k1k_1, this.l1k_1, this.m1k_1, this.n1k_1, completion);
  i.o1k_1 = $this$launch;
  return i;
};
...
function combineInternal$slambda($flows, $arrayFactory, $transform, $this_combineInternal, resultContinuation) {
  this.a1l_1 = $flows;
  this.b1l_1 = $arrayFactory;
  this.c1l_1 = $transform;
  this.d1l_1 = $this_combineInternal;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(combineInternal$slambda).k1h = function ($this$flowScope, $completion) {
  var tmp = this.l1h($this$flowScope, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 10;
          this.f1l_1 = this.a1l_1.length;
          if (this.f1l_1 === 0)
            return Unit_instance;
          var tmp_0 = this;
          var size = this.f1l_1;
          tmp_0.g1l_1 = Array(size);
          fill(this.g1l_1, get_UNINITIALIZED());
          this.h1l_1 = Channel(this.f1l_1);
          this.i1l_1 = new LocalAtomicInt(this.f1l_1);
          this.j1l_1 = this.f1l_1;
          var inductionVariable = 0;
          var last = this.f1l_1;
          if (inductionVariable < last)
            do {
              var i = inductionVariable;
              inductionVariable = inductionVariable + 1 | 0;
              launch(this.e1l_1, VOID, VOID, combineInternal$slambda$slambda_0(this.a1l_1, i, this.i1l_1, this.h1l_1, null));
            }
             while (inductionVariable < last);
          this.k1l_1 = new Int8Array(this.f1l_1);
          this.l1l_1 = 0;
          this.u8_1 = 1;
          continue $sm;
        case 1:
          ...
          this.l1l_1 = numberToByte(this.l1l_1 + 1);
          this.u8_1 = 2;
          suspendResult = this.h1l_1.d16(this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
          ...
          continue $sm;
        case 2:
          this.m1l_1 = suspendResult.b13_1;
          suspendResult = new ChannelResult(this.m1l_1);
          this.u8_1 = 3;
          continue $sm;
        case 3:
          this.n1l_1 = suspendResult.b13_1;
          this.o1l_1 = ChannelResult__getOrNull_impl_f5e07h(this.n1l_1);
          if (this.o1l_1 == null) {
            this.u8_1 = 9;
            var tmp_1 = this;
            continue $sm;
        ...
        case 4:
          ...
          $l$loop_0: while (true) {
            var index = this.q1l_1.eg_1;
            var previous = this.g1l_1[index];
            this.g1l_1[index] = this.q1l_1.fg_1;
            if (previous === get_UNINITIALIZED()) {
              this.j1l_1 = this.j1l_1 - 1 | 0;
            }
            if (this.k1l_1[index] === this.l1l_1)
              break $l$loop_0;
            this.k1l_1[index] = this.l1l_1;
            var tmp_2 = this;
            var tmp1_elvis_lhs = ChannelResult__getOrNull_impl_f5e07h(this.h1l_1.e16());
            var tmp_3;
            if (tmp1_elvis_lhs == null) {
              break $l$loop_0;
            } else {
          ...
          if (this.j1l_1 === 0) {
            this.r1l_1 = this.b1l_1();
            if (this.r1l_1 == null) {
              this.u8_1 = 6;
              var tmp_4 = this.g1l_1;
              suspendResult = this.c1l_1(this.d1l_1, isArray(tmp_4) ? tmp_4 : THROW_CCE(), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
            } else {
              var tmp_5 = this.g1l_1;
              var tmp0 = isArray(tmp_5) ? tmp_5 : THROW_CCE();
              var destination = this.r1l_1;
              var endIndex = tmp0.length;
              arrayCopy(tmp0, destination, 0, 0, endIndex);
              this.u8_1 = 5;
              var tmp_6 = this.r1l_1;
              suspendResult = this.c1l_1(this.d1l_1, (!(tmp_6 == null) ? isArray(tmp_6) : false) ? tmp_6 : THROW_CCE(), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
...
protoOf(combineInternal$slambda).l1h = function ($this$flowScope, completion) {
  var i = new combineInternal$slambda(this.a1l_1, this.b1l_1, this.c1l_1, this.d1l_1, completion);
  i.e1l_1 = $this$flowScope;
  return i;
};
function combineInternal$slambda_0($flows, $arrayFactory, $transform, $this_combineInternal, resultContinuation) {
  ...
  var l = function ($this$flowScope, $completion) {
    return i.k1h($this$flowScope, $completion);
  };
  l.$arity = 1;
  return l;
}
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.j1m_1.r1m_1(this.k1m_1, this.l1m_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ChannelFlowTransformLatest$flowCollect$slambda$slambda$slambda).l1h = function ($this$launch, completion) {
  var i = new ChannelFlowTransformLatest$flowCollect$slambda$slambda$slambda(this.j1m_1, this.k1m_1, this.l1m_1, completion);
  i.m1m_1 = $this$launch;
  return i;
};
...
function ChannelFlowTransformLatest$flowCollect$slambda$slambda($previousFlow, $this_coroutineScope, this$0, $collector, resultContinuation) {
  this.a1n_1 = $previousFlow;
  this.b1n_1 = $this_coroutineScope;
  this.c1n_1 = this$0;
  this.d1n_1 = $collector;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(ChannelFlowTransformLatest$flowCollect$slambda$slambda).j1j = function (value, $completion) {
  var tmp = this.k1j(value, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
      ...
      switch (tmp) {
        case 0:
          ...
          if (this.f1n_1 == null) {
            ...
            var tmp_0 = this;
            tmp_0.h1n_1 = this.f1n_1;
            this.i1n_1 = this.h1n_1;
            var tmp_1 = this;
            tmp_1.j1n_1 = this.i1n_1;
            this.k1n_1 = this.j1n_1;
            this.k1n_1.dp(new ChildCancelledException());
            this.u8_1 = 1;
            suspendResult = this.k1n_1.ap(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
        ...
        case 1:
          this.g1n_1 = this.i1n_1;
          this.u8_1 = 2;
          continue $sm;
        case 2:
          var tmp_2 = CoroutineStart_UNDISPATCHED_getInstance();
          this.a1n_1._v = launch(this.b1n_1, VOID, tmp_2, ChannelFlowTransformLatest$flowCollect$slambda$slambda$slambda_0(this.c1n_1, this.d1n_1, this.e1n_1, null));
          return Unit_instance;
        case 3:
          throw this.x8_1;
      }
...
protoOf(ChannelFlowTransformLatest$flowCollect$slambda$slambda).k1j = function (value, completion) {
  var i = new ChannelFlowTransformLatest$flowCollect$slambda$slambda(this.a1n_1, this.b1n_1, this.c1n_1, this.d1n_1, completion);
  i.e1n_1 = value;
  return i;
};
...
function sam$kotlinx_coroutines_flow_FlowCollector$0_1(function_0) {
  this.l1n_1 = function_0;
}
protoOf(sam$kotlinx_coroutines_flow_FlowCollector$0_1).g18 = function (value, $completion) {
  return this.l1n_1(value, $completion);
};
...
protoOf(ChannelFlowTransformLatest$flowCollect$slambda).k1h = function ($this$coroutineScope, $completion) {
  var tmp = this.l1h($this$coroutineScope, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          ...
          this.x1n_1 = {_v: null};
          this.u8_1 = 1;
          var tmp_0 = ChannelFlowTransformLatest$flowCollect$slambda$slambda_0(this.x1n_1, this.w1n_1, this.u1n_1, this.v1n_1, null);
          suspendResult = this.u1n_1.z1h_1.s17(new sam$kotlinx_coroutines_flow_FlowCollector$0_1(tmp_0), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ChannelFlowTransformLatest$flowCollect$slambda).l1h = function ($this$coroutineScope, completion) {
  var i = new ChannelFlowTransformLatest$flowCollect$slambda(this.u1n_1, this.v1n_1, completion);
  i.w1n_1 = $this$coroutineScope;
  return i;
};
...
function ChannelFlowTransformLatest(transform, flow, context, capacity, onBufferOverflow) {
  ...
  onBufferOverflow = onBufferOverflow === VOID ? BufferOverflow_SUSPEND_getInstance() : onBufferOverflow;
  ChannelFlowOperator.call(this, flow, context, capacity, onBufferOverflow);
  this.r1m_1 = transform;
}
protoOf(ChannelFlowTransformLatest).q1h = function (context, capacity, onBufferOverflow) {
  return new ChannelFlowTransformLatest(this.r1m_1, this.z1h_1, context, capacity, onBufferOverflow);
};
protoOf(ChannelFlowTransformLatest).y1n = function (collector, $completion) {
  // Inline function 'kotlinx.coroutines.assert' call
  return coroutineScope(ChannelFlowTransformLatest$flowCollect$slambda_0(this, collector, null), $completion);
};
protoOf(ChannelFlowTransformLatest).a1i = function (collector, $completion) {
  return this.y1n(collector, $completion);
};
function NopCollector() {
}
protoOf(NopCollector).z1n = function (value, $completion) {
  return Unit_instance;
};
protoOf(NopCollector).g18 = function (value, $completion) {
  return this.z1n((value == null ? true : !(value == null)) ? value : THROW_CCE(), $completion);
};
...
function checkContext$lambda($this_checkContext) {
  return function (count, element) {
    var key = element.s();
    var collectElement = $this_checkContext.d1a_1.h9(key);
    var tmp;
...
protoOf(SendingCollector).g18 = function (value, $completion) {
  return this.a1o_1.z15(value, $completion);
};
function buffer(_this__u8e3s4, capacity, onBufferOverflow) {
  ...
  if (isInterface(_this__u8e3s4, FusibleFlow)) {
    tmp = _this__u8e3s4.e1c(VOID, capacity_0, onBufferOverflow_0);
  } else {
...
function distinctUntilChangedBy(_this__u8e3s4, keySelector, areEquivalent) {
  ...
  if (_this__u8e3s4 instanceof DistinctFlowImpl) {
    tmp_1 = _this__u8e3s4.c1o_1 === keySelector;
  } else {
    tmp_1 = false;
  }
  if (tmp_1) {
    tmp_0 = _this__u8e3s4.d1o_1 === areEquivalent;
  } else {
    tmp_0 = false;
  }
  if (tmp_0) {
...
function sam$kotlinx_coroutines_flow_FlowCollector$0_2(function_0) {
  this.e1o_1 = function_0;
}
protoOf(sam$kotlinx_coroutines_flow_FlowCollector$0_2).g18 = function (value, $completion) {
  return this.e1o_1(value, $completion);
};
...
function DistinctFlowImpl$collect$slambda(this$0, $previousKey, $collector, resultContinuation) {
  this.n1o_1 = this$0;
  this.o1o_1 = $previousKey;
  this.p1o_1 = $collector;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(DistinctFlowImpl$collect$slambda).j1j = function (value, $completion) {
  var tmp = this.k1j(value, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 3;
          this.r1o_1 = this.n1o_1.c1o_1(this.q1o_1);
          if (this.o1o_1._v === get_NULL() || !this.n1o_1.d1o_1(this.o1o_1._v, this.r1o_1)) {
            this.o1o_1._v = this.r1o_1;
            this.u8_1 = 1;
            suspendResult = this.p1o_1.g18(this.q1o_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
...
protoOf(DistinctFlowImpl$collect$slambda).k1j = function (value, completion) {
  var i = new DistinctFlowImpl$collect$slambda(this.n1o_1, this.o1o_1, this.p1o_1, completion);
  i.q1o_1 = value;
  return i;
};
...
function DistinctFlowImpl(upstream, keySelector, areEquivalent) {
  this.b1o_1 = upstream;
  this.c1o_1 = keySelector;
  this.d1o_1 = areEquivalent;
}
protoOf(DistinctFlowImpl).s17 = function (collector, $completion) {
  var previousKey = {_v: get_NULL()};
  var tmp = DistinctFlowImpl$collect$slambda_0(this, previousKey, collector, null);
  return this.b1o_1.s17(new sam$kotlinx_coroutines_flow_FlowCollector$0_2(tmp), $completion);
};
...
protoOf(sam$kotlinx_coroutines_flow_FlowCollector$0_3).g18 = function (value, $completion) {
  return this.t1o_1(value, $completion);
};
...
function dropWhile$o$collect$slambda($matched, $$this$flow, $predicate, resultContinuation) {
  this.c1p_1 = $matched;
  this.d1p_1 = $$this$flow;
  this.e1p_1 = $predicate;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(dropWhile$o$collect$slambda).j1j = function (value, $completion) {
  var tmp = this.k1j(value, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          ...
          if (this.c1p_1._v) {
            this.u8_1 = 3;
            suspendResult = this.d1p_1.g18(this.f1p_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
            ...
            this.u8_1 = 1;
            suspendResult = this.e1p_1(this.f1p_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
...
protoOf(dropWhile$o$collect$slambda).k1j = function (value, completion) {
  var i = new dropWhile$o$collect$slambda(this.c1p_1, this.d1p_1, this.e1p_1, completion);
  i.f1p_1 = value;
  return i;
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          var tmp_0 = this;
          tmp_0.r1p_1 = this.q1p_1;
          this.s1p_1 = this.r1p_1;
          this.t1p_1 = {_v: false};
          this.u8_1 = 1;
          var tmp_1 = dropWhile$o$collect$slambda_0(this.t1p_1, this.s1p_1, this.p1p_1.v1p_1, null);
          suspendResult = this.p1p_1.u1p_1.s17(new sam$kotlinx_coroutines_flow_FlowCollector$0_3(tmp_1), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
function dropWhile$$inlined$unsafeFlow$1($this_dropWhile, $predicate) {
  this.u1p_1 = $this_dropWhile;
  this.v1p_1 = $predicate;
}
protoOf(dropWhile$$inlined$unsafeFlow$1).h18 = function (collector, $completion) {
  var tmp = new $collectCOROUTINE$_5(this, collector, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(dropWhile$$inlined$unsafeFlow$1).s17 = function (collector, $completion) {
  return this.h18(collector, $completion);
};
...
protoOf(mapLatest$slambda).i1q = function ($this$transformLatest, it, $completion) {
  var tmp = this.j1q($this$transformLatest, it, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(mapLatest$slambda).l9 = function (p1, p2, $completion) {
  var tmp = (!(p1 == null) ? isInterface(p1, FlowCollector) : false) ? p1 : THROW_CCE();
  return this.i1q(tmp, (p2 == null ? true : !(p2 == null)) ? p2 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 3;
          this.u8_1 = 1;
          suspendResult = this.e1q_1(this.g1q_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 1:
          ...
          this.u8_1 = 2;
          suspendResult = this.f1q_1.g18(this.h1q_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(mapLatest$slambda).j1q = function ($this$transformLatest, it, completion) {
  var i = new mapLatest$slambda(this.e1q_1, completion);
  i.f1q_1 = $this$transformLatest;
  i.g1q_1 = it;
  return i;
};
function mapLatest$slambda_0($transform, resultContinuation) {
  ...
  var l = function ($this$transformLatest, it, $completion) {
    return i.i1q($this$transformLatest, it, $completion);
  };
  l.$arity = 2;
  return l;
}
...
function stateIn(_this__u8e3s4, scope, started, initialValue) {
  ...
  var job = launchSharing(scope, config.n1q_1, config.k1q_1, state, started, initialValue);
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 7;
          var tmp_0 = this;
          tmp_0.x1q_1 = new SafeCollector(this.w1q_1.s1b_1, this.a9());
          this.u8_1 = 1;
          continue $sm;
        case 1:
          this.v8_1 = 6;
          this.u8_1 = 2;
          suspendResult = this.w1q_1.t1b_1(this.x1q_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 3:
          this.v8_1 = 7;
          this.x1q_1.e9();
          var tmp_1 = this.w1q_1.s1b_1;
          if (tmp_1 instanceof SubscribedFlowCollector) {
            this.u8_1 = 4;
            suspendResult = this.w1q_1.s1b_1.u1b(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.h1r_1.j1r_1.x1b(this.i1r_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ReadonlyStateFlow).s17 = function (collector, $completion) {
  return this.x1b(collector, $completion);
};
protoOf(ReadonlyStateFlow).d1c = function (context, capacity, onBufferOverflow) {
  return fuseStateFlow(this, context, capacity, onBufferOverflow);
};
function SharingConfig(upstream, extraBufferCapacity, onBufferOverflow, context) {
  this.k1q_1 = upstream;
  this.l1q_1 = extraBufferCapacity;
  this.m1q_1 = onBufferOverflow;
  this.n1q_1 = context;
}
function configureSharing(_this__u8e3s4, replay) {
  // Inline function 'kotlinx.coroutines.assert' call
  var defaultExtraCapacity = coerceAtLeast(replay, Factory_getInstance().r16_1) - replay | 0;
  if (_this__u8e3s4 instanceof ChannelFlow) {
    var upstream = _this__u8e3s4.p1h();
    if (!(upstream == null)) {
      var tmp144_subject = _this__u8e3s4.w1g_1;
      return new SharingConfig(upstream, tmp144_subject === -3 || (tmp144_subject === -2 || tmp144_subject === 0) ? _this__u8e3s4.x1g_1.equals(BufferOverflow_SUSPEND_getInstance()) ? _this__u8e3s4.w1g_1 === 0 ? 0 : defaultExtraCapacity : replay === 0 ? 1 : 0 : _this__u8e3s4.w1g_1, _this__u8e3s4.x1g_1, _this__u8e3s4.v1g_1);
    }
  }
...
function launchSharing(_this__u8e3s4, context, upstream, shared, started, initialValue) {
  var start = equals(started, Companion_getInstance_0().k1c_1) ? CoroutineStart_DEFAULT_getInstance() : CoroutineStart_UNDISPATCHED_getInstance();
...
protoOf(launchSharing$slambda$slambda).u1r = function (it, $completion) {
  var tmp = this.b1d(it, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(launchSharing$slambda$slambda).k9 = function (p1, $completion) {
  return this.u1r((!(p1 == null) ? typeof p1 === 'number' : false) ? p1 : THROW_CCE(), $completion);
};
...
protoOf(launchSharing$slambda$slambda).b1d = function (it, completion) {
...
function launchSharing$slambda$slambda_1($upstream, $shared, $initialValue, resultContinuation) {
  this.d1s_1 = $upstream;
  this.e1s_1 = $shared;
  this.f1s_1 = $initialValue;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(launchSharing$slambda$slambda_1).k1s = function (it, $completion) {
  var tmp = this.p1e(it, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
...
protoOf(launchSharing$slambda$slambda_1).k9 = function (p1, $completion) {
  return this.k1s(p1 instanceof SharingCommand ? p1 : THROW_CCE(), $completion);
};
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 3;
          this.h1s_1 = this.g1s_1;
          this.i1s_1 = this.h1s_1.l2_1;
          if (this.i1s_1 === 0) {
            this.u8_1 = 1;
            suspendResult = this.d1s_1.s17(this.e1s_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
            ...
            if (this.i1s_1 === 1) {
              ...
              if (this.i1s_1 === 2) {
                var tmp_1 = this;
                var tmp_2;
                if (this.f1s_1 === get_NO_VALUE()) {
                  this.e1s_1.c1c();
                  tmp_2 = Unit_instance;
                } else {
                  tmp_2 = this.e1s_1.y1b(this.f1s_1);
                }
                tmp_1.j1s_1 = tmp_2;
                this.u8_1 = 2;
                continue $sm;
...
protoOf(launchSharing$slambda$slambda_1).p1e = function (it, completion) {
  var i = new launchSharing$slambda$slambda_1(this.d1s_1, this.e1s_1, this.f1s_1, completion);
  i.g1s_1 = it;
  return i;
};
...
function launchSharing$slambda($started, $upstream, $shared, $initialValue, resultContinuation) {
  ...
  this.u1s_1 = $upstream;
  this.v1s_1 = $shared;
  this.w1s_1 = $initialValue;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(launchSharing$slambda).k1h = function ($this$launch, $completion) {
  var tmp = this.l1h($this$launch, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 6;
          if (this.t1s_1 === Companion_getInstance_0().k1c_1) {
            this.u8_1 = 4;
            suspendResult = this.u1s_1.s17(this.v1s_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
          } else {
            if (this.t1s_1 === Companion_getInstance_0().l1c_1) {
              this.u8_1 = 2;
              var tmp_0 = this.v1s_1.f1c();
              ...
              this.u8_1 = 1;
              var tmp_1 = distinctUntilChanged(this.t1s_1.o1c(this.v1s_1.f1c()));
              suspendResult = collectLatest(tmp_1, launchSharing$slambda$slambda_2(this.u1s_1, this.v1s_1, this.w1s_1, null), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
...
protoOf(launchSharing$slambda).l1h = function ($this$launch, completion) {
  var i = new launchSharing$slambda(this.t1s_1, this.u1s_1, this.v1s_1, this.w1s_1, completion);
  i.x1s_1 = $this$launch;
  return i;
};
...
function combine(flow, flow2, flow3, transform) {
...
function combine$o$collect$slambda($transform, resultContinuation) {
  this.g1t_1 = $transform;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(combine$o$collect$slambda).m1t = function ($this$combineInternal, it, $completion) {
  var tmp = this.n1t($this$combineInternal, it, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(combine$o$collect$slambda).l9 = function (p1, p2, $completion) {
  var tmp = (!(p1 == null) ? isInterface(p1, FlowCollector) : false) ? p1 : THROW_CCE();
  return this.m1t(tmp, (!(p2 == null) ? isArray(p2) : false) ? p2 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 3;
          var tmp_0 = this;
          tmp_0.j1t_1 = this.i1t_1;
          this.k1t_1 = this.j1t_1;
          this.u8_1 = 1;
          var tmp_1 = this.k1t_1[0];
          var tmp_2 = (tmp_1 == null ? true : !(tmp_1 == null)) ? tmp_1 : THROW_CCE();
          var tmp_3 = this.k1t_1[1];
          var tmp_4 = (tmp_3 == null ? true : !(tmp_3 == null)) ? tmp_3 : THROW_CCE();
          var tmp_5 = this.k1t_1[2];
          suspendResult = this.g1t_1(tmp_2, tmp_4, (tmp_5 == null ? true : !(tmp_5 == null)) ? tmp_5 : THROW_CCE(), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 1:
          ...
          this.u8_1 = 2;
          suspendResult = this.h1t_1.g18(this.l1t_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(combine$o$collect$slambda).n1t = function ($this$combineInternal, it, completion) {
  var i = new combine$o$collect$slambda(this.g1t_1, completion);
  i.h1t_1 = $this$combineInternal;
  i.i1t_1 = it;
  return i;
};
function combine$o$collect$slambda_0($transform, resultContinuation) {
  ...
  var l = function ($this$combineInternal, it, $completion) {
    return i.m1t($this$combineInternal, it, $completion);
  };
  l.$arity = 2;
  return l;
}
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          var tmp_0 = this;
          tmp_0.y1t_1 = this.x1t_1;
          this.z1t_1 = this.y1t_1;
          this.u8_1 = 1;
          var tmp_1 = nullArrayFactory();
          suspendResult = combineInternal(this.z1t_1, this.w1t_1.a1u_1, tmp_1, combine$o$collect$slambda_0(this.w1t_1.b1u_1, null), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
function combine$$inlined$combineUnsafe$1($flows, $transform) {
  this.a1u_1 = $flows;
  this.b1u_1 = $transform;
}
protoOf(combine$$inlined$combineUnsafe$1).h18 = function (collector, $completion) {
  var tmp = new $collectCOROUTINE$_7(this, collector, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(combine$$inlined$combineUnsafe$1).s17 = function (collector, $completion) {
  return this.h18(collector, $completion);
};
...
function collect(_this__u8e3s4, $completion) {
  return _this__u8e3s4.s17(NopCollector_instance, $completion);
}
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          ...
          this.u8_1 = 1;
          suspendResult = this.m1v_1.r1v_1(this.p1v_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 1:
          if (suspendResult) {
            var tmp_1 = this;
            this.m1v_1.s1v_1._v = this.p1v_1;
            tmp_1.q1v_1 = false;
            this.u8_1 = 2;
            continue $sm;
          } else {
        ...
        case 2:
          var ARGUMENT = this.q1v_1;
          if (!ARGUMENT) {
            throw new AbortFlowException(this.m1v_1);
          } else {
            this.u8_1 = 3;
            continue $sm;
          }
...
function first$$inlined$collectWhile$1($predicate, $result) {
  this.r1v_1 = $predicate;
  this.s1v_1 = $result;
}
protoOf(first$$inlined$collectWhile$1).z1n = function (value, $completion) {
  var tmp = new $emitCOROUTINE$(this, value, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(first$$inlined$collectWhile$1).g18 = function (value, $completion) {
  return this.z1n((value == null ? true : !(value == null)) ? value : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 4;
          var tmp_0 = this;
          tmp_0.d1w_1 = this.c1w_1;
          this.e1w_1 = this.d1w_1;
          this.u8_1 = 1;
          suspendResult = this.b1w_1.g1w_1(this.e1w_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 1:
          if (suspendResult) {
            var tmp_1 = this;
            this.b1w_1.h1w_1._v = this.e1w_1;
            tmp_1.f1w_1 = false;
            this.u8_1 = 2;
            continue $sm;
          } else {
        ...
        case 2:
          var ARGUMENT = this.f1w_1;
          if (!ARGUMENT) {
            throw new AbortFlowException(this.b1w_1);
          } else {
            this.u8_1 = 3;
            continue $sm;
          }
...
function firstOrNull$$inlined$collectWhile$1($predicate, $result) {
  this.g1w_1 = $predicate;
  this.h1w_1 = $result;
}
protoOf(firstOrNull$$inlined$collectWhile$1).z1n = function (value, $completion) {
  var tmp = new $emitCOROUTINE$_0(this, value, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(firstOrNull$$inlined$collectWhile$1).g18 = function (value, $completion) {
  return this.z1n((value == null ? true : !(value == null)) ? value : THROW_CCE(), $completion);
};
function $firstCOROUTINE$(_this__u8e3s4, predicate, resultContinuation) {
  CoroutineImpl.call(this, resultContinuation);
  this.k1u_1 = _this__u8e3s4;
  this.l1u_1 = predicate;
}
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 3;
          this.m1u_1 = {_v: get_NULL()};
          var tmp_0 = this;
          tmp_0.n1u_1 = this.k1u_1;
          this.o1u_1 = this.n1u_1;
          var tmp_1 = this;
          tmp_1.p1u_1 = new first$$inlined$collectWhile$1(this.l1u_1, this.m1u_1);
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.o1u_1.s17(this.p1u_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 4:
          this.v8_1 = 3;
          if (this.m1u_1._v === get_NULL())
            throw NoSuchElementException_init_$Create$_0('Expected at least one element matching the predicate ' + toString(this.l1u_1));
          var tmp_3 = this.m1u_1._v;
...
function $firstOrNullCOROUTINE$(_this__u8e3s4, predicate, resultContinuation) {
  CoroutineImpl.call(this, resultContinuation);
  this.y1u_1 = _this__u8e3s4;
  this.z1u_1 = predicate;
}
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          ...
          this.a1v_1 = {_v: null};
          var tmp_0 = this;
          tmp_0.b1v_1 = this.y1u_1;
          this.c1v_1 = this.b1v_1;
          var tmp_1 = this;
          tmp_1.d1v_1 = new firstOrNull$$inlined$collectWhile$1(this.z1u_1, this.a1v_1);
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.c1v_1.s17(this.d1v_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
function set_value(_this__u8e3s4, value) {
  return _this__u8e3s4.i1w(value);
}
...
function Segment(id, prev, pointers) {
  ...
  this.lt_1 = id;
  this.mt_1 = atomic$int$1(pointers << 16);
}
protoOf(Segment).x10 = function () {
  return this.mt_1.kotlinx$atomicfu$value === this.zz() && !this.e11();
};
protoOf(Segment).y10 = function () {
  var tmp0 = this.mt_1;
  var tmp$ret$1;
  $l$block_0: {
...
protoOf(Segment).z10 = function () {
  return this.mt_1.atomicfu$addAndGet(-65536) === this.zz() && !this.e11();
};
protoOf(Segment).w10 = function () {
  if (this.mt_1.atomicfu$incrementAndGet() === this.zz()) {
    this.b4();
  }
};
...
function SegmentOrClosed__equals_impl_6erq1g($this, other) {
  if (!(other instanceof SegmentOrClosed))
    return false;
  var tmp0_other_with_cast = other instanceof SegmentOrClosed ? other.o13_1 : THROW_CCE();
  if (!equals($this, tmp0_other_with_cast))
    return false;
  return true;
}
...
protoOf(SegmentOrClosed).toString = function () {
  return SegmentOrClosed__toString_impl_pzb2an(this.o13_1);
};
protoOf(SegmentOrClosed).hashCode = function () {
  return SegmentOrClosed__hashCode_impl_4855hs(this.o13_1);
};
protoOf(SegmentOrClosed).equals = function (other) {
  return SegmentOrClosed__equals_impl_6erq1g(this.o13_1, other);
};
function _get_nextOrClosed__w0gmuv($this) {
  return $this.a11_1.kotlinx$atomicfu$value;
}
function _get_aliveSegmentLeft__mr4ndu($this) {
  var cur = $this.f11();
  while (!(cur === null) && cur.x10())
    cur = cur.b11_1.kotlinx$atomicfu$value;
  return cur;
}
function _get_aliveSegmentRight__7ulr0b($this) {
  // Inline function 'kotlinx.coroutines.assert' call
  var cur = ensureNotNull($this.c11());
  while (cur.x10()) {
    var tmp0_elvis_lhs = cur.c11();
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return cur;
    } else {
...
function ConcurrentLinkedListNode(prev) {
  this.a11_1 = atomic$ref$1(null);
  this.b11_1 = atomic$ref$1(prev);
}
protoOf(ConcurrentLinkedListNode).c11 = function () {
  // Inline function 'kotlinx.coroutines.internal.ConcurrentLinkedListNode.nextOrIfClosed' call
  // Inline function 'kotlin.let' call
...
protoOf(ConcurrentLinkedListNode).d11 = function (value) {
  return this.a11_1.atomicfu$compareAndSet(null, value);
};
protoOf(ConcurrentLinkedListNode).e11 = function () {
  return this.c11() == null;
};
protoOf(ConcurrentLinkedListNode).f11 = function () {
  return this.b11_1.kotlinx$atomicfu$value;
};
protoOf(ConcurrentLinkedListNode).g11 = function () {
  // Inline function 'kotlinx.atomicfu.AtomicRef.lazySet' call
  this.b11_1.kotlinx$atomicfu$value = null;
};
protoOf(ConcurrentLinkedListNode).h11 = function () {
  return this.a11_1.atomicfu$compareAndSet(null, get_CLOSED());
};
protoOf(ConcurrentLinkedListNode).b4 = function () {
  ...
  $l$loop_0: while (true) {
    ...
    if (!(prev === null))
      prev.a11_1.kotlinx$atomicfu$value = next;
    if (next.x10() && !next.e11())
      continue $l$loop_0;
    if (!(prev === null) && prev.x10())
      continue $l$loop_0;
    return Unit_instance;
  }
};
function findSegmentInternal(_this__u8e3s4, id, createNewSegment) {
  _init_properties_ConcurrentLinkedList_kt__5gcgzy();
  var cur = _this__u8e3s4;
  $l$loop: while (cur.lt_1.y(id) < 0 || cur.x10()) {
    // Inline function 'kotlinx.coroutines.internal.ConcurrentLinkedListNode.nextOrIfClosed' call
    var this_0 = cur;
    // Inline function 'kotlin.let' call
    var it = access$_get_nextOrClosed__ywzond(this_0);
    ...
    // Inline function 'kotlin.Long.plus' call
    var newTail = createNewSegment(cur.lt_1.r2(toLong(1)), cur);
    if (cur.d11(newTail)) {
      if (cur.x10()) {
        cur.b4();
      }
...
function _get_reusableCancellableContinuation__9qex09($this) {
  var tmp = $this.dt_1.kotlinx$atomicfu$value;
  return tmp instanceof CancellableContinuationImpl ? tmp : null;
}
function DispatchedContinuation(dispatcher, continuation) {
  DispatchedTask.call(this, -1);
  this.zs_1 = dispatcher;
  this.at_1 = continuation;
  this.bt_1 = get_UNDEFINED();
  this.ct_1 = threadContextElements(this.a9());
  this.dt_1 = atomic$ref$1(null);
}
protoOf(DispatchedContinuation).a9 = function () {
  return this.at_1.a9();
};
protoOf(DispatchedContinuation).gt = function () {
  return !(this.dt_1.kotlinx$atomicfu$value == null);
};
protoOf(DispatchedContinuation).j1w = function () {
  // Inline function 'kotlinx.atomicfu.loop' call
...
protoOf(DispatchedContinuation).et = function () {
  ...
  while (true) {
    var state = this_0.kotlinx$atomicfu$value;
    if (state === null) {
      this.dt_1.kotlinx$atomicfu$value = get_REUSABLE_CLAIMED();
      return null;
    } else {
      if (state instanceof CancellableContinuationImpl) {
        if (this.dt_1.atomicfu$compareAndSet(state, get_REUSABLE_CLAIMED())) {
...
protoOf(DispatchedContinuation).iu = function (continuation) {
  // Inline function 'kotlinx.atomicfu.loop' call
  var this_0 = this.dt_1;
  while (true) {
    var state = this_0.kotlinx$atomicfu$value;
    if (state === get_REUSABLE_CLAIMED()) {
      if (this.dt_1.atomicfu$compareAndSet(get_REUSABLE_CLAIMED(), continuation))
        return null;
    } else {
      if (state instanceof Error) {
        // Inline function 'kotlin.require' call
        // Inline function 'kotlin.require' call
        if (!this.dt_1.atomicfu$compareAndSet(state, null)) {
...
protoOf(DispatchedContinuation).it = function (cause) {
  // Inline function 'kotlinx.atomicfu.loop' call
  var this_0 = this.dt_1;
  while (true) {
    var state = this_0.kotlinx$atomicfu$value;
    if (equals(state, get_REUSABLE_CLAIMED())) {
      if (this.dt_1.atomicfu$compareAndSet(get_REUSABLE_CLAIMED(), cause))
        return true;
    } else {
      if (state instanceof Error)
        return true;
...
protoOf(DispatchedContinuation).zt = function () {
  var state = this.bt_1;
  // Inline function 'kotlinx.coroutines.assert' call
  this.bt_1 = get_UNDEFINED();
  return state;
...
protoOf(DispatchedContinuation).f9 = function (result) {
  ...
  if (this.zs_1.sv(this.a9())) {
    this.bt_1 = state;
    this.ht_1 = 0;
    this.zs_1.tv(this.a9(), this);
  } else {
    $l$block: {
      // Inline function 'kotlinx.coroutines.internal.executeUnconfined' call
      // Inline function 'kotlinx.coroutines.assert' call
      var eventLoop = ThreadLocalEventLoop_getInstance().nw();
      if (false && eventLoop.iw()) {
        break $l$block;
      }
      var tmp;
      if (eventLoop.hw()) {
...
protoOf(DispatchedContinuation).rz = function (context, value) {
  this.bt_1 = value;
  this.ht_1 = 1;
  this.zs_1.uv(context, this);
};
protoOf(DispatchedContinuation).toString = function () {
  return 'DispatchedContinuation[' + this.zs_1.toString() + ', ' + toDebugString(this.at_1) + ']';
};
function resumeCancellableWith(_this__u8e3s4, result) {
  ...
  if (_this__u8e3s4 instanceof DispatchedContinuation) {
    ...
    var state = toState_0(result);
    if (_this__u8e3s4.zs_1.sv(_this__u8e3s4.a9())) {
      _this__u8e3s4.bt_1 = state;
      _this__u8e3s4.ht_1 = 1;
      _this__u8e3s4.zs_1.tv(_this__u8e3s4.a9(), _this__u8e3s4);
    } else {
      $l$block: {
        // Inline function 'kotlinx.coroutines.internal.executeUnconfined' call
        // Inline function 'kotlinx.coroutines.assert' call
...
function yieldUndispatched(_this__u8e3s4) {
  ...
  $l$block: {
    ...
    // Inline function 'kotlinx.coroutines.assert' call
    var eventLoop = ThreadLocalEventLoop_getInstance().nw();
    if (true && eventLoop.iw()) {
      tmp$ret$1 = false;
      break $l$block;
    }
    var tmp;
    if (eventLoop.hw()) {
      _this__u8e3s4.bt_1 = Unit_instance;
      _this__u8e3s4.ht_1 = 1;
      eventLoop.gw(_this__u8e3s4);
      tmp = true;
    } else {
...
function DispatchedTask(resumeMode) {
  ...
  this.ht_1 = resumeMode;
}
protoOf(DispatchedTask).au = function (takenState, cause) {
};
protoOf(DispatchedTask).hu = function (state) {
  return (state == null ? true : !(state == null)) ? state : THROW_CCE();
};
protoOf(DispatchedTask).ru = function (state) {
  var tmp151_safe_receiver = state instanceof CompletedExceptionally ? state : null;
  return tmp151_safe_receiver == null ? null : tmp151_safe_receiver.zn_1;
};
protoOf(DispatchedTask).tu = function () {
  // Inline function 'kotlinx.coroutines.assert' call
  var fatalException = null;
  try {
    var tmp = this.yt();
    var delegate = tmp instanceof DispatchedContinuation ? tmp : THROW_CCE();
    var continuation = delegate.at_1;
    // Inline function 'kotlinx.coroutines.withContinuationContext' call
    delegate.ct_1;
    var context = continuation.a9();
    var state = this.zt();
    var exception = this.ru(state);
    var job = exception == null && get_isCancellableMode(this.ht_1) ? context.h9(Key_instance_3) : null;
    if (!(job == null) && !job.un()) {
      var cause = job.to();
      this.au(state, cause);
      // Inline function 'kotlinx.coroutines.resumeWithStackTrace' call
    ...
    if (tmp152_safe_receiver == null)
      ...
      // Inline function 'kotlin.let' call
      this.uu(tmp152_safe_receiver);
    }
  }
};
protoOf(DispatchedTask).uu = function (exception) {
  var reason = new CoroutinesInternalError('Fatal exception in coroutines machinery for ' + toString(this) + '. ' + "Please read KDoc to 'handleFatalException' method and report this incident to maintainers", exception);
  handleCoroutineException(this.yt().a9(), reason);
};
...
function dispatch(_this__u8e3s4, mode) {
  ...
  if (tmp_0) {
    tmp = get_isCancellableMode(mode) === get_isCancellableMode(_this__u8e3s4.ht_1);
  } else {
    tmp = false;
  }
  if (tmp) {
    var dispatcher = delegate.zs_1;
    var context = delegate.a9();
    if (dispatcher.sv(context)) {
      dispatcher.tv(context, _this__u8e3s4);
    } else {
...
function resume(_this__u8e3s4, delegate, undispatched) {
  var state = _this__u8e3s4.zt();
  var exception = _this__u8e3s4.ru(state);
  var tmp;
  if (!(exception == null)) {
    // Inline function 'kotlin.Companion.failure' call
    tmp = _Result___init__impl__xyqfz8(createFailure(exception));
    ...
    // Inline function 'kotlin.Companion.success' call
    var value = _this__u8e3s4.hu(state);
    tmp = _Result___init__impl__xyqfz8(value);
  }
  var result = tmp;
  if (undispatched) {
...
protoOf(ContextScope).tn = function () {
  return this.k1w_1;
};
protoOf(ContextScope).toString = function () {
  return 'CoroutineScope(coroutineContext=' + toString(this.k1w_1) + ')';
};
function ScopeCoroutine(context, uCont) {
  AbstractCoroutine.call(this, context, true, true);
  this.z1l_1 = uCont;
}
protoOf(ScopeCoroutine).np = function () {
  return true;
};
protoOf(ScopeCoroutine).eo = function (state) {
  resumeCancellableWith(intercepted(this.z1l_1), recoverResult(state, this.z1l_1));
};
protoOf(ScopeCoroutine).do = function (state) {
  this.z1l_1.f9(recoverResult(state, this.z1l_1));
};
...
function startUndispatchedOrReturn(_this__u8e3s4, receiver, block) {
  ...
  $l$block_0: {
    ...
    var state = _this__u8e3s4.co(result);
    if (state === get_COMPLETING_WAITING_CHILDREN()) {
      tmp$ret$2 = get_COROUTINE_SUSPENDED();
      break $l$block_0;
    }
    ...
    if (state instanceof CompletedExceptionally) {
      ...
      state.zn_1;
      if (true) {
        throw recoverStackTrace(state.zn_1, _this__u8e3s4.z1l_1);
      } else {
        if (result instanceof CompletedExceptionally) {
          throw recoverStackTrace(result.zn_1, _this__u8e3s4.z1l_1);
        } else {
          tmp_2 = result;
        }
      }
...
function trySelectInternal($this, clauseObject, internalResult) {
  $l$loop: while (true) {
    var curState = $this.e13_1.kotlinx$atomicfu$value;
    if (isInterface(curState, CancellableContinuation)) {
      ...
      var clause = tmp;
      var onCancellation = clause.p1w($this, internalResult);
      if ($this.e13_1.atomicfu$compareAndSet(curState, clause)) {
        var cont = isInterface(curState, CancellableContinuation) ? curState : THROW_CCE();
        $this.g13_1 = internalResult;
        if (tryResume_0(cont, onCancellation))
          return 0;
        $this.g13_1 = get_NO_RESULT();
        return 2;
      }
    } else {
      var tmp_0;
      ...
      if (tmp_0)
        ...
        if (equals(curState, get_STATE_CANCELLED()))
          ...
          if (equals(curState, get_STATE_REG())) {
            if ($this.e13_1.atomicfu$compareAndSet(curState, listOf_0(clauseObject)))
              return 1;
          } else {
            if (isInterface(curState, KtList)) {
              if ($this.e13_1.atomicfu$compareAndSet(curState, plus_0(curState, clauseObject)))
                return 1;
            } else {
              // Inline function 'kotlin.error' call
...
protoOf(ClauseData).p1w = function (select, internalResult) {
  var tmp161_safe_receiver = this.o1w_1;
  return tmp161_safe_receiver == null ? null : tmp161_safe_receiver(select, this.n1w_1, internalResult);
};
function SelectImplementation() {
}
protoOf(SelectImplementation).h13 = function (clauseObject, result) {
...
function tryResume_0(_this__u8e3s4, onCancellation) {
  _init_properties_Select_kt__zhm2jg();
  var tmp0_elvis_lhs = _this__u8e3s4.ts(Unit_instance, null, onCancellation);
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return false;
  } else {
...
protoOf(NodeDispatcher).s1w = function () {
  process.nextTick(this.z1w_1.x1w_1);
};
...
function ScheduledMessageQueue(dispatcher) {
  ...
  this.w1w_1 = dispatcher;
  var tmp = this;
  tmp.x1w_1 = ScheduledMessageQueue$processQueue$lambda(this);
}
protoOf(ScheduledMessageQueue).e1x = function () {
  this.w1w_1.s1w();
};
protoOf(ScheduledMessageQueue).f1x = function () {
  setTimeout(this.x1w_1, 0);
};
protoOf(ScheduledMessageQueue).g1x = function (timeout) {
  setTimeout(this.x1w_1, timeout);
};
...
function WindowMessageQueue$lambda(this$0) {
  return function (event) {
    var tmp;
    if (event.source == this$0.r1x_1 && event.data == this$0.s1x_1) {
...
function WindowMessageQueue(window_0) {
  MessageQueue.call(this);
  this.r1x_1 = window_0;
  this.s1x_1 = 'dispatchCoroutine';
  this.r1x_1.addEventListener('message', WindowMessageQueue$lambda(this), true);
}
protoOf(WindowMessageQueue).e1x = function () {
  var tmp = Promise.resolve(Unit_instance);
  tmp.then(WindowMessageQueue$schedule$lambda(this));
};
protoOf(WindowMessageQueue).f1x = function () {
  this.r1x_1.postMessage(this.s1x_1, '*');
};
...
protoOf(UnconfinedEventLoop).tv = function (context, block) {
  unsupported();
};
...
protoOf(SetTimeoutDispatcher).s1w = function () {
  this.z1w_1.g1x(0);
};
...
function SetTimeoutBasedDispatcher$scheduleResumeAfterDelay$lambda($continuation, this$0) {
  return function () {
    ...
    $continuation.vs(this$0, Unit_instance);
    return Unit_instance;
  };
}
function SetTimeoutBasedDispatcher() {
  CoroutineDispatcher.call(this);
  this.z1w_1 = new ScheduledMessageQueue(this);
}
protoOf(SetTimeoutBasedDispatcher).tv = function (context, block) {
  this.z1w_1.n1x(block);
};
protoOf(SetTimeoutBasedDispatcher).aw = function (timeMillis, continuation) {
...
function MessageQueue() {
  this.a1x_1 = ArrayDeque_init_$Create$();
  this.b1x_1 = 16;
  this.c1x_1 = false;
}
protoOf(MessageQueue).h1x = function (element) {
  return this.a1x_1.e(element);
};
protoOf(MessageQueue).e = function (element) {
  return this.h1x((!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
};
protoOf(MessageQueue).i1x = function (index, element) {
  this.a1x_1.a2(index, element);
};
protoOf(MessageQueue).a2 = function (index, element) {
  return this.i1x(index, (!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
};
protoOf(MessageQueue).j1x = function (elements) {
  return this.a1x_1.n(elements);
};
protoOf(MessageQueue).n = function (elements) {
  return this.j1x(elements);
};
protoOf(MessageQueue).y1 = function () {
  this.a1x_1.y1();
};
protoOf(MessageQueue).w1 = function (index) {
  return this.a1x_1.w1(index);
};
protoOf(MessageQueue).b2 = function (index) {
  return this.a1x_1.b2(index);
};
protoOf(MessageQueue).k1x = function (index, element) {
  return this.a1x_1.z1(index, element);
};
protoOf(MessageQueue).z1 = function (index, element) {
  return this.k1x(index, (!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
};
protoOf(MessageQueue).x1 = function (fromIndex, toIndex) {
  return this.a1x_1.x1(fromIndex, toIndex);
};
protoOf(MessageQueue).l1x = function (element) {
  return this.a1x_1.u1(element);
};
protoOf(MessageQueue).u1 = function (element) {
  if (!(!(element == null) ? isInterface(element, Runnable) : false))
    return false;
  return this.l1x((!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
};
protoOf(MessageQueue).m1x = function (elements) {
  return this.a1x_1.v1(elements);
};
protoOf(MessageQueue).v1 = function (elements) {
  return this.m1x(elements);
};
protoOf(MessageQueue).o = function (index) {
  return this.a1x_1.o(index);
};
...
protoOf(MessageQueue).m = function () {
  return this.a1x_1.nf_1;
};
protoOf(MessageQueue).n1x = function (element) {
  this.h1x(element);
  if (!this.c1x_1) {
    this.c1x_1 = true;
    this.e1x();
...
protoOf(MessageQueue).d1x = function () {
  try {
    // Inline function 'kotlin.repeat' call
    var times = this.b1x_1;
    var inductionVariable = 0;
    if (inductionVariable < times)
      do {
        var index = inductionVariable;
...
protoOf(WindowClearTimeout).pq = function () {
  w3cClearTimeout(this.a1y_1.c1y_1, this.e1y_1);
};
...
function WindowDispatcher(window_0) {
  CoroutineDispatcher.call(this);
  this.c1y_1 = window_0;
  this.d1y_1 = new WindowMessageQueue(this.c1y_1);
}
protoOf(WindowDispatcher).tv = function (context, block) {
  return this.d1y_1.n1x(block);
};
protoOf(WindowDispatcher).aw = function (timeMillis, continuation) {
  var handle = w3cSetTimeout_0(this.c1y_1, WindowDispatcher$scheduleResumeAfterDelay$lambda(continuation, this), delayToInt(timeMillis));
...
protoOf(ClearTimeout).pq = function () {
  w3cClearTimeout_0(this.e1y_1);
};
protoOf(ClearTimeout).qq = function (cause) {
  this.pq();
};
protoOf(ClearTimeout).toString = function () {
  return 'ClearTimeout[' + this.e1y_1 + ']';
};
function toDebugString(_this__u8e3s4) {
  return toString(_this__u8e3s4);
}
function get_DefaultDelay() {
  var tmp = Dispatchers_getInstance().gz_1;
  return isInterface(tmp, Delay) ? tmp : THROW_CCE();
}
function newCoroutineContext(_this__u8e3s4, context) {
  var combined = _this__u8e3s4.tn().rh(context);
  return !(combined === Dispatchers_getInstance().gz_1) && combined.h9(Key_instance) == null ? combined.rh(Dispatchers_getInstance().gz_1) : combined;
}
...
function Dispatchers() {
  ...
  this.gz_1 = createDefaultDispatcher();
  this.hz_1 = Unconfined_getInstance();
  this.iz_1 = new JsMainDispatcher(this.gz_1, false);
  this.jz_1 = null;
}
protoOf(Dispatchers).kz = function () {
  var tmp0_elvis_lhs = this.jz_1;
  return tmp0_elvis_lhs == null ? this.iz_1 : tmp0_elvis_lhs;
};
...
function JsMainDispatcher(delegate, invokeImmediately) {
  ...
  this.g1y_1 = delegate;
  this.h1y_1 = invokeImmediately;
  this.i1y_1 = this.h1y_1 ? this : new JsMainDispatcher(this.g1y_1, true);
}
protoOf(JsMainDispatcher).ez = function () {
  return this.i1y_1;
};
protoOf(JsMainDispatcher).sv = function (context) {
  return !this.h1y_1;
};
protoOf(JsMainDispatcher).tv = function (context, block) {
  return this.g1y_1.tv(context, block);
};
protoOf(JsMainDispatcher).uv = function (context, block) {
  return this.g1y_1.uv(context, block);
};
protoOf(JsMainDispatcher).toString = function () {
  var tmp0_elvis_lhs = this.fz();
  return tmp0_elvis_lhs == null ? this.g1y_1.toString() : tmp0_elvis_lhs;
};
...
protoOf(JobCancellationException).toString = function () {
  return protoOf(CancellationException).toString.call(this) + '; job=' + toString(this.j1y_1);
};
protoOf(JobCancellationException).equals = function (other) {
  ...
  if (other === this) {
    ...
    if (tmp_2) {
      tmp_1 = equals(other.j1y_1, this.j1y_1);
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
...
protoOf(JobCancellationException).hashCode = function () {
  var tmp = imul(imul(getStringHashCode(ensureNotNull(this.message)), 31) + hashCode(this.j1y_1) | 0, 31);
...
function SafeCollector(collector, collectContext) {
  ...
  var tmp = this;
  tmp.e1a_1 = this.d1a_1.qh(0, SafeCollector$collectContextSize$lambda);
  this.f1a_1 = null;
}
protoOf(SafeCollector).g18 = function (value, $completion) {
  ...
  return this.c1a_1.g18(value, $completion);
};
...
protoOf(WorkaroundAtomicReference).pw = function () {
  return this.t1f_1;
};
protoOf(WorkaroundAtomicReference).i1w = function (value) {
  this.t1f_1 = value;
};
protoOf(WorkaroundAtomicReference).v1f = function (value) {
  var prev = this.t1f_1;
  this.t1f_1 = value;
  return prev;
};
protoOf(WorkaroundAtomicReference).u1f = function (expected, value) {
  if (this.t1f_1 === expected) {
    this.t1f_1 = value;
    return true;
  }
  return false;
...
protoOf(LockFreeLinkedListNode).ir = function (node, permissionsBitmask) {
  var prev = this.gr_1;
  var tmp;
  if (prev instanceof ListClosed) {
    tmp = ((prev.n1y_1 & permissionsBitmask) === 0 && prev.ir(node, permissionsBitmask));
  } else {
    node.fr_1 = this;
    node.gr_1 = prev;
    prev.fr_1 = node;
...
protoOf(LockFreeLinkedListNode).ww = function (forbiddenElementsBit) {
  this.ir(new ListClosed(forbiddenElementsBit), forbiddenElementsBit);
};
protoOf(LockFreeLinkedListNode).jr = function () {
  if (this.hr_1)
    return false;
  var prev = this.gr_1;
  var next = this.fr_1;
...
protoOf(LockFreeLinkedListNode).kr = function (node) {
  if (!(this.fr_1 === this))
    return false;
  this.ir(node, -2147483648);
  return true;
};
function ListClosed(forbiddenElementsBitmask) {
  LockFreeLinkedListNode.call(this);
  this.n1y_1 = forbiddenElementsBitmask;
}
function LocalAtomicInt(value) {
  this.q1k_1 = value;
}
protoOf(LocalAtomicInt).r1k = function () {
  this.q1k_1 = this.q1k_1 - 1 | 0;
  return this.q1k_1;
};
...
protoOf(CommonThreadLocal).pw = function () {
  var tmp = this.ow_1;
  return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
};
protoOf(CommonThreadLocal).qw = function (value) {
  this.ow_1 = value;
};
...
protoOf(JobSupport).yo = invokeOnCompletion$default;
protoOf(JobSupport).ep = cancel$default;
...
protoOf(BufferedChannel).i16 = close$default;
protoOf(BufferedChannel).k16 = cancel$default_0;
protoOf(ChannelCoroutine).i16 = close$default;
protoOf(SharedFlowImpl).e1c = fuse$default;
protoOf(StateFlowImpl).e1c = fuse$default;
protoOf(ChannelFlow).e1c = fuse$default;
protoOf(ReadonlyStateFlow).e1c = fuse$default;
//endregion
//region block: init
...
export {
  ...
  combine as combine1wzjwcv2bs3w6,
