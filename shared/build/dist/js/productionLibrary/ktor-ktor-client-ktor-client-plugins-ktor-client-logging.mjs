    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.q4u_1.v4u_1.ap(this);
        ...
        case 1:
          ...
          this.q4u_1.s4u_1.z4u(toString(trim(isCharSequence(this_0) ? this_0 : THROW_CCE())));
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.i4v_1.w4u_1.ap(this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
          ...
          continue $sm;
        case 1:
          this.i4v_1.u4u_1.b8(this.j4v_1);
          return Unit_instance;
        case 2:
          throw this.x8_1;
      }
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          if (!this.s4v_1.y4u_1.atomicfu$compareAndSet(false, true))
            return Unit_instance;
          this.u8_1 = 1;
          suspendResult = this.s4v_1.v4u_1.ap(this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
          ...
          continue $sm;
        case 1:
          var message = toString(trim(this.s4v_1.u4u_1));
          if (charSequenceLength(message) > 0) {
            this.s4v_1.s4u_1.z4u(message);
          }
...
function HttpClientCallLogger(logger) {
  this.s4u_1 = logger;
  this.t4u_1 = StringBuilder_init_$Create$();
  this.u4u_1 = StringBuilder_init_$Create$();
  this.v4u_1 = Job();
  this.w4u_1 = Job();
  this.x4u_1 = atomic$boolean$1(false);
  this.y4u_1 = atomic$boolean$1(false);
}
protoOf(HttpClientCallLogger).t4v = function (message) {
  var tmp0 = this.t4u_1;
...
protoOf(HttpClientCallLogger).u4v = function (message) {
  var tmp0 = this.u4u_1;
  // Inline function 'kotlin.text.trim' call
  // Inline function 'kotlin.text.appendLine' call
  var value = toString(trim(isCharSequence(message) ? message : THROW_CCE()));
...
protoOf(HttpClientCallLogger).v4v = function (message, $completion) {
  var tmp = new $logResponseExceptionCOROUTINE$(this, message, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(HttpClientCallLogger).w4v = function (message, $completion) {
  var tmp = new $logResponseBodyCOROUTINE$(this, message, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(HttpClientCallLogger).x4v = function () {
  if (!this.x4u_1.atomicfu$compareAndSet(false, true))
    return Unit_instance;
  try {
    var message = toString(trim(this.t4u_1));
    // Inline function 'kotlin.text.isNotEmpty' call
    if (charSequenceLength(message) > 0) {
      this.s4u_1.z4u(message);
    }
  }finally {
    this.v4u_1.qv();
  }
};
protoOf(HttpClientCallLogger).y4v = function ($completion) {
...
function LoggedContent(originalContent, channel) {
  ...
  this.f4w_1 = originalContent;
  this.g4w_1 = channel;
  this.h4w_1 = this.f4w_1.k3f();
  this.i4w_1 = this.f4w_1.m3f();
  this.j4w_1 = this.f4w_1.l3f();
  this.k4w_1 = this.f4w_1.c3a();
}
protoOf(LoggedContent).k3f = function () {
  return this.h4w_1;
};
protoOf(LoggedContent).m3f = function () {
  return this.i4w_1;
};
protoOf(LoggedContent).l3f = function () {
  return this.j4w_1;
};
protoOf(LoggedContent).c3a = function () {
  return this.k4w_1;
};
protoOf(LoggedContent).q3f = function () {
  return this.g4w_1;
};
function Companion() {
}
...
protoOf(SimpleLogger).z4u = function (message) {
...
function LoggingConfig() {
  ...
  tmp.l4w_1 = ArrayList_init_$Create$();
  var tmp_0 = this;
  // Inline function 'kotlin.collections.mutableListOf' call
  tmp_0.m4w_1 = ArrayList_init_$Create$();
  this.n4w_1 = null;
  this.o4w_1 = LogLevel_HEADERS_getInstance();
}
protoOf(LoggingConfig).p4w = function () {
...
protoOf(Context).r4w = function (content, $completion) {
  return this.q4w_1.g32(content, $completion);
};
function SendHook$install$slambda($handler, resultContinuation) {
  this.a4x_1 = $handler;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(SendHook$install$slambda).r3k = function ($this$intercept, it, $completion) {
  var tmp = this.s3k($this$intercept, it, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(SendHook$install$slambda).l9 = function (p1, p2, $completion) {
  ...
  return this.r3k(tmp, !(p2 == null) ? p2 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.a4x_1(new Context(this.b4x_1), this.b4x_1.c33_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(SendHook$install$slambda).s3k = function ($this$intercept, it, completion) {
  var i = new SendHook$install$slambda(this.a4x_1, completion);
  i.b4x_1 = $this$intercept;
  i.c4x_1 = it;
  return i;
};
function SendHook$install$slambda_0($handler, resultContinuation) {
  ...
  var l = function ($this$intercept, it, $completion) {
    return i.r3k($this$intercept, it, $completion);
  };
  l.$arity = 2;
  return l;
}
...
protoOf(SendHook).d4x = function (client, handler) {
  var tmp = Phases_getInstance().i3m_1;
  client.z3j_1.g33(tmp, SendHook$install$slambda_0(handler, null));
};
protoOf(SendHook).o3t = function (client, handler) {
...
protoOf(Context_0).f4x = function ($completion) {
  return this.e4x_1.h32($completion);
};
function ResponseHook$install$slambda($handler, resultContinuation) {
  this.o4x_1 = $handler;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(ResponseHook$install$slambda).b3u = function ($this$intercept, it, $completion) {
  var tmp = this.c3u($this$intercept, it, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(ResponseHook$install$slambda).l9 = function (p1, p2, $completion) {
  var tmp = p1 instanceof PipelineContext ? p1 : THROW_CCE();
  return this.b3u(tmp, p2 instanceof HttpResponse ? p2 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.o4x_1(new Context_0(this.p4x_1), this.p4x_1.f32(), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ResponseHook$install$slambda).c3u = function ($this$intercept, it, completion) {
  var i = new ResponseHook$install$slambda(this.o4x_1, completion);
  i.p4x_1 = $this$intercept;
  i.q4x_1 = it;
  return i;
};
function ResponseHook$install$slambda_0($handler, resultContinuation) {
  ...
  var l = function ($this$intercept, it, $completion) {
    return i.b3u($this$intercept, it, $completion);
  };
  l.$arity = 2;
  return l;
}
...
protoOf(ResponseHook).r4x = function (client, handler) {
  var tmp = Phases_getInstance_0().f3u_1;
  client.a3k_1.g33(tmp, ResponseHook$install$slambda_0(handler, null));
};
protoOf(ResponseHook).o3t = function (client, handler) {
  return this.r4x(client, (!(handler == null) ? isSuspendFunction(handler, 2) : false) ? handler : THROW_CCE());
};
...
protoOf(Context_1).t4x = function ($completion) {
  return this.s4x_1.h32($completion);
};
function ReceiveHook$install$slambda($handler, resultContinuation) {
  this.c4y_1 = $handler;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(ReceiveHook$install$slambda).m3l = function ($this$intercept, it, $completion) {
  var tmp = this.n3l($this$intercept, it, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(ReceiveHook$install$slambda).l9 = function (p1, p2, $completion) {
  var tmp = p1 instanceof PipelineContext ? p1 : THROW_CCE();
  return this.m3l(tmp, p2 instanceof HttpResponseContainer ? p2 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.c4y_1(new Context_1(this.d4y_1), this.d4y_1.c33_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ReceiveHook$install$slambda).n3l = function ($this$intercept, it, completion) {
  var i = new ReceiveHook$install$slambda(this.c4y_1, completion);
  i.d4y_1 = $this$intercept;
  i.e4y_1 = it;
  return i;
};
function ReceiveHook$install$slambda_0($handler, resultContinuation) {
  ...
  var l = function ($this$intercept, it, $completion) {
    return i.m3l($this$intercept, it, $completion);
  };
  l.$arity = 2;
  return l;
}
...
protoOf(ReceiveHook).f4y = function (client, handler) {
  var tmp = Phases_getInstance_1().w3m_1;
  client.y3j_1.g33(tmp, ReceiveHook$install$slambda_0(handler, null));
};
protoOf(ReceiveHook).o3t = function (client, handler) {
  return this.f4y(client, (!(handler == null) ? isSuspendFunction(handler, 2) : false) ? handler : THROW_CCE());
};
...
function Logging$lambda($this$createClientPlugin) {
  _init_properties_Logging_kt__66pui5();
  var logger = $this$createClientPlugin.j3u_1.p4w();
  var level = $this$createClientPlugin.j3u_1.o4w_1;
  var filters = $this$createClientPlugin.j3u_1.l4w_1;
  var sanitizedHeaders = $this$createClientPlugin.j3u_1.m4w_1;
  var tmp = SendHook_instance;
  $this$createClientPlugin.m3u(tmp, Logging$lambda$slambda_0(filters, logger, level, sanitizedHeaders, null));
  var tmp_0 = ResponseHook_instance;
  $this$createClientPlugin.m3u(tmp_0, Logging$lambda$slambda_2(level, sanitizedHeaders, null));
  var tmp_1 = ReceiveHook_instance;
  $this$createClientPlugin.m3u(tmp_1, Logging$lambda$slambda_4(level, null));
  if (!level.d4w_1)
    return Unit_instance;
  var observer = Logging$lambda$slambda_6(level, null);
  var tmp_2 = get_ResponseObserver();
  var tmp_3 = get_ResponseObserver();
  tmp_2.e3n(tmp_3.d3n(Logging$lambda$lambda(observer)), $this$createClientPlugin.i3u_1);
  return Unit_instance;
}
...
function invoke$logRequestBody(content, logger, $completion) {
  ...
  // Inline function 'kotlin.text.appendLine' call
  var value = 'BODY Content-Type: ' + toString_0(content.k3f());
  // Inline function 'kotlin.text.appendLine' call
  requestLog.b8(value).c8(_Char___init__impl__6a9atx(10));
  var tmp0_safe_receiver = content.k3f();
  var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : charset(tmp0_safe_receiver);
  var charset_0 = tmp1_elvis_lhs == null ? Charsets_getInstance().b2a_1 : tmp1_elvis_lhs;
  var channel = new ByteChannel();
  var tmp = GlobalScope_instance;
  var tmp_0 = Dispatchers_getInstance().gz_1.rh(MDCContext());
...
function invoke$logRequestException(level, logger, context, cause) {
  if (level.b4w_1) {
    logger.z4u('REQUEST ' + Url(context.y3l_1).toString() + ' failed with exception: ' + cause.toString());
  }
}
function invoke$logRequest(logger, level, sanitizedHeaders, request, $completion) {
  var tmp = request.b3m_1;
  var content = tmp instanceof OutgoingContent ? tmp : THROW_CCE();
  var callLogger = new HttpClientCallLogger(logger);
  request.d3m_1.w2v(get_ClientCallLogger(), callLogger);
  // Inline function 'kotlin.text.buildString' call
  // Inline function 'kotlin.apply' call
  var this_0 = StringBuilder_init_$Create$();
  if (level.b4w_1) {
    // Inline function 'kotlin.text.appendLine' call
    var value = 'REQUEST: ' + Url(request.y3l_1).toString();
    // Inline function 'kotlin.text.appendLine' call
    this_0.b8(value).c8(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    var value_0 = 'METHOD: ' + request.z3l_1.toString();
    // Inline function 'kotlin.text.appendLine' call
  ...
  if (level.c4w_1) {
    ...
    logHeaders(this_0, request.a3m_1.x2z(), sanitizedHeaders);
    // Inline function 'kotlin.text.appendLine' call
    ...
    $l$block: {
      ...
      while (_iterator__ex2g4s.k()) {
        var element = _iterator__ex2g4s.l();
        if (element.h4y_1(HttpHeaders_getInstance().o36_1)) {
          tmp$ret$9 = element;
          break $l$block;
        }
      }
    ...
    var contentLengthPlaceholder = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.g4y_1;
    var tmp$ret$11;
    $l$block_0: {
      // Inline function 'kotlin.collections.firstOrNull' call
      ...
      while (_iterator__ex2g4s_0.k()) {
        ...
        if (element_0.h4y_1(HttpHeaders_getInstance().r36_1)) {
    ...
    var contentTypePlaceholder = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.g4y_1;
    var tmp2_safe_receiver = content.m3f();
    if (tmp2_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      var tmp_0 = HttpHeaders_getInstance().o36_1;
      logHeader(this_0, tmp_0, contentLengthPlaceholder == null ? tmp2_safe_receiver.toString() : contentLengthPlaceholder);
    }
    var tmp3_safe_receiver = content.k3f();
    if (tmp3_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      var tmp_1 = HttpHeaders_getInstance().r36_1;
      logHeader(this_0, tmp_1, contentTypePlaceholder == null ? tmp3_safe_receiver.toString() : contentTypePlaceholder);
    }
    logHeaders(this_0, content.c3a().x2z(), sanitizedHeaders);
  }
  var message = this_0.toString();
  // Inline function 'kotlin.text.isNotEmpty' call
  if (charSequenceLength(message) > 0) {
    callLogger.t4v(message);
  }
  var tmp_2;
...
function invoke$logResponseException(level, log, request, cause) {
  if (!level.b4w_1)
    return Unit_instance;
  log.b8('RESPONSE ' + request.k3o().toString() + ' failed with exception: ' + cause.toString());
}
function Logging$lambda$slambda($filters, $logger, $level, $sanitizedHeaders, resultContinuation) {
  this.q4y_1 = $filters;
  this.r4y_1 = $logger;
  this.s4y_1 = $level;
  this.t4y_1 = $sanitizedHeaders;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(Logging$lambda$slambda).a4z = function ($this$on, request, $completion) {
  var tmp = this.b4z($this$on, request, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(Logging$lambda$slambda).l9 = function (p1, p2, $completion) {
  ...
  return this.a4z(tmp, p2 instanceof HttpRequestBuilder ? p2 : THROW_CCE(), $completion);
};
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 8;
          if (!invoke$shouldBeLogged(this.q4y_1, this.v4y_1)) {
            this.v4y_1.d3m_1.w2v(get_DisableLogging(), Unit_instance);
            return Unit_instance;
          }

          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = invoke$logRequest(this.r4y_1, this.s4y_1, this.t4y_1, this.v4y_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 3:
          this.v8_1 = 8;
          this.y4y_1 = this.w4y_1;
          this.z4y_1 = Unit_instance;
          this.u8_1 = 4;
          continue $sm;
        case 4:
          this.v8_1 = 7;
          this.v8_1 = 6;
          this.u8_1 = 5;
          var tmp0_elvis_lhs = this.y4y_1;
          suspendResult = this.u4y_1.r4w(tmp0_elvis_lhs == null ? this.v4y_1.b3m_1 : tmp0_elvis_lhs, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 6:
          ...
          if (tmp_2 instanceof Error) {
            var cause = this.x8_1;
            var tmp_3 = this;
            invoke$logRequestException(this.s4y_1, this.r4y_1, this.v4y_1, cause);
            throw cause;
          } else {
            throw this.x8_1;
          }
...
protoOf(Logging$lambda$slambda).b4z = function ($this$on, request, completion) {
  var i = new Logging$lambda$slambda(this.q4y_1, this.r4y_1, this.s4y_1, this.t4y_1, completion);
  i.u4y_1 = $this$on;
  i.v4y_1 = request;
  return i;
};
function Logging$lambda$slambda_0($filters, $logger, $level, $sanitizedHeaders, resultContinuation) {
  ...
  var l = function ($this$on, request, $completion) {
    return i.a4z($this$on, request, $completion);
  };
  l.$arity = 2;
  return l;
}
function Logging$lambda$slambda_1($level, $sanitizedHeaders, resultContinuation) {
  this.k4z_1 = $level;
  this.l4z_1 = $sanitizedHeaders;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(Logging$lambda$slambda_1).v4z = function ($this$on, response, $completion) {
  var tmp = this.w4z($this$on, response, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(Logging$lambda$slambda_1).l9 = function (p1, p2, $completion) {
  ...
  return this.v4z(tmp, p2 instanceof HttpResponse ? p2 : THROW_CCE(), $completion);
};
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 10;
          if (this.k4z_1.equals(LogLevel_NONE_getInstance()) || this.n4z_1.g3p().n3n().v2v(get_DisableLogging()))
            return Unit_instance;
          this.o4z_1 = this.n4z_1.g3p().n3n().t2v(get_ClientCallLogger());
          this.p4z_1 = StringBuilder_init_$Create$();
          this.q4z_1 = false;
          this.u8_1 = 1;
          continue $sm;
        case 1:
          this.v8_1 = 4;
          this.v8_1 = 3;
          logResponseHeader(this.p4z_1, this.n4z_1.g3p().y3k(), this.k4z_1, this.l4z_1);
          this.u8_1 = 2;
          suspendResult = this.m4z_1.f4x(this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 3:
          ...
          var tmp_0 = this.x8_1;
          if (tmp_0 instanceof Error) {
            this.s4z_1 = this.x8_1;
            var tmp_1 = this;
            invoke$logResponseException(this.k4z_1, this.p4z_1, this.n4z_1.g3p().h3o(), this.s4z_1);
            this.q4z_1 = true;
            throw this.s4z_1;
          } else {
            throw this.x8_1;
        ...
        case 4:
          this.v8_1 = 10;
          this.t4z_1 = this.x8_1;
          this.o4z_1.u4v(this.p4z_1.toString());
          if (this.q4z_1 || !this.k4z_1.d4w_1) {
            this.u8_1 = 5;
            suspendResult = this.o4z_1.y4v(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
...
protoOf(Logging$lambda$slambda_1).w4z = function ($this$on, response, completion) {
  var i = new Logging$lambda$slambda_1(this.k4z_1, this.l4z_1, completion);
  i.m4z_1 = $this$on;
  i.n4z_1 = response;
  return i;
};
function Logging$lambda$slambda_2($level, $sanitizedHeaders, resultContinuation) {
  ...
  var l = function ($this$on, response, $completion) {
    return i.v4z($this$on, response, $completion);
  };
  l.$arity = 2;
  return l;
}
...
protoOf(Logging$lambda$slambda_3).m50 = function ($this$on, call, $completion) {
  var tmp = this.n50($this$on, call, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(Logging$lambda$slambda_3).l9 = function (p1, p2, $completion) {
  ...
  return this.m50(tmp, p2 instanceof HttpClientCall ? p2 : THROW_CCE(), $completion);
};
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 6;
          if (this.f50_1.equals(LogLevel_NONE_getInstance()) || this.h50_1.n3n().v2v(get_DisableLogging())) {
            return Unit_instance;
          }

          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.g50_1.t4x(this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 2:
          ...
          var tmp_0 = this.x8_1;
          if (tmp_0 instanceof Error) {
            this.j50_1 = this.x8_1;
            this.k50_1 = StringBuilder_init_$Create$();
            this.l50_1 = this.h50_1.n3n().t2v(get_ClientCallLogger());
            invoke$logResponseException(this.f50_1, this.k50_1, this.h50_1.h3o(), this.j50_1);
            this.u8_1 = 3;
            suspendResult = this.l50_1.v4v(this.k50_1.toString(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
        ...
        case 3:
          this.u8_1 = 4;
          suspendResult = this.l50_1.y4v(this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(Logging$lambda$slambda_3).n50 = function ($this$on, call, completion) {
  var i = new Logging$lambda$slambda_3(this.f50_1, completion);
  i.g50_1 = $this$on;
  i.h50_1 = call;
  return i;
};
function Logging$lambda$slambda_4($level, resultContinuation) {
  ...
  var l = function ($this$on, call, $completion) {
    return i.m50($this$on, call, $completion);
  };
  l.$arity = 2;
  return l;
}
...
protoOf(Logging$lambda$slambda_5).h3w = function (it, $completion) {
...
protoOf(Logging$lambda$slambda_5).k9 = function (p1, $completion) {
  return this.h3w(p1 instanceof HttpResponse ? p1 : THROW_CCE(), $completion);
};
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 10;
          if (this.w50_1.equals(LogLevel_NONE_getInstance()) || this.x50_1.g3p().n3n().v2v(get_DisableLogging())) {
            return Unit_instance;
          }

          this.y50_1 = this.x50_1.g3p().n3n().t2v(get_ClientCallLogger());
          this.z50_1 = StringBuilder_init_$Create$();
          this.u8_1 = 1;
          continue $sm;
        case 1:
          this.v8_1 = 4;
          this.v8_1 = 3;
          this.u8_1 = 2;
          suspendResult = logResponseBody(this.z50_1, contentType(this.x50_1), this.x50_1.i3o(), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 3:
          ...
          var tmp_0 = this.x8_1;
          if (tmp_0 instanceof Error) {
            this.b51_1 = this.x8_1;
            var tmp_1 = this;
            tmp_1.a51_1 = Unit_instance;
            this.v8_1 = 10;
            this.u8_1 = 7;
            continue $sm;
          } else {
        ...
        case 4:
          this.v8_1 = 10;
          this.c51_1 = this.x8_1;
          this.u8_1 = 5;
          var this_0 = this.z50_1.toString();
          suspendResult = this.y50_1.w4v(toString(trim(isCharSequence(this_0) ? this_0 : THROW_CCE())), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 5:
          this.u8_1 = 6;
          suspendResult = this.y50_1.y4v(this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 7:
          this.v8_1 = 10;
          this.u8_1 = 8;
          var this_1 = this.z50_1.toString();
          suspendResult = this.y50_1.w4v(toString(trim(isCharSequence(this_1) ? this_1 : THROW_CCE())), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(Logging$lambda$slambda_5).j3v = function (it, completion) {
  var i = new Logging$lambda$slambda_5(this.w50_1, completion);
  i.x50_1 = it;
  return i;
};
...
function Logging$lambda$logRequestBody$slambda($channel, $charset, $requestLog, $logger, resultContinuation) {
  this.l51_1 = $channel;
  this.m51_1 = $charset;
  this.n51_1 = $requestLog;
  this.o51_1 = $logger;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(Logging$lambda$logRequestBody$slambda).k1h = function ($this$launch, $completion) {
    ...
    try {
      ...
      switch (tmp) {
        ...
        case 1:
          this.v8_1 = 6;
          var tmp_0 = this;
          tmp_0.r51_1 = this.l51_1;
          var tmp_1 = this;
          tmp_1.s51_1 = this.m51_1;
          this.t51_1 = this.r51_1;
          this.u51_1 = this.s51_1;
          this.v8_1 = 3;
          this.u8_1 = 2;
          suspendResult = readRemaining(this.t51_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 2:
          ...
          this.v51_1 = readText(ARGUMENT, this.u51_1);
          this.v8_1 = 6;
          this.u8_1 = 4;
          continue $sm;
        case 3:
        ...
        case 4:
          this.v8_1 = 6;
          var tmp0_elvis_lhs = this.v51_1;
          var text = tmp0_elvis_lhs == null ? '[request body omitted]' : tmp0_elvis_lhs;
          var tmp0 = this.n51_1;
          var value = 'BODY START';
          tmp0.b8(value).c8(_Char___init__impl__6a9atx(10));
          this.n51_1.b8(text).c8(_Char___init__impl__6a9atx(10));
          this.q51_1 = this.n51_1.b8('BODY END');
          this.v8_1 = 7;
          this.u8_1 = 5;
          continue $sm;
        case 5:
          this.q51_1;
          this.v8_1 = 7;
          this.o51_1.t4v(this.n51_1.toString());
          this.o51_1.x4v();
          return Unit_instance;
        case 6:
          this.v8_1 = 7;
...
protoOf(Logging$lambda$logRequestBody$slambda).l1h = function ($this$launch, completion) {
  var i = new Logging$lambda$logRequestBody$slambda(this.l51_1, this.m51_1, this.n51_1, this.o51_1, completion);
  i.p51_1 = $this$launch;
  return i;
};
...
function logHeaders(_this__u8e3s4, headers, sanitizedHeaders) {
  ...
  while (_iterator__ex2g4s.k()) {
    ...
    var placeholder = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.g4y_1;
...
function logResponseHeader(log, response, level, sanitizedHeaders) {
  ...
  if (level.b4w_1) {
    // Inline function 'kotlin.text.appendLine' call
    var value = 'RESPONSE: ' + response.l3f().toString();
    // Inline function 'kotlin.text.appendLine' call
    log.b8(value).c8(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    var value_0 = 'METHOD: ' + response.g3p().h3o().d3p().toString();
    // Inline function 'kotlin.text.appendLine' call
    log.b8(value_0).c8(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    var value_1 = 'FROM: ' + response.g3p().h3o().k3o().toString();
    // Inline function 'kotlin.text.appendLine' call
  ...
  if (level.c4w_1) {
    ...
    logHeaders(log, response.c3a().x2z(), sanitizedHeaders);
  }
}
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 3;
          var tmp_0 = this;
          tmp_0.h52_1 = this.e52_1;
          this.i52_1 = this.h52_1;
          var tmp_1 = this;
          tmp_1.j52_1 = this.i52_1;
          this.k52_1 = this.j52_1;
          var tmp0 = this.k52_1;
          var value = 'BODY Content-Type: ' + toString_0(this.f52_1);
          tmp0.b8(value).c8(_Char___init__impl__6a9atx(10));
          var tmp0_0 = this.k52_1;
          var value_0 = 'BODY START';
          tmp0_0.b8(value_0).c8(_Char___init__impl__6a9atx(10));
          var tmp_2 = this;
          tmp_2.l52_1 = this.g52_1;
          var tmp_3 = this;
          var tmp0_safe_receiver = this.f52_1;
          var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : charset(tmp0_safe_receiver);
          tmp_3.m52_1 = tmp1_elvis_lhs == null ? Charsets_getInstance().b2a_1 : tmp1_elvis_lhs;
          this.n52_1 = this.l52_1;
          this.o52_1 = this.m52_1;
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = readRemaining(this.n52_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 1:
          var ARGUMENT = suspendResult;
          this.p52_1 = readText(ARGUMENT, this.o52_1);
          this.v8_1 = 3;
          this.u8_1 = 4;
          continue $sm;
        case 2:
        ...
        case 4:
          this.v8_1 = 3;
          var tmp2_elvis_lhs = this.p52_1;
          var message = tmp2_elvis_lhs == null ? '[response body omitted]' : tmp2_elvis_lhs;
          this.k52_1.b8(message).c8(_Char___init__impl__6a9atx(10));
          this.k52_1.b8('BODY END');
          return Unit_instance;
      }
    } catch ($p) {
      var e = $p;
...
function toReadChannel(_this__u8e3s4) {
  var tmp = GlobalScope_instance;
  var tmp_0 = Dispatchers_getInstance().gz_1;
  return writer(tmp, tmp_0, VOID, toReadChannel$slambda_0(_this__u8e3s4, null)).p28_1;
}
function toReadChannel$slambda($this_toReadChannel, resultContinuation) {
  this.n53_1 = $this_toReadChannel;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(toReadChannel$slambda).i3q = function ($this$writer, $completion) {
  var tmp = this.j3q($this$writer, $completion);
  tmp.w8_1 = Unit_instance;
  tmp.x8_1 = null;
  return tmp.c9();
};
protoOf(toReadChannel$slambda).k9 = function (p1, $completion) {
  return this.i3q(p1 instanceof WriterScope ? p1 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 2;
          this.u8_1 = 1;
          suspendResult = this.n53_1.s3f(this.o53_1.r28_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(toReadChannel$slambda).j3q = function ($this$writer, completion) {
  var i = new toReadChannel$slambda(this.n53_1, completion);
  i.o53_1 = $this$writer;
  return i;
};
function toReadChannel$slambda_0($this_toReadChannel, resultContinuation) {
  ...
  var l = function ($this$writer, $completion) {
    return i.i3q($this$writer, $completion);
  };
  l.$arity = 1;
  return l;
}
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.v8_1 = 6;
          this.b53_1 = this.z52_1;
          var tmp_0 = this.b53_1;
          if (tmp_0 instanceof ByteArrayContent) {
            this.u8_1 = 3;
            suspendResult = writeFully(this.a53_1, this.z52_1.n3f(), VOID, VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
          } else {
            var tmp_1 = this.b53_1;
            if (tmp_1 instanceof ReadChannelContent) {
              var tmp_2 = this;
              var responseChannel = new ByteChannel();
              var content = this.z52_1.q3f();
              copyToBoth(content, this.a53_1, responseChannel);
              tmp_2.c53_1 = new LoggedContent(this.z52_1, responseChannel);
              this.u8_1 = 5;
              continue $sm;
            } else {
              var tmp_3 = this.b53_1;
              if (tmp_3 instanceof WriteChannelContent) {
                var tmp_4 = this;
                var responseChannel_0 = new ByteChannel();
                var content_0 = toReadChannel(this.z52_1);
                copyToBoth(content_0, this.a53_1, responseChannel_0);
                tmp_4.c53_1 = new LoggedContent(this.z52_1, responseChannel_0);
                this.u8_1 = 5;
                continue $sm;
              } else {
                var tmp_5 = this.b53_1;
                if (tmp_5 instanceof ContentWrapper) {
                  this.d53_1 = this.z52_1;
                  this.u8_1 = 2;
                  suspendResult = observe(this.z52_1.w3f(), this.a53_1, this);
                  if (suspendResult === get_COROUTINE_SUSPENDED()) {
                    return suspendResult;
                  }
                  continue $sm;
                  ...
                  var tmp_6;
                  var tmp_7 = this.b53_1;
                  if (tmp_7 instanceof NoContent) {
                    tmp_6 = true;
                  } else {
                    var tmp_8 = this.b53_1;
                    tmp_6 = tmp_8 instanceof ProtocolUpgrade;
                  }
                  if (tmp_6) {
                    this.u8_1 = 1;
                    suspendResult = this.a53_1.o24(this);
                    if (suspendResult === get_COROUTINE_SUSPENDED()) {
                      return suspendResult;
                    }
                    continue $sm;
          ...
          break;
        case 1:
          this.c53_1 = this.z52_1;
          this.u8_1 = 5;
          continue $sm;
        case 2:
          this.e53_1 = suspendResult;
          this.c53_1 = this.d53_1.x3f(this.e53_1);
          this.u8_1 = 5;
          continue $sm;
        case 3:
          this.u8_1 = 4;
